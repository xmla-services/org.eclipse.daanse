    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link Database.MiningStructures }
     *     
     */
     ...
     * @return
     *     possible object is
     *     {@link Database.DatabasePermissions }
     *     
     */
        ...
        implements Serializable
    {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a <CODE>set</CODE> method for the databasePermission property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
        ...
        implements Serializable
    {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a <CODE>set</CODE> method for the dataSourceView property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
        ...
        implements Serializable
    {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a <CODE>set</CODE> method for the miningStructure property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
