...
public class AndOrType implements Serializable
{
    ...
    protected List<JAXBElement<? extends Serializable>> notOrOrOrAnd;
     ...
     * 
     */
    public List<JAXBElement<? extends Serializable>> getNotOrOrOrAnd() {
        if (notOrOrOrAnd == null) {
            notOrOrOrAnd = new ArrayList<JAXBElement<? extends Serializable>>();
        }
