/* MdxParserImpl.java */
/* Generated by: ParserGeneratorCC: Do not edit this line. MdxParserImpl.java */
...
import org.eclipse.daanse.mdx.parser.JavaccParserValidatorImpl;
import org.eclipse.daanse.mdx.parser.MdxParserValidator;
...
// Entry points
  final public 
QueryPart statementEof() throws ParseException {QueryPart qp;
    qp = statement();
    jj_consume_token(0);
{if ("" != null) return qp;}
  ...
  final public Exp expressionEof() throws ParseException {Exp e;
    e = expression();
    jj_consume_token(0);
{if ("" != null) return e;}
    throw new IllegalStateException ("Missing return statement in function");
...
// <identifier> ::= <regularIdentifier> | <delimitedIdentifier>
  final public 
Id.Segment identifier() throws ParseException {Id.Segment segment;
...
{if ("" != null) return segment;}
  ...
  final public Id.NameSegment nameSegment() throws ParseException {String id;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case DIMENSION:
    case PROPERTIES:{
      id = keyword();
// Allow a non-reserved keyword to be converted back into an identifier
        ...
        {if ("" != null) return new Id.NameSegment(id, Id.Quoting.UNQUOTED);}
      break;
      }
    case ID:{
      jj_consume_token(ID);
{if ("" != null) return new Id.NameSegment(token.image, Id.Quoting.UNQUOTED);}
      break;
      }
    case ATSIGN:{
...
{if ("" != null) return new Id.NameSegment(
...
// for example '&foo&[1]&bar' in '[x].&foo&[1]&bar.[y]'
  final public Id.KeySegment keyIdentifier() throws ParseException {List<Id.NameSegment> list = new ArrayList<Id.NameSegment>();
    Id.NameSegment key;
    label_1:
    while (true) {
      key = ampId();
...
{if ("" != null) return new Id.KeySegment(list);}
    throw new IllegalStateException ("Missing return statement in function");
}
...
{if ("" != null) return "Properties";}
  ...
  final public Id compoundId() throws ParseException {Id.Segment i;
...
{if ("" != null) return new Id(list);}
    throw new IllegalStateException ("Missing return statement in function");
}

// ----------------------------------------------------------------------------
// Expressions
  final public Exp unaliasedExpression() throws ParseException {Exp x, y;
    x = term5();
    label_3:
    while (true) {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
{if ("" != null) return x;}
  ...
  final public Exp term5() throws ParseException {Exp x, y;
    x = term4();
    label_4:
    while (true) {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
{if ("" != null) return x;}
  ...
  final public Exp term4() throws ParseException {Exp x;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case CASE:
    case CAST:
    case DIMENSION:
...
{if ("" != null) return x;}
    ...
    case NOT:{
      ...
      x = term4();
{if ("" != null) return new UnresolvedFunCall("NOT", Syntax.Prefix, new Exp[] {x});}
      break;
      }
    default:
      jj_la1[8] = jj_gen;
  ...
  final public Exp term3() throws ParseException {Exp x, y;
    Token op;
    x = term2();
    label_5:
    while (true) {
...
{if ("" != null) return x;}
  ...
  final public Exp term2() throws ParseException {Exp x, y;
    x = term();
    label_6:
    while (true) {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
{if ("" != null) return x;}
  ...
  final public Exp term() throws ParseException {Exp x, y;
    x = factor();
    label_7:
    while (true) {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
{if ("" != null) return x;}
  ...
  final public Exp factor() throws ParseException {Exp p;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case CASE:
    case CAST:
    case DIMENSION:
...
{if ("" != null) return p;}
    ...
    case MINUS:{
      jj_consume_token(MINUS);
      p = primary();
{if ("" != null) return new UnresolvedFunCall("-", Syntax.Prefix, new Exp[] {p});}
      break;
      }
    case EXISTING:{
      jj_consume_token(EXISTING);
      p = primary();
{if ("" != null) return new UnresolvedFunCall("Existing", Syntax.Prefix, new Exp[] {p});}
      break;
      }
    default:
      jj_la1[18] = jj_gen;
  ...
  final public Exp primary() throws ParseException {Exp e;
    e = atom();
    label_8:
    while (true) {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
{if ("" != null) return e;}
  ...
  final public Exp segmentOrFuncall(Exp left) throws ParseException {Id.Segment segment;
...
{if ("" != null) return createCall(left, segment, argList);}
    throw new IllegalStateException ("Missing return statement in function");
}
...
{if ("" != null) return Literal.create(new BigDecimal(token.image));}
      break;
      }
    case UNSIGNED_INTEGER_LITERAL:{
...
{if ("" != null) return Literal.create(new BigDecimal(token.image));}
  ...
  final public Exp atom() throws ParseException {Exp e;
    Id.NameSegment segment;
    List<Exp> lis;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case SINGLE_QUOTED_STRING:{
      jj_consume_token(SINGLE_QUOTED_STRING);
{if ("" != null) return Literal.createString(stripQuotes(token.image, "'", "'", "''"));}
      break;
      }
    case DOUBLE_QUOTED_STRING:{
      jj_consume_token(DOUBLE_QUOTED_STRING);
{if ("" != null) return Literal.createString(stripQuotes(token.image, DQ, DQ, DQDQ));}
      break;
      }
    case UNSIGNED_INTEGER_LITERAL:
    case APPROX_NUMERIC_LITERAL:
...
{if ("" != null) return e;}
    ...
    case NULL:{
      jj_consume_token(NULL);
{if ("" != null) return Literal.nullValue;}
      break;
      }
    case CAST:{
      ...
      segment = nameSegment();
      jj_consume_token(RPAREN);
{if ("" != null) return new UnresolvedFunCall(
...
{if ("" != null) return createCall(null, segment, lis);}
      break;
      }
    default:
      jj_la1[25] = jj_gen;
  ...
  final public Exp caseExpression() throws ParseException {Exp e, e2;
...
{if ("" != null) return e;}
  ...
  final public Exp expressionOrEmpty() throws ParseException {Exp e;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case CASE:
    case CAST:
    case DIMENSION:
...
{if ("" != null) return e;}
    ...
    default:
      jj_la1[30] = jj_gen;
{if ("" != null) return new UnresolvedFunCall("", Syntax.Empty, new Exp[] {});}
    }
    throw new IllegalStateException ("Missing return statement in function");
}
...
// for functions.
  final public List<Exp> expOrEmptyList() throws ParseException {Exp e;
...
// List of expressions, none of which may be empty.
  final public List<Exp> expList() throws ParseException {Exp e;
    List<Exp> list = new LinkedList<Exp>();
    e = expression();
list.add(e);
    label_13:
...
//
  final public QueryPart statement() throws ParseException {QueryPart qp;
...
{if ("" != null) return qp;}
  ...
  final public QueryPart selectOrDrillthroughStatement() throws ParseException {QueryPart qp;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case SELECT:
    case WITH:{
      qp = selectStatement();
...
{if ("" != null) return qp;}
  ...
  final public QueryPart dmvSelectStatement() throws ParseException {Id.NameSegment tableId;
    Id c;
...
String tableName = tableId.name;
        ...
        {if ("" != null) return factory.makeDmvQuery(tableName, returnList, w);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public Query selectStatement() throws ParseException {Formula e;
...
// We want 'Sales', not '[Sales]', and can't handle 'Schema.Sales'
        ...
        {if ("" != null) return factory.makeQuery(
            statement,
            toFormulaArray(f),
            toQueryAxisArray(a),
            subcube,
  ...
  final public Subcube selectSubcubeClause() throws ParseException {Id c = null;
     QueryAxis i;
     List<QueryAxis> a = new ArrayList<QueryAxis>();
...
String cubeName = null;
  ...
  final public QueryPart createFormula() throws ParseException {boolean isMember = true;
...
String cubeName = cubeId.name;
        ...
        {if ("" != null) return factory.makeCalculatedFormula(cubeName, formula);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public QueryPart refreshStatement() throws ParseException {Id c;
    jj_consume_token(REFRESH);
    jj_consume_token(CUBE);
    c = compoundId();
String cubeName = ((Id.NameSegment) c.getElement(0)).name;
        {if ("" != null) return factory.makeRefresh(cubeName);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public QueryPart updateStatement() throws ParseException {Id c;
...
String cubeName = ((Id.NameSegment) c.getElement(0)).name;
        {if ("" != null) return factory.makeUpdate(cubeName, list);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public Update.UpdateClause updateClause() throws ParseException {Exp t, v, w = null;
    ...
    case USE_WEIGHTED_INCREMENT:{
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
      case USE_EQUAL_ALLOCATION:{
        jj_consume_token(USE_EQUAL_ALLOCATION);
a = Update.Allocation.USE_EQUAL_ALLOCATION;
        break;
        }
      case USE_EQUAL_INCREMENT:{
        jj_consume_token(USE_EQUAL_INCREMENT);
a = Update.Allocation.USE_EQUAL_INCREMENT;
        break;
        }
      case USE_WEIGHTED_ALLOCATION:{
        jj_consume_token(USE_WEIGHTED_ALLOCATION);
a = Update.Allocation.USE_WEIGHTED_ALLOCATION;
        switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
        case BY:{
          jj_consume_token(BY);
          w = unaliasedExpression();
          break;
          }
        default:
          jj_la1[56] = jj_gen;
      ...
      case USE_WEIGHTED_INCREMENT:{
        jj_consume_token(USE_WEIGHTED_INCREMENT);
...
{if ("" != null) return new Update.UpdateClause(t, v, a, w);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public QueryPart transactionCommandStatement() throws ParseException {TransactionCommand.Command c;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case BEGIN:{
      jj_consume_token(BEGIN);
c = TransactionCommand.Command.BEGIN;
      break;
      }
    case COMMIT:{
      jj_consume_token(COMMIT);
c = TransactionCommand.Command.COMMIT;
      break;
      }
    case ROLLBACK:{
      jj_consume_token(ROLLBACK);
c = TransactionCommand.Command.ROLLBACK;
      break;
      }
    default:
      jj_la1[60] = jj_gen;
...
{if ("" != null) return factory.makeTransactionCommand(c);}
    throw new IllegalStateException ("Missing return statement in function");
}
...
//                                 [, <memberPropertyDefinition>...]
  final public Formula memberSpecification() throws ParseException {Id m;
    Exp e;
    List<MemberProperty> l = new ArrayList<MemberProperty>();
    MemberProperty mp;
    jj_consume_token(MEMBER);
...
{if ("" != null) return new Formula(m, e, toMemberPropertyArray(l));}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public Exp formulaExpression() throws ParseException {Exp e;
    if (jj_2_9(2147483647)) {
      jj_consume_token(SINGLE_QUOTED_STRING);
// Support archaic syntax "WITH MEMBER m AS ' <expr> ' ...";
        // "WITH MEMBER m AS <expr>" is now preferred.
        {if ("" != null) return recursivelyParseExp(stripQuotes(token.image, "'", "'", "''"));}
    } else {
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
      case CASE:
      case CAST:
...
{if ("" != null) return e;}
  ...
  final public MemberProperty memberPropertyDefinition() throws ParseException {Id.NameSegment id;
    Exp e;
    id = nameSegment();
    jj_consume_token(EQ);
    e = expression();
{if ("" != null) return new MemberProperty(id.name, e);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public Formula setSpecification() throws ParseException {Id n;
    Exp e;
    jj_consume_token(SET);
    n = compoundId();
    jj_consume_token(AS);
    e = formulaExpression();
{if ("" != null) return new Formula(n, e);}
    throw new IllegalStateException ("Missing return statement in function");
}

// <axisSpecification> ::= [NON EMPTY] <set> [<dimProps>] ON <axis_name>
  final public QueryAxis axisSpecification() throws ParseException {boolean nonEmpty = false;
    Exp e;
...
{if ("" != null) return new QueryAxis(
  ...
  final public QueryPart drillthroughStatement() throws ParseException {int m = 0, f = 0;
    List<Exp> rl = null;
    Query s;
...
{if ("" != null) return factory.makeDrillThrough(s, m, f, rl);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public List<Exp> returnItemList() throws ParseException {List<Exp> list = new ArrayList<Exp>();
    Id i;
    i = returnItem();
list.add(i);
    label_23:
...
{if ("" != null) return list;}
  ...
  final public Id returnItem() throws ParseException {Id i;
...
{if ("" != null) return i;}
  ...
  final public QueryPart explainStatement() throws ParseException {QueryPart qp;
...
{if ("" != null) return factory.makeExplain(qp);}
    throw new IllegalStateException ("Missing return statement in function");
}
  ...
  private boolean jj_3R_70()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x4000,0x4000,0x0,0x0,0x4000,0x0,0x0,0x2,0x600040c0,0x23800000,0x0,0x0,0x3000000,0x20800000,0x0,0x0,0x0,0x0,0x400040c0,0x0,0x0,0x0,0x600040c0,0x0,0x0,0x400040c0,0x600040c0,0x0,0x10000,0x4,0x600040c0,0x0,0x0,0x89410,0x8000,0x0,0x4000,0x0,0x8000000,0x8000000,0x0,0x0,0x700040c0,0x0,0x100,0x0,0x100,0x0,0x0,0x700040c0,0x0,0x4000,0x8000000,0x0,0x2000,0x0,0x20,0x20,0x0,0x0,0x1010,0x0,0x0,0x600040c0,0x10000000,0x4000,0x0,0x4000,0x8,0xa08,0x4000000,0x100000,0x0,0x0,0x8000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x8,0x8,0x0,0x0,0x8,0x400001,0x400001,0x0,0x1000008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000008,0x0,0x0,0x0,0x1000008,0x0,0x0,0x8,0x1000008,0x100000,0x0,0x0,0x1000008,0x0,0x0,0x808250,0x800200,0x0,0x8,0x200000,0x800,0x800,0x800000,0x0,0x1000008,0x200000,0x0,0x0,0x8,0x0,0x0,0x1000008,0x200000,0x8,0x800,0x0,0x0,0x0,0x0,0x0,0xf0000,0xf0000,0x40,0x6000,0x0,0x1000008,0x0,0x0,0x0,0x8,0x0,0x182,0x0,0x0,0x20,0x0,0x800200,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x4000000,0x4000000,0x0,0x0,0x0,0x200,0x200,0x0,0xbc550000,0x2ae000,0x2ae000,0x2ae000,0x0,0x0,0x500800,0x500800,0x2000080,0x2000080,0xbc550000,0x1000,0x40000,0x38000000,0xbc550000,0x100,0x40000,0xbc050000,0xbc550000,0x0,0x0,0x0,0xbc550000,0x400,0x400,0x0,0x0,0x400,0x4000000,0x0,0x0,0x0,0x0,0x400,0xbc550000,0x0,0x0,0x400,0x0,0x400,0x80,0xbc550000,0x0,0x4040000,0x0,0x400,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0xbc550000,0x0,0x0,0x400,0x0,0x38000000,0x38000000,0x0,0x0,0x0,0x400,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x3c,0xc,0x30,0x30,0x0,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0xd,0x0,0x0,0xd,0xd,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0x0,0x0,0x3c,0x0,0x0,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0xd,0x0,0x3c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
   ...
   */
  public MdxParserImpl(final java.io.InputStream stream) {
	  this(stream, null);
  }
   ...
   */
  public MdxParserImpl(final java.io.InputStream stream, final String encoding) {
   try {
   ...
   */
  public MdxParserImpl(final java.io.Reader stream) {
