...
public class Token implements mdxConstants, Node {
  ...
  /**
   * It would be extremely rare that an application programmer would use this
   * method. It needs to be public because it is part of the
   * org.eclipse.daanse.mdx.parser.impl.Node interface.
   */
  ...
  /**
   * @return the mdxLexer object that handles location info for the tokens.
   */
  ...
  /**
   * It should be exceedingly rare that an application programmer needs to use
   * this method.
   */
  ...
  /**
   * @return the next _cached_ regular (i.e. parsed) token or null
   */
  ...
  /**
   * @return the previous regular (i.e. parsed) token or null
   */
  ...
  public Iterator<Token> precedingTokens() {
    return new Iterator<Token>() {
      ...
      public Token next() {
        ...
        if (previous == null)
          throw new java.util.NoSuchElementException("No previous token!");
  ...
  /**
   * @return a list of the unparsed tokens preceding this one in the order they
   *         appear in the input
   */
  ...
  public Iterator<Token> followingTokens() {
    return new java.util.Iterator<Token>() {
      ...
      public Token next() {
        ...
        if (next == null)
          throw new java.util.NoSuchElementException("No next token!");
