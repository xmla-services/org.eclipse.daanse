...
public class ParseException extends RuntimeException implements mdxConstants {
  ...
  private void setInfo(MDXParser parser, Token token, EnumSet<TokenType> expectedTypes,
      List<MDXParser.NonTerminalCall> callStack) {
    this.parser = parser;
  ...
  public ParseException(MDXParser parser, Token token, EnumSet<TokenType> expectedTypes,
      List<MDXParser.NonTerminalCall> callStack) {
  ...
  private void adjustStackTrace() {
    if (alreadyAdjusted || callStack == null || callStack.isEmpty())
      return;
