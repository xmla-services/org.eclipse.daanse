...
public class MdxParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MdxGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getSingleFormulaSpecificationAccess().getAlternatives(), "rule__SingleFormulaSpecification__Alternatives");
			builder.put(grammarAccess.getSetSpecificationAccess().getAlternatives_3(), "rule__SetSpecification__Alternatives_3");
			builder.put(grammarAccess.getMemberSpecificationAccess().getAlternatives_3_0(), "rule__MemberSpecification__Alternatives_3_0");
			builder.put(grammarAccess.getCellPropertyAccess().getAlternatives(), "rule__CellProperty__Alternatives");
			builder.put(grammarAccess.getMandatoryCellPropertyAccess().getAlternatives(), "rule__MandatoryCellProperty__Alternatives");
			builder.put(grammarAccess.getValueExpressionAccess().getAlternatives_1(), "rule__ValueExpression__Alternatives_1");
			...
			builder.put(grammarAccess.getValueExpressionPrimaryAccess().getAlternatives_1_1(), "rule__ValueExpressionPrimary__Alternatives_1_1");
			builder.put(grammarAccess.getValueExpressionPrimary0Access().getAlternatives(), "rule__ValueExpressionPrimary0__Alternatives");
			builder.put(grammarAccess.getCompatingOperatorAccess().getAlternatives(), "rule__CompatingOperator__Alternatives");
			builder.put(grammarAccess.getIdentifierAccess().getAlternatives(), "rule__Identifier__Alternatives");
			builder.put(grammarAccess.getUnquotedIdentifierAccess().getAlternatives(), "rule__UnquotedIdentifier__Alternatives");
			...
			builder.put(grammarAccess.getMemberSpecificationAccess().getGroup_3_0_0(), "rule__MemberSpecification__Group_3_0_0__0");
			builder.put(grammarAccess.getAxisSpecificationListAccess().getGroup(), "rule__AxisSpecificationList__Group__0");
			builder.put(grammarAccess.getAxisSpecificationListAccess().getGroup_1(), "rule__AxisSpecificationList__Group_1__0");
			builder.put(grammarAccess.getMemberPropertyDefListAccess().getGroup(), "rule__MemberPropertyDefList__Group__0");
			builder.put(grammarAccess.getMemberPropertyDefListAccess().getGroup_1(), "rule__MemberPropertyDefList__Group_1__0");
			builder.put(grammarAccess.getMemberPropertyDefinitionAccess().getGroup(), "rule__MemberPropertyDefinition__Group__0");
			...
			builder.put(grammarAccess.getValueExpressionPrimaryAccess().getGroup_1(), "rule__ValueExpressionPrimary__Group_1__0");
			builder.put(grammarAccess.getValueExpressionPrimary0Access().getGroup_1(), "rule__ValueExpressionPrimary0__Group_1__0");
			builder.put(grammarAccess.getValueExpressionPrimary0Access().getGroup_2(), "rule__ValueExpressionPrimary0__Group_2__0");
			...
			builder.put(grammarAccess.getMdxStatementAccess().getStatementAssignment(), "rule__MdxStatement__StatementAssignment");
		}
	}
