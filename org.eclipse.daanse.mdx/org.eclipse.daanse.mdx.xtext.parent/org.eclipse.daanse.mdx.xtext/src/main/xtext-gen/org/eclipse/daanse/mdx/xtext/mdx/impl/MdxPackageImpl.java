...
public class MdxPackageImpl extends EPackageImpl implements MdxPackage
{
   ...
   *
   * <p>This method is used to initialize {@link MdxPackage#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (MdxPackage)EPackage.Registry.INSTANCE.getEPackage(MdxPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMdxPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MdxPackageImpl theMdxPackage = registeredMdxPackage instanceof MdxPackageImpl ? (MdxPackageImpl)registeredMdxPackage : new MdxPackageImpl();
