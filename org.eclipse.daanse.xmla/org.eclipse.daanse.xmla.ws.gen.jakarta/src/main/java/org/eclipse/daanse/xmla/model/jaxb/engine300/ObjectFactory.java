...
import com.microsoft.schemas.analysisservices._2003.engine.ImpersonationInfo;
 ...
 * generated in the org.eclipse.daanse.xmla.model.jaxb.engine300 package. 
...
public class ObjectFactory {
    ...
    private final static QName _DataEmbeddingStyle_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "DataEmbeddingStyle");
    private final static QName _QueryImpersonationInfo_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "QueryImpersonationInfo");
    private final static QName _QueryHints_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "QueryHints");
    private final static QName _StringStoresCompatibilityLevel_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "StringStoresCompatibilityLevel");
    private final static QName _CurrentStringStoresCompatibilityLevel_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "CurrentStringStoresCompatibilityLevel");
    private final static QName _ProcessingState_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "ProcessingState");
    private final static QName _StructureType_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "StructureType");
    private final static QName _ServerMode_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2011/engine/300", "ServerMode");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.eclipse.daanse.xmla.model.jaxb.engine300
     * 
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ImpersonationInfo }{@code >}
     */
