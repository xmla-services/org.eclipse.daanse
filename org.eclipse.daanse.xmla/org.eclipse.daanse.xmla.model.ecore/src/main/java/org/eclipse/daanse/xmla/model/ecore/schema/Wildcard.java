 ...
 * '<em><b>Wildcard</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getNamespace
 * <em>Namespace</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getProcessContents
 * <em>Process Contents</em>}</li>
 * </ul>
 *
...
public interface Wildcard extends Annotated {
  /**
   * Returns the value of the '<em><b>Namespace</b></em>' attribute. The default
   * value is <code>"##any"</code>. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   *        dataType="org.eclipse.daanse.xmla.model.ecore.schema.NamespaceList"
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getNamespace
   * <em>Namespace</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Process Contents</b></em>' attribute. The
   * default value is <code>"strict"</code>. The literals are from the enumeration
   ...
   * @model default="strict" unsettable="true" extendedMetaData="kind='attribute'
   ...
   * <em>Process Contents</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getProcessContents
   * <em>Process Contents</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return whether the value of the '<em>Process Contents</em>' attribute is
   *         set.
   * @see #unsetProcessContents()
   * @see #getProcessContents()
   * @see #setProcessContents(ProcessContentsType)
