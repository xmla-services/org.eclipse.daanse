...
public class Engine800PackageImpl extends EPackageImpl implements Engine800Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine800Package#eINSTANCE} when
  ...
  public static Engine800Package init() {
    if (isInited)
      return (Engine800Package) EPackage.Registry.INSTANCE.getEPackage(Engine800Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine800Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine800PackageImpl theEngine800Package = registeredEngine800Package instanceof Engine800PackageImpl
        ? (Engine800PackageImpl) registeredEngine800Package
        : new Engine800PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_DaxOptimizationMode(), this.getDaxOptimizationModeType(), "daxOptimizationMode",
        null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getDocumentRoot_SubscriptionId(), theXMLTypePackage.getString(), "subscriptionId", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(daxOptimizationModeTypeEEnum, source, new String[] { "name", "DaxOptimizationMode_._type" });
    ...
    addAnnotation(getDocumentRoot_DaxOptimizationMode(), source,
        new String[] { "kind", "element", "name", "DaxOptimizationMode", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_SubscriptionId(), source,
        new String[] { "kind", "element", "name", "SubscriptionId", "namespace", "##targetNamespace" });
  }
