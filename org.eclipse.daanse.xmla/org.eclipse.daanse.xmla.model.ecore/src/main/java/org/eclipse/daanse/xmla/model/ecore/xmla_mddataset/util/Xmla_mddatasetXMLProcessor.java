 ...
 * @generated
 */
@Component(name = Xmla_mddatasetPackage.eNAME
    + "XMLProcessor", service = Xmla_mddatasetXMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Xmla_mddatasetXMLProcessor extends XMLProcessor {
   ...
   * Xmla_mddatasetResourceFactoryImpl factory. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
