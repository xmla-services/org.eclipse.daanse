 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getCurrentStringStoresCompatibilityLevel
 * <em>Current String Stores Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getDataEmbeddingStyle
 * <em>Data Embedding Style</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getProcessingState
 * <em>Processing State</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getQueryHints
 * <em>Query Hints</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getQueryImpersonationInfo
 * <em>Query Impersonation Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getServerMode
 * <em>Server Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getStringStoresCompatibilityLevel
 * <em>String Stores Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.DocumentRoot#getStructureType
 * <em>Structure Type</em>}</li>
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Current String Stores Compatibility
   * Level</b></em>' attribute. The literals are from the enumeration
   * {@link org.eclipse.daanse.xmla.model.ecore.engine300.CurrentStringStoresCompatibilityLevelType}.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the value of the '<em>Current String Stores Compatibility Level</em>'
   *         attribute.
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   ...
   * <em>Current String Stores Compatibility Level</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Current String Stores Compatibility
   *              Level</em>' attribute.
   * @see org.eclipse.daanse.xmla.model.ecore.engine300.CurrentStringStoresCompatibilityLevelType
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element'
   *        name='DataEmbeddingStyle' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Data Embedding Style</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Processing State</b></em>' attribute. The
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element' name='ProcessingState'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Processing State</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   *        extendedMetaData="kind='element' name='QueryHints'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Query Hints</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Query Impersonation Info</b></em>'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the value of the '<em>Query Impersonation Info</em>' containment
   *         reference.
   ...
   *        derived="true" extendedMetaData="kind='element'
   *        name='QueryImpersonationInfo' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Query Impersonation Info</em>}' containment reference. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Query Impersonation Info</em>'
  ...
  /**
   * Returns the value of the '<em><b>Server Mode</b></em>' attribute. The
   * literals are from the enumeration
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element' name='ServerMode'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Server Mode</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>String Stores Compatibility Level</b></em>'
   ...
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the value of the '<em>String Stores Compatibility Level</em>'
   *         attribute.
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element'
   *        name='StringStoresCompatibilityLevel' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>String Stores Compatibility Level</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>String Stores Compatibility
   *              Level</em>' attribute.
   * @see org.eclipse.daanse.xmla.model.ecore.engine300.StringStoresCompatibilityLevelType
  ...
  /**
   * Returns the value of the '<em><b>Structure Type</b></em>' attribute. The
   * literals are from the enumeration
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element' name='StructureType'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Structure Type</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
