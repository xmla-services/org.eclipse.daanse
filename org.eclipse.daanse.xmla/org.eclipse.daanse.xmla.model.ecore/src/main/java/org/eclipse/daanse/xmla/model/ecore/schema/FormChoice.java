 ...
 * '<em><b>Form Choice</b></em>', and utility methods for working with them.
...
public enum FormChoice implements Enumerator {
  ...
  /**
   * The '<em><b>Unqualified</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Unqualified</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #UNQUALIFIED
   ...
   * @generated
   */
  private static final FormChoice[] VALUES_ARRAY = new FormChoice[] { QUALIFIED, UNQUALIFIED, };
  ...
  /**
   * Returns the '<em><b>Form Choice</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>Form Choice</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
