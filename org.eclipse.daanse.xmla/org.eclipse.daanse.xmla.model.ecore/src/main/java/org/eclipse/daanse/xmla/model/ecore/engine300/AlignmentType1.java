 ...
 * '<em><b>Alignment Type1</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum AlignmentType1 implements Enumerator {
   ...
   * @generated
   */
  private static final AlignmentType1[] VALUES_ARRAY = new AlignmentType1[] { DEFAULT, LEFT, RIGHT, CENTER, };

  /**
   * A public read-only list of all the '<em><b>Alignment Type1</b></em>'
  ...
  /**
   * Returns the '<em><b>Alignment Type1</b></em>' literal with the specified
