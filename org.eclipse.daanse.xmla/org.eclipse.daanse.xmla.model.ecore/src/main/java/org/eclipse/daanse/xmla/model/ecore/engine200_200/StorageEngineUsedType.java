 ...
 * '<em><b>Storage Engine Used Type</b></em>', and utility methods for working
...
public enum StorageEngineUsedType implements Enumerator {
  /**
   * The '<em><b>Traditional</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>In Memory</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #IN_MEMORY_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Mixed</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #MIXED_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Tabular Metadata</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Traditional</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #TRADITIONAL
  ...
  /**
   * The '<em><b>In Memory</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #IN_MEMORY
   * @model name="InMemory"
  ...
  /**
   * The '<em><b>Tabular Metadata</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   ...
   * @generated
   */
  private static final StorageEngineUsedType[] VALUES_ARRAY = new StorageEngineUsedType[] { TRADITIONAL, IN_MEMORY,
      MIXED, TABULAR_METADATA, };

  /**
   * A public read-only list of all the '<em><b>Storage Engine Used Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Storage Engine Used Type</b></em>' literal with the
