 ...
 * @generated
 */
@Component(name = Engine400Package.eNAME
    + "XMLProcessor", service = Engine400XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine400XMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the Engine400ResourceFactoryImpl
