 ...
 * '<em><b>Authenticate Response Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.ext.impl.AuthenticateResponseTypeImpl#getReturn
 * <em>Return</em>}</li>
 * </ul>
 *
 * @generated
...
public class AuthenticateResponseTypeImpl extends MinimalEObjectImpl.Container implements AuthenticateResponseType {
  /**
   * The cached value of the '{@link #getReturn() <em>Return</em>}' containment
  ...
  public NotificationChain basicSetReturn(ReturnType newReturn, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          ExtPackage.AUTHENTICATE_RESPONSE_TYPE__RETURN, oldReturn, newReturn);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newReturn != return_) {
      ...
      if (return_ != null)
        msgs = ((InternalEObject) return_).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - ExtPackage.AUTHENTICATE_RESPONSE_TYPE__RETURN, null, msgs);
      if (newReturn != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ExtPackage.AUTHENTICATE_RESPONSE_TYPE__RETURN, newReturn,
          newReturn));
  }
