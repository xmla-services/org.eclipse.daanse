...
public class Xmla_exceptionAdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
  protected Xmla_exceptionSwitch<Adapter> modelSwitch = new Xmla_exceptionSwitch<Adapter>() {
    @Override
   ...
   * <em>Error Type</em>}'. <!-- begin-user-doc --> This default implementation
   ...
   * <em>Exception</em>}'. <!-- begin-user-doc --> This default implementation
   * returns null so that we can easily ignore cases; it's useful to ignore a case
   * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
   ...
   * <em>Message Location</em>}'. <!-- begin-user-doc --> This default
   ...
   * <em>Start Type</em>}'. <!-- begin-user-doc --> This default implementation
   * returns null so that we can easily ignore cases; it's useful to ignore a case
   * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
   ...
   * <em>Warning Type</em>}'. <!-- begin-user-doc --> This default implementation
   * returns null so that we can easily ignore cases; it's useful to ignore a case
   * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
