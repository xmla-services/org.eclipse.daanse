 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getAllowedRowsExpression
 * <em>Allowed Rows Expression</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getDirectQueryMode
 * <em>Direct Query Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getDirectQueryUsage
 * <em>Direct Query Usage</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.DocumentRootImpl#getXEvent
 * <em>XEvent</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getAllowedRowsExpression() <em>Allowed Rows
  ...
  /**
   * The default value of the '{@link #getDirectQueryMode() <em>Direct Query
  ...
  /**
   * The default value of the '{@link #getDirectQueryUsage() <em>Direct Query
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine300_300Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine300_300Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine300_300Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine300_300Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setAllowedRowsExpression(String newAllowedRowsExpression) {
    ((FeatureMap.Internal) getMixed()).set(Engine300_300Package.Literals.DOCUMENT_ROOT__ALLOWED_ROWS_EXPRESSION,
        newAllowedRowsExpression);
  }
  ...
  public void setDirectQueryMode(DirectQueryModeType newDirectQueryMode) {
    ((FeatureMap.Internal) getMixed()).set(Engine300_300Package.Literals.DOCUMENT_ROOT__DIRECT_QUERY_MODE,
        newDirectQueryMode);
  }
  ...
  public void setDirectQueryUsage(DirectQueryUsageType newDirectQueryUsage) {
    ((FeatureMap.Internal) getMixed()).set(Engine300_300Package.Literals.DOCUMENT_ROOT__DIRECT_QUERY_USAGE,
        newDirectQueryUsage);
  }
  ...
  public NotificationChain basicSetXEvent(XEventType newXEvent, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(Engine300_300Package.Literals.DOCUMENT_ROOT__XEVENT, newXEvent,
        msgs);
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Engine300_300Package.DOCUMENT_ROOT__ALLOWED_ROWS_EXPRESSION:
      return ALLOWED_ROWS_EXPRESSION_EDEFAULT == null ? getAllowedRowsExpression() != null
          : !ALLOWED_ROWS_EXPRESSION_EDEFAULT.equals(getAllowedRowsExpression());
    case Engine300_300Package.DOCUMENT_ROOT__DIRECT_QUERY_MODE:
