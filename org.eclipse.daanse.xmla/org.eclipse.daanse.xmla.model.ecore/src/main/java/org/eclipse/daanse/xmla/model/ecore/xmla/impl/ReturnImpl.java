 ...
 * '<em><b>Return</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ReturnImpl#getRoot
 * <em>Root</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ReturnImpl#getRoot1
 * <em>Root1</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ReturnImpl#getRoot2
 * <em>Root2</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ReturnImpl#getResults
 * <em>Results</em>}</li>
 * </ul>
 *
 * @generated
...
public class ReturnImpl extends MinimalEObjectImpl.Container implements Return {
  ...
  /**
   * The cached value of the '{@link #getRoot1() <em>Root1</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getRoot1()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getRoot2() <em>Root2</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getRoot2()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getResults() <em>Results</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getResults()
   * @generated
  ...
  public NotificationChain basicSetRoot(Mddataset newRoot, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.RETURN__ROOT, oldRoot,
          newRoot);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setRoot(Mddataset newRoot) {
    if (newRoot != root) {
      ...
      if (root != null)
        msgs = ((InternalEObject) root).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT, null,
            msgs);
      if (newRoot != null)
        msgs = ((InternalEObject) newRoot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT, null,
            msgs);
  ...
  public NotificationChain basicSetRoot1(Rowset newRoot1, NotificationChain msgs) {
    ...
    root1 = newRoot1;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.RETURN__ROOT1,
          oldRoot1, newRoot1);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setRoot1(Rowset newRoot1) {
    if (newRoot1 != root1) {
      NotificationChain msgs = null;
      if (root1 != null)
        msgs = ((InternalEObject) root1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT1, null,
            msgs);
      if (newRoot1 != null)
        msgs = ((InternalEObject) newRoot1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT1, null,
            msgs);
  ...
  public NotificationChain basicSetRoot2(Emptyresult newRoot2, NotificationChain msgs) {
    ...
    root2 = newRoot2;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.RETURN__ROOT2,
          oldRoot2, newRoot2);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setRoot2(Emptyresult newRoot2) {
    if (newRoot2 != root2) {
      NotificationChain msgs = null;
      if (root2 != null)
        msgs = ((InternalEObject) root2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT2, null,
            msgs);
      if (newRoot2 != null)
        msgs = ((InternalEObject) newRoot2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__ROOT2, null,
            msgs);
  ...
  public NotificationChain basicSetResults(ResultsType newResults, NotificationChain msgs) {
    ...
    results = newResults;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.RETURN__RESULTS,
  ...
  public void setResults(ResultsType newResults) {
    if (newResults != results) {
      NotificationChain msgs = null;
      if (results != null)
        msgs = ((InternalEObject) results).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__RESULTS,
            null, msgs);
      if (newResults != null)
        msgs = ((InternalEObject) newResults).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.RETURN__RESULTS,
            null, msgs);
