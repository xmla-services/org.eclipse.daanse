...
public interface Xmla_exceptionFactory extends EFactory {
   ...
   * @generated
   */
  Xmla_exceptionFactory eINSTANCE = org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.Xmla_exceptionFactoryImpl
      .init();

  /**
   * Returns a new object of class '<em>End Type</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Error Type</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Exception</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Messages</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Start Type</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Warning Type</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
