...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Norm
 * Tuple Set Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.NormTupleSetTypeImpl#getNormTuples
 * <em>Norm Tuples</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.NormTupleSetTypeImpl#getMembersLookup
 * <em>Members Lookup</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormTupleSetTypeImpl extends MinimalEObjectImpl.Container implements NormTupleSetType {
  /**
   * The cached value of the '{@link #getNormTuples() <em>Norm Tuples</em>}'
  ...
  /**
   * The cached value of the '{@link #getMembersLookup() <em>Members Lookup</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public NotificationChain basicSetNormTuples(NormTuplesType newNormTuples, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          MsxmlaPackage.NORM_TUPLE_SET_TYPE__NORM_TUPLES, oldNormTuples, newNormTuples);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setNormTuples(NormTuplesType newNormTuples) {
    if (newNormTuples != normTuples) {
      ...
      if (normTuples != null)
        msgs = ((InternalEObject) normTuples).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - MsxmlaPackage.NORM_TUPLE_SET_TYPE__NORM_TUPLES, null, msgs);
      if (newNormTuples != null)
        msgs = ((InternalEObject) newNormTuples).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - MsxmlaPackage.NORM_TUPLE_SET_TYPE__NORM_TUPLES, null, msgs);
      msgs = basicSetNormTuples(newNormTuples, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MsxmlaPackage.NORM_TUPLE_SET_TYPE__NORM_TUPLES,
          newNormTuples, newNormTuples));
  }
  ...
  public NotificationChain basicSetMembersLookup(MembersLookupType newMembersLookup, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          MsxmlaPackage.NORM_TUPLE_SET_TYPE__MEMBERS_LOOKUP, oldMembersLookup, newMembersLookup);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setMembersLookup(MembersLookupType newMembersLookup) {
    if (newMembersLookup != membersLookup) {
      ...
      if (membersLookup != null)
        msgs = ((InternalEObject) membersLookup).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - MsxmlaPackage.NORM_TUPLE_SET_TYPE__MEMBERS_LOOKUP, null, msgs);
      if (newMembersLookup != null)
        msgs = ((InternalEObject) newMembersLookup).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - MsxmlaPackage.NORM_TUPLE_SET_TYPE__MEMBERS_LOOKUP, null, msgs);
      msgs = basicSetMembersLookup(newMembersLookup, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MsxmlaPackage.NORM_TUPLE_SET_TYPE__MEMBERS_LOOKUP,
          newMembersLookup, newMembersLookup));
  }
