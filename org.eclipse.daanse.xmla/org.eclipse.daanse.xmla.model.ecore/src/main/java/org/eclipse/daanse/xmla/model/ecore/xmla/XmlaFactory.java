...
public interface XmlaFactory extends EFactory {
  ...
  /**
   * Returns a new object of class '<em>Discover</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Property List</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Restrictions</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Annotations</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Event Session</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
