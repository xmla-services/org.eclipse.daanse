 ...
 * '<em><b>All NNI Member1</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum AllNNIMember1 implements Enumerator {
  /**
   * The '<em><b>Unbounded</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #UNBOUNDED_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Unbounded</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #UNBOUNDED
   ...
   * @generated
   */
  private static final AllNNIMember1[] VALUES_ARRAY = new AllNNIMember1[] { UNBOUNDED, };

  /**
   * A public read-only list of all the '<em><b>All NNI Member1</b></em>'
  ...
  /**
   * Returns the '<em><b>All NNI Member1</b></em>' literal with the specified
