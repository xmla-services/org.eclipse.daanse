 ...
 * '<em><b>SQL Query Mode</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum SQLQueryMode implements Enumerator {
  ...
  /**
   * The '<em><b>Calculated</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Include Empty</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Data Keys</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #DATA_KEYS_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Calculated</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #CALCULATED
  ...
  /**
   * The '<em><b>Include Empty</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #INCLUDE_EMPTY
  ...
  /**
   * The '<em><b>Data Keys</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #DATA_KEYS
   * @model name="DataKeys"
   ...
   * @generated
   */
  private static final SQLQueryMode[] VALUES_ARRAY = new SQLQueryMode[] { DATA, CALCULATED, INCLUDE_EMPTY, DATA_KEYS, };

  /**
   * A public read-only list of all the '<em><b>SQL Query Mode</b></em>'
  ...
  /**
   * Returns the '<em><b>SQL Query Mode</b></em>' literal with the specified
  ...
  public static SQLQueryMode get(int value) {
    ...
    case CALCULATED_VALUE:
      return CALCULATED;
    case INCLUDE_EMPTY_VALUE:
      return INCLUDE_EMPTY;
    case DATA_KEYS_VALUE:
      return DATA_KEYS;
    }
    return null;
  }
