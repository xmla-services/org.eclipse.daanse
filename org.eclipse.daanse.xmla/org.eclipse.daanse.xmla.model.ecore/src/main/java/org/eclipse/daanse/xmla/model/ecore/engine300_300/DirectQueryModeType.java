 ...
 * '<em><b>Direct Query Mode Type</b></em>', and utility methods for working
...
public enum DirectQueryModeType implements Enumerator {
  ...
  /**
   * The '<em><b>Direct Query</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Direct Query</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #DIRECT_QUERY
   ...
   * @generated
   */
  private static final DirectQueryModeType[] VALUES_ARRAY = new DirectQueryModeType[] { IN_MEMORY,
      DIRECT_QUERY_WITH_IN_MEMORY, IN_MEMORY_WITH_DIRECT_QUERY, DIRECT_QUERY, };

  /**
   * A public read-only list of all the '<em><b>Direct Query Mode Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Direct Query Mode Type</b></em>' literal with the
  ...
  public static DirectQueryModeType get(int value) {
    ...
    case IN_MEMORY_VALUE:
      return IN_MEMORY;
    case DIRECT_QUERY_WITH_IN_MEMORY_VALUE:
      return DIRECT_QUERY_WITH_IN_MEMORY;
    case IN_MEMORY_WITH_DIRECT_QUERY_VALUE:
      return IN_MEMORY_WITH_DIRECT_QUERY;
    case DIRECT_QUERY_VALUE:
      return DIRECT_QUERY;
    }
    return null;
  }
