...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Union
 * Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.UnionTypeImpl#getSimpleType
 * <em>Simple Type</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.UnionTypeImpl#getMemberTypes
...
public class UnionTypeImpl extends AnnotatedImpl implements UnionType {
  ...
  /**
   * The default value of the '{@link #getMemberTypes() <em>Member Types</em>}'
  ...
  /**
   * The cached value of the '{@link #getMemberTypes() <em>Member Types</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMemberTypes()
   * @generated
  ...
  public EList<LocalSimpleType> getSimpleType() {
    if (simpleType == null) {
      simpleType = new EObjectContainmentEList<LocalSimpleType>(LocalSimpleType.class, this,
          SchemaPackage.UNION_TYPE__SIMPLE_TYPE);
    }
    return simpleType;
  }
  ...
  public void setMemberTypes(List<QName> newMemberTypes) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.UNION_TYPE__MEMBER_TYPES, oldMemberTypes,
          memberTypes));
  }
