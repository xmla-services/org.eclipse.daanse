 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getCurrentStringStoresCompatibilityLevel
 * <em>Current String Stores Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getDataEmbeddingStyle
 * <em>Data Embedding Style</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getProcessingState
 * <em>Processing State</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getQueryHints
 * <em>Query Hints</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getQueryImpersonationInfo
 * <em>Query Impersonation Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getServerMode
 * <em>Server Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getStringStoresCompatibilityLevel
 * <em>String Stores Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300.impl.DocumentRootImpl#getStructureType
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getCurrentStringStoresCompatibilityLevel()
  ...
  /**
   * The default value of the '{@link #getDataEmbeddingStyle() <em>Data Embedding
  ...
  /**
   * The default value of the '{@link #getProcessingState() <em>Processing
  ...
  /**
   * The default value of the '{@link #getQueryHints() <em>Query Hints</em>}'
  ...
  /**
   * The default value of the '{@link #getServerMode() <em>Server Mode</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getServerMode()
   * @generated
  ...
  /**
   * The default value of the '{@link #getStringStoresCompatibilityLevel()
  ...
  /**
   * The default value of the '{@link #getStructureType() <em>Structure
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine300Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine300Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine300Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine300Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public CurrentStringStoresCompatibilityLevelType getCurrentStringStoresCompatibilityLevel() {
    return (CurrentStringStoresCompatibilityLevelType) getMixed()
        .get(Engine300Package.Literals.DOCUMENT_ROOT__CURRENT_STRING_STORES_COMPATIBILITY_LEVEL, true);
  }
   ...
   * @generated
   */
  public void setCurrentStringStoresCompatibilityLevel(
      CurrentStringStoresCompatibilityLevelType newCurrentStringStoresCompatibilityLevel) {
    ((FeatureMap.Internal) getMixed()).set(
        Engine300Package.Literals.DOCUMENT_ROOT__CURRENT_STRING_STORES_COMPATIBILITY_LEVEL,
        newCurrentStringStoresCompatibilityLevel);
  }
  ...
  public void setDataEmbeddingStyle(DataEmbeddingStyleType newDataEmbeddingStyle) {
    ((FeatureMap.Internal) getMixed()).set(Engine300Package.Literals.DOCUMENT_ROOT__DATA_EMBEDDING_STYLE,
        newDataEmbeddingStyle);
  }
  ...
  public void setProcessingState(ProcessingStateType newProcessingState) {
    ((FeatureMap.Internal) getMixed()).set(Engine300Package.Literals.DOCUMENT_ROOT__PROCESSING_STATE,
        newProcessingState);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetQueryImpersonationInfo(ImpersonationInfo newQueryImpersonationInfo,
      NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Engine300Package.Literals.DOCUMENT_ROOT__QUERY_IMPERSONATION_INFO, newQueryImpersonationInfo, msgs);
  }
  ...
  public void setQueryImpersonationInfo(ImpersonationInfo newQueryImpersonationInfo) {
    ((FeatureMap.Internal) getMixed()).set(Engine300Package.Literals.DOCUMENT_ROOT__QUERY_IMPERSONATION_INFO,
        newQueryImpersonationInfo);
  }
  ...
  public StringStoresCompatibilityLevelType getStringStoresCompatibilityLevel() {
    return (StringStoresCompatibilityLevelType) getMixed()
        .get(Engine300Package.Literals.DOCUMENT_ROOT__STRING_STORES_COMPATIBILITY_LEVEL, true);
  }
  ...
  public void setStringStoresCompatibilityLevel(StringStoresCompatibilityLevelType newStringStoresCompatibilityLevel) {
    ((FeatureMap.Internal) getMixed()).set(Engine300Package.Literals.DOCUMENT_ROOT__STRING_STORES_COMPATIBILITY_LEVEL,
        newStringStoresCompatibilityLevel);
  }
