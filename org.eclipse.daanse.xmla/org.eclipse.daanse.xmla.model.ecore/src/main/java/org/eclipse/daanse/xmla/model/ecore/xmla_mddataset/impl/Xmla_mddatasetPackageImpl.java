...
public class Xmla_mddatasetPackageImpl extends EPackageImpl implements Xmla_mddatasetPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link Xmla_mddatasetPackage#eINSTANCE}
  ...
  public static Xmla_mddatasetPackage init() {
    if (isInited)
      return (Xmla_mddatasetPackage) EPackage.Registry.INSTANCE.getEPackage(Xmla_mddatasetPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmla_mddatasetPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Xmla_mddatasetPackageImpl theXmla_mddatasetPackage = registeredXmla_mddatasetPackage instanceof Xmla_mddatasetPackageImpl
        ? (Xmla_mddatasetPackageImpl) registeredXmla_mddatasetPackage
        : new Xmla_mddatasetPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    Xmla_exceptionPackage theXmla_exceptionPackage = (Xmla_exceptionPackage) EPackage.Registry.INSTANCE
        .getEPackage(Xmla_exceptionPackage.eNS_URI);
    ...
    initEReference(getAxes_Axis(), this.getAxis(), null, "axis", null, 1, -1, Axes.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(axesInfoEClass, AxesInfo.class, "AxesInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAxesInfo_AxisInfo(), this.getAxisInfo(), null, "axisInfo", null, 1, -1, AxesInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(axisEClass, Axis.class, "Axis", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAxis_SetType(), ecorePackage.getEFeatureMapEntry(), "setType", null, 0, -1, Axis.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAxis_Members(), this.getMembersType(), null, "members", null, 0, -1, Axis.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getAxis_Tuples(), this.getTuplesType(), null, "tuples", null, 0, -1, Axis.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getAxis_CrossProduct(), this.getSetListType(), null, "crossProduct", null, 0, -1, Axis.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getAxis_NormTupleSet(), theMsxmlaPackage.getNormTupleSetType(), null, "normTupleSet", null, 0, -1,
        Axis.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAxis_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Axis.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(axisInfoEClass, AxisInfo.class, "AxisInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAxisInfo_HierarchyInfo(), this.getHierarchyInfo(), null, "hierarchyInfo", null, 0, -1,
        AxisInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAxisInfo_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, AxisInfo.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(cellDataEClass, CellData.class, "CellData", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCellData_Cell(), this.getCellType(), null, "cell", null, 0, -1, CellData.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getCellData_CellSet(), this.getCellSetType(), null, "cellSet", null, 0, 1, CellData.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(cellInfoEClass, CellInfo.class, "CellInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCellInfo_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, CellInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(cellSetTypeEClass, CellSetType.class, "CellSetType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCellSetType_Data(), theXMLTypePackage.getBase64Binary(), "data", null, 1, -1, CellSetType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(cellTypeEClass, CellType.class, "CellType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCellType_Value(), this.getValueType(), null, "value", null, 0, 1, CellType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getCellType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, CellType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCellType_CellOrdinal(), theXMLTypePackage.getUnsignedInt(), "cellOrdinal", null, 1, 1,
        CellType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(cellTypeErrorEClass, CellTypeError.class, "CellTypeError", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCellTypeError_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
        CellTypeError.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getCellTypeError_ErrorCode(), theXMLTypePackage.getLong(), "errorCode", null, 0, 1,
        CellTypeError.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(cubeInfoEClass, CubeInfo.class, "CubeInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCubeInfo_Cube(), this.getOlapInfoCube(), null, "cube", null, 1, -1, CubeInfo.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(hierarchyInfoEClass, HierarchyInfo.class, "HierarchyInfo", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getHierarchyInfo_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, HierarchyInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHierarchyInfo_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, HierarchyInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(mddatasetEClass, Mddataset.class, "Mddataset", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMddataset_OlapInfo(), this.getOlapInfo(), null, "olapInfo", null, 0, 1, Mddataset.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getMddataset_Axes(), this.getAxes(), null, "axes", null, 0, 1, Mddataset.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getMddataset_CellData(), this.getCellData(), null, "cellData", null, 0, 1, Mddataset.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getMddataset_Exception(), theXmla_exceptionPackage.getException(), null, "exception", null, 0, 1,
        Mddataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMddataset_Messages(), theXmla_exceptionPackage.getMessages(), null, "messages", null, 0, 1,
        Mddataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(membersTypeEClass, MembersType.class, "MembersType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMembersType_Member(), this.getMemberType(), null, "member", null, 0, -1, MembersType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMembersType_Hierarchy(), theXMLTypePackage.getString(), "hierarchy", null, 1, 1,
        MembersType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(memberTypeEClass, MemberType.class, "MemberType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMemberType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, MemberType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMemberType_Hierarchy(), theXMLTypePackage.getString(), "hierarchy", null, 0, 1, MemberType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(olapInfoEClass, OlapInfo.class, "OlapInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOlapInfo_CubeInfo(), this.getCubeInfo(), null, "cubeInfo", null, 1, 1, OlapInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getOlapInfo_AxesInfo(), this.getAxesInfo(), null, "axesInfo", null, 1, 1, OlapInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getOlapInfo_CellInfo(), this.getCellInfo(), null, "cellInfo", null, 1, 1, OlapInfo.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(olapInfoCubeEClass, OlapInfoCube.class, "OlapInfoCube", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOlapInfoCube_CubeName(), theXMLTypePackage.getString(), "cubeName", null, 1, 1,
        OlapInfoCube.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getOlapInfoCube_LastDataUpdate(), theXMLTypePackage.getDateTime(), "lastDataUpdate", null, 0, 1,
        OlapInfoCube.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getOlapInfoCube_LastSchemaUpdate(), theXMLTypePackage.getDateTime(), "lastSchemaUpdate", null, 0, 1,
        OlapInfoCube.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(setListTypeEClass, SetListType.class, "SetListType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSetListType_SetType(), ecorePackage.getEFeatureMapEntry(), "setType", null, 0, -1,
        SetListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getSetListType_Members(), this.getMembersType(), null, "members", null, 0, -1, SetListType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSetListType_Tuples(), this.getTuplesType(), null, "tuples", null, 0, -1, SetListType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSetListType_CrossProduct(), this.getSetListType(), null, "crossProduct", null, 0, -1,
        SetListType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getSetListType_NormTupleSet(), theMsxmlaPackage.getNormTupleSetType(), null, "normTupleSet", null, 0,
        -1, SetListType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getSetListType_Size(), theXMLTypePackage.getUnsignedInt(), "size", null, 0, 1, SetListType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(tuplesTypeEClass, TuplesType.class, "TuplesType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTuplesType_Tuple(), this.getTupleType(), null, "tuple", null, 0, -1, TuplesType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(tupleTypeEClass, TupleType.class, "TupleType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTupleType_Member(), this.getMemberType(), null, "member", null, 1, -1, TupleType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(valueTypeEClass, ValueType.class, "ValueType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getValueType_Error(), this.getCellTypeError(), null, "error", null, 0, -1, ValueType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_Root(), this.getMddataset(), null, "root", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(axesEClass, source, new String[] { "name", "Axes", "kind", "elementOnly" });
    addAnnotation(getAxes_Axis(), source, new String[] { "kind", "element", "name", "Axis" });
    addAnnotation(axesInfoEClass, source, new String[] { "name", "AxesInfo", "kind", "elementOnly" });
    addAnnotation(getAxesInfo_AxisInfo(), source, new String[] { "kind", "element", "name", "AxisInfo" });
    addAnnotation(axisEClass, source, new String[] { "name", "Axis", "kind", "elementOnly" });
    addAnnotation(getAxis_SetType(), source, new String[] { "kind", "group", "name", "SetType:0" });
    addAnnotation(getAxis_Members(), source,
        new String[] { "kind", "element", "name", "Members", "group", "#SetType:0" });
    addAnnotation(getAxis_Tuples(), source,
        new String[] { "kind", "element", "name", "Tuples", "group", "#SetType:0" });
    addAnnotation(getAxis_CrossProduct(), source,
        new String[] { "kind", "element", "name", "CrossProduct", "group", "#SetType:0" });
    addAnnotation(getAxis_NormTupleSet(), source, new String[] { "kind", "element", "name", "NormTupleSet", "namespace",
        "http://schemas.microsoft.com/analysisservices/2003/xmla", "group", "#SetType:0" });
    addAnnotation(getAxis_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(axisInfoEClass, source, new String[] { "name", "AxisInfo", "kind", "elementOnly" });
    addAnnotation(getAxisInfo_HierarchyInfo(), source, new String[] { "kind", "element", "name", "HierarchyInfo" });
    addAnnotation(getAxisInfo_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(cellDataEClass, source, new String[] { "name", "CellData", "kind", "elementOnly" });
    addAnnotation(getCellData_Cell(), source, new String[] { "kind", "element", "name", "Cell" });
    addAnnotation(getCellData_CellSet(), source, new String[] { "kind", "element", "name", "CellSet" });
    addAnnotation(cellInfoEClass, source, new String[] { "name", "CellInfo", "kind", "elementOnly" });
    addAnnotation(getCellInfo_Any(), source, new String[] { "kind", "elementWildcard", "wildcards", "##targetNamespace",
        "name", ":0", "processing", "skip" });
    addAnnotation(cellSetTypeEClass, source, new String[] { "name", "CellSetType", "kind", "elementOnly" });
    addAnnotation(getCellSetType_Data(), source, new String[] { "kind", "element", "name", "Data" });
    addAnnotation(cellTypeEClass, source, new String[] { "name", "CellType", "kind", "elementOnly" });
    addAnnotation(getCellType_Value(), source, new String[] { "kind", "element", "name", "Value" });
    addAnnotation(getCellType_Any(), source, new String[] { "kind", "elementWildcard", "wildcards", "##targetNamespace",
        "name", ":1", "processing", "skip" });
    addAnnotation(getCellType_CellOrdinal(), source, new String[] { "kind", "attribute", "name", "CellOrdinal" });
    addAnnotation(cellTypeErrorEClass, source, new String[] { "name", "CellTypeError", "kind", "empty" });
    addAnnotation(getCellTypeError_Description(), source, new String[] { "kind", "attribute", "name", "Description" });
    addAnnotation(getCellTypeError_ErrorCode(), source, new String[] { "kind", "attribute", "name", "ErrorCode" });
    addAnnotation(cubeInfoEClass, source, new String[] { "name", "CubeInfo", "kind", "elementOnly" });
    addAnnotation(getCubeInfo_Cube(), source, new String[] { "kind", "element", "name", "Cube" });
    addAnnotation(hierarchyInfoEClass, source, new String[] { "name", "HierarchyInfo", "kind", "elementOnly" });
    addAnnotation(getHierarchyInfo_Any(), source, new String[] { "kind", "elementWildcard", "wildcards",
        "##targetNamespace", "name", ":0", "processing", "skip" });
    addAnnotation(getHierarchyInfo_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(mddatasetEClass, source, new String[] { "name", "mddataset", "kind", "elementOnly" });
    addAnnotation(getMddataset_OlapInfo(), source, new String[] { "kind", "element", "name", "OlapInfo" });
    addAnnotation(getMddataset_Axes(), source, new String[] { "kind", "element", "name", "Axes" });
    addAnnotation(getMddataset_CellData(), source, new String[] { "kind", "element", "name", "CellData" });
    addAnnotation(getMddataset_Exception(), source, new String[] { "kind", "element", "name", "Exception" });
    addAnnotation(getMddataset_Messages(), source, new String[] { "kind", "element", "name", "Messages" });
    addAnnotation(membersTypeEClass, source, new String[] { "name", "MembersType", "kind", "elementOnly" });
    addAnnotation(getMembersType_Member(), source, new String[] { "kind", "element", "name", "Member" });
    addAnnotation(getMembersType_Hierarchy(), source, new String[] { "kind", "attribute", "name", "Hierarchy" });
    addAnnotation(memberTypeEClass, source, new String[] { "name", "MemberType", "kind", "elementOnly" });
    addAnnotation(getMemberType_Any(), source, new String[] { "kind", "elementWildcard", "wildcards",
        "##targetNamespace", "name", ":0", "processing", "skip" });
    addAnnotation(getMemberType_Hierarchy(), source, new String[] { "kind", "attribute", "name", "Hierarchy" });
    addAnnotation(olapInfoEClass, source, new String[] { "name", "OlapInfo", "kind", "elementOnly" });
    addAnnotation(getOlapInfo_CubeInfo(), source, new String[] { "kind", "element", "name", "CubeInfo" });
    addAnnotation(getOlapInfo_AxesInfo(), source, new String[] { "kind", "element", "name", "AxesInfo" });
    addAnnotation(getOlapInfo_CellInfo(), source, new String[] { "kind", "element", "name", "CellInfo" });
    addAnnotation(olapInfoCubeEClass, source, new String[] { "name", "OlapInfoCube", "kind", "elementOnly" });
    addAnnotation(getOlapInfoCube_CubeName(), source, new String[] { "kind", "element", "name", "CubeName" });
    addAnnotation(getOlapInfoCube_LastDataUpdate(), source, new String[] { "kind", "element", "name", "LastDataUpdate",
        "namespace", "http://schemas.microsoft.com/analysisservices/2003/engine" });
    addAnnotation(getOlapInfoCube_LastSchemaUpdate(), source, new String[] { "kind", "element", "name",
        "LastSchemaUpdate", "namespace", "http://schemas.microsoft.com/analysisservices/2003/engine" });
    addAnnotation(setListTypeEClass, source, new String[] { "name", "SetListType", "kind", "elementOnly" });
    addAnnotation(getSetListType_SetType(), source, new String[] { "kind", "group", "name", "SetType:0" });
    addAnnotation(getSetListType_Members(), source,
        new String[] { "kind", "element", "name", "Members", "group", "#SetType:0" });
    addAnnotation(getSetListType_Tuples(), source,
        new String[] { "kind", "element", "name", "Tuples", "group", "#SetType:0" });
    addAnnotation(getSetListType_CrossProduct(), source,
        new String[] { "kind", "element", "name", "CrossProduct", "group", "#SetType:0" });
    addAnnotation(getSetListType_NormTupleSet(), source, new String[] { "kind", "element", "name", "NormTupleSet",
        "namespace", "http://schemas.microsoft.com/analysisservices/2003/xmla", "group", "#SetType:0" });
    addAnnotation(getSetListType_Size(), source, new String[] { "kind", "attribute", "name", "Size" });
    addAnnotation(tuplesTypeEClass, source, new String[] { "name", "TuplesType", "kind", "elementOnly" });
    addAnnotation(getTuplesType_Tuple(), source, new String[] { "kind", "element", "name", "Tuple" });
    addAnnotation(tupleTypeEClass, source, new String[] { "name", "TupleType", "kind", "elementOnly" });
    addAnnotation(getTupleType_Member(), source, new String[] { "kind", "element", "name", "Member" });
    addAnnotation(valueTypeEClass, source, new String[] { "name", "Value_._type", "kind", "elementOnly" });
    addAnnotation(getValueType_Error(), source, new String[] { "kind", "element", "name", "Error" });
    ...
    addAnnotation(getDocumentRoot_Root(), source,
        new String[] { "kind", "element", "name", "root", "namespace", "##targetNamespace" });
  }
