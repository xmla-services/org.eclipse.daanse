 ...
 * '<em><b>Data Embedding Style Type</b></em>', and utility methods for working
...
public enum DataEmbeddingStyleType implements Enumerator {
  /**
   * The '<em><b>Embedded</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #EMBEDDED_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Not Embedded</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Embedded</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #EMBEDDED
   * @model name="Embedded"
  ...
  /**
   * The '<em><b>Not Embedded</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #NOT_EMBEDDED
   ...
   * @generated
   */
  private static final DataEmbeddingStyleType[] VALUES_ARRAY = new DataEmbeddingStyleType[] { EMBEDDED, NOT_EMBEDDED, };

  /**
   * A public read-only list of all the '<em><b>Data Embedding Style
  ...
  /**
   * Returns the '<em><b>Data Embedding Style Type</b></em>' literal with the
