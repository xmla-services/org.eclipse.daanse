 ...
 * '<em><b>Simple Derivation Set Member1 Item</b></em>', and utility methods for
...
public enum SimpleDerivationSetMember1Item implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Simple Derivation Set Member1 Item</b></em>'
   * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final SimpleDerivationSetMember1Item[] VALUES_ARRAY = new SimpleDerivationSetMember1Item[] { LIST,
      UNION, RESTRICTION, };

  /**
   * A public read-only list of all the '<em><b>Simple Derivation Set Member1
   * Item</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<SimpleDerivationSetMember1Item> VALUES = Collections
      .unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Simple Derivation Set Member1 Item</b></em>' literal with
