 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.Properties#getPropertyList
...
public interface Properties extends EObject {
  /**
   * Returns the value of the '<em><b>Property List</b></em>' containment
   ...
   * <em>Property List</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Property List</em>' containment
   *              reference.
   * @see #getPropertyList()
   * @generated
   */
