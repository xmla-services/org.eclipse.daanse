...
public class EngineFactoryImpl extends EFactoryImpl implements EngineFactory {
   ...
   * @generated
   */
  public ImpersonationInfoSecurityType createImpersonationInfoSecurityTypeFromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public ImpersonationInfoSecurityType createImpersonationInfoSecurityTypeObjectFromString(EDataType eDataType,
      String initialValue) {
    return createImpersonationInfoSecurityTypeFromString(EnginePackage.Literals.IMPERSONATION_INFO_SECURITY_TYPE,
        initialValue);
  }
  ...
  public String convertImpersonationInfoSecurityTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertImpersonationInfoSecurityTypeToString(EnginePackage.Literals.IMPERSONATION_INFO_SECURITY_TYPE,
        instanceValue);
  }
