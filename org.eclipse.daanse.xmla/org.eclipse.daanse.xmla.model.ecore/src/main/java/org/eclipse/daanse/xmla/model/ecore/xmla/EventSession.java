 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getTemplateCategory
 * <em>Template Category</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getTemplateName
 * <em>Template Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getTemplateDescription
 * <em>Template Description</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getEvent
 * <em>Event</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getTarget
 * <em>Target</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getDispatchLatency
 * <em>Dispatch Latency</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getEventRetentionMode
 * <em>Event Retention Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMaxEventSize
 * <em>Max Event Size</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMaxMemory
 * <em>Max Memory</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMemoryPartitionMode
 * <em>Memory Partition Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getName
 * <em>Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#isTrackCausality
...
public interface EventSession extends EObject {
   ...
   * <em>Template Category</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * <em>Template Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * @model containment="true" extendedMetaData="kind='element' name='event'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='target'"
   * @generated
   */
  EList<EObject> getTarget();

  /**
   * Returns the value of the '<em><b>Dispatch Latency</b></em>' attribute. The
   * default value is <code>"30"</code>. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   *        dataType="org.eclipse.emf.ecore.xml.type.UnsignedInt" required="true"
   ...
   * <em>Dispatch Latency</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getDispatchLatency
   * <em>Dispatch Latency</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return whether the value of the '<em>Dispatch Latency</em>' attribute is
   *         set.
   * @see #unsetDispatchLatency()
   * @see #getDispatchLatency()
   * @see #setDispatchLatency(long)
   ...
   * The default value is <code>"allowSingleEventLoss"</code>. The literals are
   * from the enumeration
   * {@link org.eclipse.daanse.xmla.model.ecore.xmla.RetentionModes}. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Event Retention Mode</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getEventRetentionMode
   * <em>Event Retention Mode</em>}' attribute is set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return whether the value of the '<em>Event Retention Mode</em>' attribute is
   *         set.
   * @see #unsetEventRetentionMode()
   * @see #getEventRetentionMode()
   * @see #setEventRetentionMode(RetentionModes)
  ...
  /**
   * Returns the value of the '<em><b>Max Event Size</b></em>' attribute. The
   ...
   * <em>Max Event Size</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMaxEventSize
   * <em>Max Event Size</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Max Memory</b></em>' attribute. The default
   * value is <code>"4"</code>. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   *        dataType="org.eclipse.emf.ecore.xml.type.UnsignedLong"
   ...
   * <em>Max Memory</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMaxMemory
   * <em>Max Memory</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * enumeration {@link org.eclipse.daanse.xmla.model.ecore.xmla.PartitionModes}.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @model default="none" unsettable="true" extendedMetaData="kind='attribute'
   ...
   * <em>Memory Partition Mode</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#getMemoryPartitionMode
   * <em>Memory Partition Mode</em>}' attribute is set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return whether the value of the '<em>Memory Partition Mode</em>' attribute
   *         is set.
   * @see #unsetMemoryPartitionMode()
   * @see #getMemoryPartitionMode()
   * @see #setMemoryPartitionMode(PartitionModes)
   ...
   * @model required="true" extendedMetaData="kind='attribute' name='name'"
   * @generated
   */
  String getName();
  ...
  /**
   * Returns the value of the '<em><b>Track Causality</b></em>' attribute. The
   ...
   * <em>Track Causality</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.EventSession#isTrackCausality
   * <em>Track Causality</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
