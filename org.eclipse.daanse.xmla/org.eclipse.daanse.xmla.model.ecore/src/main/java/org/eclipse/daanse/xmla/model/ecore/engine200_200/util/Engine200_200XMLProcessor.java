 ...
 * @generated
 */
@Component(name = Engine200_200Package.eNAME
    + "XMLProcessor", service = Engine200_200XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine200_200XMLProcessor extends XMLProcessor {
   ...
   * Engine200_200ResourceFactoryImpl factory. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
