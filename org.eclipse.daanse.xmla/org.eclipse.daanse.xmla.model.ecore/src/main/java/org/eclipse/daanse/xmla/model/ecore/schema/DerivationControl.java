 ...
 * '<em><b>Derivation Control</b></em>', and utility methods for working with
...
public enum DerivationControl implements Enumerator {
  /**
   * The '<em><b>Substitution</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Restriction</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Union</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #UNION_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Substitution</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #SUBSTITUTION
  ...
  /**
   * The '<em><b>Extension</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #EXTENSION
  ...
  /**
   * The '<em><b>Restriction</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #RESTRICTION
  ...
  /**
   * The '<em><b>Union</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #UNION
   * @model name="union"
   ...
   * @generated
   */
  private static final DerivationControl[] VALUES_ARRAY = new DerivationControl[] { SUBSTITUTION, EXTENSION,
      RESTRICTION, LIST, UNION, };

  /**
   * A public read-only list of all the '<em><b>Derivation Control</b></em>'
  ...
  /**
   * Returns the '<em><b>Derivation Control</b></em>' literal with the specified
