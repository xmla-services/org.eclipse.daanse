 ...
 * @generated
 */
@Component(name = SchemaPackage.eNAME
    + "XMLProcessor", service = SchemaXMLProcessor.class, scope = ServiceScope.SINGLETON)
public class SchemaXMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the SchemaResourceFactoryImpl
