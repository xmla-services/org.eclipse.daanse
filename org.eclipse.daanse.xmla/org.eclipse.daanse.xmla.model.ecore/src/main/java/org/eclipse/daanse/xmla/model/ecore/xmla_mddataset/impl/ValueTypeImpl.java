 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.ValueTypeImpl#getError
 * <em>Error</em>}</li>
 * </ul>
 *
 * @generated
...
public class ValueTypeImpl extends MinimalEObjectImpl.Container implements ValueType {
  ...
  public EList<CellTypeError> getError() {
    if (error == null) {
      error = new EObjectContainmentEList<CellTypeError>(CellTypeError.class, this,
          Xmla_mddatasetPackage.VALUE_TYPE__ERROR);
    }
    return error;
  }
