 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.MemberRefType#getMemberOrdinal
 * <em>Member Ordinal</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.MemberRefType#getMemberDispInfo
...
public interface MemberRefType extends EObject {
   ...
   *        required="true" extendedMetaData="kind='element' name='MemberOrdinal'"
   * @generated
   */
   ...
   * <em>Member Ordinal</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.msxmla.MemberRefType#getMemberOrdinal
   * <em>Member Ordinal</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * <em>Member Disp Info</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns whether the value of the
   * '{@link org.eclipse.daanse.xmla.model.ecore.msxmla.MemberRefType#getMemberDispInfo
   * <em>Member Disp Info</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return whether the value of the '<em>Member Disp Info</em>' attribute is
   *         set.
   * @see #unsetMemberDispInfo()
   * @see #getMemberDispInfo()
   * @see #setMemberDispInfo(int)
