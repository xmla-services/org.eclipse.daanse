 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getAllowedRowsExpression
 * <em>Allowed Rows Expression</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getDirectQueryMode
 * <em>Direct Query Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getDirectQueryUsage
 * <em>Direct Query Usage</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.DocumentRoot#getXEvent
 * <em>XEvent</em>}</li>
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   *        extendedMetaData="kind='element' name='AllowedRowsExpression'
   ...
   * <em>Allowed Rows Expression</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Allowed Rows Expression</em>'
   *              attribute.
  ...
  /**
   * Returns the value of the '<em><b>Direct Query Mode</b></em>' attribute. The
   ...
   *        derived="true" extendedMetaData="kind='element' name='DirectQueryMode'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Direct Query Mode</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Direct Query Usage</b></em>' attribute. The
   * literals are from the enumeration
   ...
   *        name='DirectQueryUsage' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Direct Query Usage</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   *        derived="true" extendedMetaData="kind='element' name='XEvent'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>XEvent</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
