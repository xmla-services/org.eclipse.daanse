...
public class Xmla_rowsetPackageImpl extends EPackageImpl implements Xmla_rowsetPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link Xmla_rowsetPackage#eINSTANCE} when
  ...
  public static Xmla_rowsetPackage init() {
    if (isInited)
      return (Xmla_rowsetPackage) EPackage.Registry.INSTANCE.getEPackage(Xmla_rowsetPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmla_rowsetPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Xmla_rowsetPackageImpl theXmla_rowsetPackage = registeredXmla_rowsetPackage instanceof Xmla_rowsetPackageImpl
        ? (Xmla_rowsetPackageImpl) registeredXmla_rowsetPackage
        : new Xmla_rowsetPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getRow_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, Row.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(rowsetEClass, Rowset.class, "Rowset", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRowset_Row(), this.getRow(), null, "row", null, 0, -1, Rowset.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRowset_Exception(), theXmla_exceptionPackage.getException(), null, "exception", null, 0, 1,
        Rowset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRowset_Messages(), theXmla_exceptionPackage.getMessages(), null, "messages", null, 0, 1,
        Rowset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_Root(), this.getRowset(), null, "root", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(rowEClass, source, new String[] { "name", "row", "kind", "elementOnly" });
    addAnnotation(getRow_Any(), source,
        new String[] { "kind", "elementWildcard", "wildcards", "##any", "name", ":0", "processing", "strict" });
    addAnnotation(rowsetEClass, source, new String[] { "name", "rowset", "kind", "elementOnly" });
    addAnnotation(getRowset_Row(), source, new String[] { "kind", "element", "name", "row" });
    addAnnotation(getRowset_Exception(), source, new String[] { "kind", "element", "name", "Exception" });
    addAnnotation(getRowset_Messages(), source, new String[] { "kind", "element", "name", "Messages" });
