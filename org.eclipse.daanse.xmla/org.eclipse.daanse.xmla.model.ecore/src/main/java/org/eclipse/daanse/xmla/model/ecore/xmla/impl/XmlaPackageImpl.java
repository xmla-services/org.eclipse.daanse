...
public class XmlaPackageImpl extends EPackageImpl implements XmlaPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link XmlaPackage#eINSTANCE} when that
  ...
  public static XmlaPackage init() {
    if (isInited)
      return (XmlaPackage) EPackage.Registry.INSTANCE.getEPackage(XmlaPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmlaPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    XmlaPackageImpl theXmlaPackage = registeredXmlaPackage instanceof XmlaPackageImpl
        ? (XmlaPackageImpl) registeredXmlaPackage
        : new XmlaPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    Xmla_mddatasetPackage theXmla_mddatasetPackage = (Xmla_mddatasetPackage) EPackage.Registry.INSTANCE
        .getEPackage(Xmla_mddatasetPackage.eNS_URI);
    Xmla_rowsetPackage theXmla_rowsetPackage = (Xmla_rowsetPackage) EPackage.Registry.INSTANCE
        .getEPackage(Xmla_rowsetPackage.eNS_URI);
    Xmla_emptyPackage theXmla_emptyPackage = (Xmla_emptyPackage) EPackage.Registry.INSTANCE
        .getEPackage(Xmla_emptyPackage.eNS_URI);
    Xmla_multipleresultsPackage theXmla_multipleresultsPackage = (Xmla_multipleresultsPackage) EPackage.Registry.INSTANCE
        .getEPackage(Xmla_multipleresultsPackage.eNS_URI);
    ...
    initEClass(discoverResponseEClass, DiscoverResponse.class, "DiscoverResponse", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDiscoverResponse_Return(), this.getReturn(), null, "return", null, 0, 1, DiscoverResponse.class,
    ...
    initEAttribute(getDiscover_RequestType(), this.getRequest(), "requestType", null, 1, 1, Discover.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDiscover_Restrictions(), this.getRestrictions(), null, "restrictions", null, 1, 1, Discover.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getDiscover_Properties(), this.getProperties(), null, "properties", null, 1, 1, Discover.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(propertiesEClass, Properties.class, "Properties", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getProperties_PropertyList(), this.getPropertyList(), null, "propertyList", null, 0, 1,
        Properties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(propertyListEClass, PropertyList.class, "PropertyList", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPropertyList_DataSourceInfo(), ecorePackage.getEString(), "dataSourceInfo", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Timeout(), ecorePackage.getEBigInteger(), "timeout", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_UserName(), ecorePackage.getEString(), "userName", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_Password(), ecorePackage.getEString(), "password", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_LocaleIdentifier(), ecorePackage.getEBigInteger(), "localeIdentifier", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Catalog(), ecorePackage.getEString(), "catalog", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_StateSupport(), this.getStateSupport(), "stateSupport", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Content(), this.getContent(), "content", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_Format(), this.getFormat(), "format", null, 0, 1, PropertyList.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_AxisFormat(), this.getAxisFormat(), "axisFormat", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_BeginRange(), ecorePackage.getEBigInteger(), "beginRange", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_EndRange(), ecorePackage.getEBigInteger(), "endRange", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MDXSupport(), this.getMDXSupport(), "mDXSupport", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ProviderName(), ecorePackage.getEString(), "providerName", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ProviderVersion(), ecorePackage.getEString(), "providerVersion", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DBMSVersion(), ecorePackage.getEString(), "dBMSVersion", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ProviderType(), this.getProviderType(), "providerType", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ShowHiddenCubes(), ecorePackage.getEBoolean(), "showHiddenCubes", null, 1, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SQLSupport(), ecorePackage.getEBigInteger(), "sQLSupport", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_TransactionDDL(), ecorePackage.getEBigInteger(), "transactionDDL", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MaximumRows(), ecorePackage.getEBigInteger(), "maximumRows", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Roles(), ecorePackage.getEString(), "roles", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_VisualMode(), this.getVisualMode(), "visualMode", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_EffectiveRoles(), ecorePackage.getEString(), "effectiveRoles", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_EffectiveUserName(), ecorePackage.getEString(), "effectiveUserName", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ServerName(), ecorePackage.getEString(), "serverName", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_CatalogLocation(), this.getCatalogLocation(), "catalogLocation", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropCatalogTerm(), ecorePackage.getEString(), "dbpropCatalogTerm", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropCatalogUsage(), ecorePackage.getEBigInteger(), "dbpropCatalogUsage", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropColumnDefinition(), ecorePackage.getEBigInteger(), "dbpropColumnDefinition",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropConcatNullBehavior(), this.getDbpropConcatNullBehavior(),
        "dbpropConcatNullBehavior", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropDataSourceReadOnly(), ecorePackage.getEBoolean(), "dbpropDataSourceReadOnly",
        null, 1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropGroupBy(), ecorePackage.getEBigInteger(), "dbpropGroupBy", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropHeterogeneousTables(), ecorePackage.getEBigInteger(),
        "dbpropHeterogeneousTables", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropIdentifierCase(), ecorePackage.getEBigInteger(), "dbpropIdentifierCase", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMaxIndexSize(), ecorePackage.getEBigInteger(), "dbpropMaxIndexSize", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMaxOpenChapters(), ecorePackage.getEBigInteger(), "dbpropMaxOpenChapters",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMaxRowSize(), ecorePackage.getEBigInteger(), "dbpropMaxRowSize", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMaxRowSizeIncludeBlob(), ecorePackage.getEBoolean(),
        "dbpropMaxRowSizeIncludeBlob", null, 1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMaxTablesInSelect(), ecorePackage.getEBigInteger(), "dbpropMaxTablesInSelect",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMultiTableUpdate(), ecorePackage.getEBoolean(), "dbpropMultiTableUpdate", null,
        1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropNullCollation(), this.getDbpropNullCollation(), "dbpropNullCollation", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropOrderByColumnsInSelect(), ecorePackage.getEBoolean(),
        "dbpropOrderByColumnsInSelect", null, 1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropOutputParameterAvailable(), this.getDbpropOutputParameterAvailable(),
        "dbpropOutputParameterAvailable", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropPersistentIdType(), this.getDbpropPersistentIdType(), "dbpropPersistentIdType",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropPrepareAbortBehavior(), this.getDbpropPrepareAbortBehavior(),
        "dbpropPrepareAbortBehavior", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropPrepareCommitBehavior(), this.getDbpropPrepareCommitBehavior(),
        "dbpropPrepareCommitBehavior", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropProcedureTerm(), ecorePackage.getEString(), "dbpropProcedureTerm", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropQuotedIdentifierCase(), this.getDbpropQuotedIdentifierCase(),
        "dbpropQuotedIdentifierCase", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSchemaUsage(), ecorePackage.getEBigInteger(), "dbpropSchemaUsage", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSqlSupport(), ecorePackage.getEBigInteger(), "dbpropSqlSupport", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSubqueries(), ecorePackage.getEBigInteger(), "dbpropSubqueries", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSupportedTxnDdl(), ecorePackage.getEBigInteger(), "dbpropSupportedTxnDdl",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxSubqueries(), ecorePackage.getEBigInteger(), "mdpropMdxSubqueries", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSupportedTxnIsoLevels(), ecorePackage.getEBigInteger(),
        "dbpropSupportedTxnIsoLevels", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropSupportedTxnIsoRetain(), ecorePackage.getEBigInteger(),
        "dbpropSupportedTxnIsoRetain", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropTableTerm(), ecorePackage.getEString(), "dbpropTableTerm", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MdpropAggregateCellUpdate(), this.getMdpropAggregateCellUpdate(),
        "mdpropAggregateCellUpdate", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropAxes(), ecorePackage.getEBigInteger(), "mdpropAxes", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MdpropFlatteningSupport(), this.getMdpropFlatteningSupport(),
        "mdpropFlatteningSupport", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxCaseSupport(), ecorePackage.getEBigInteger(), "mdpropMdxCaseSupport", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxDescFlags(), ecorePackage.getEBigInteger(), "mdpropMdxDescFlags", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxDrillFunctions(), ecorePackage.getEBigInteger(), "mdpropMdxDrillFunctions",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxFormulas(), ecorePackage.getEBigInteger(), "mdpropMdxFormulas", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxJoinCubes(), ecorePackage.getEBigInteger(), "mdpropMdxJoinCubes", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxMemberFunctions(), ecorePackage.getEBigInteger(),
        "mdpropMdxMemberFunctions", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxNonMeasureExpressions(), this.getMdpropMdxNonMeasureExpressions(),
        "mdpropMdxNonMeasureExpressions", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxNumericFunctions(), ecorePackage.getEBigInteger(),
        "mdpropMdxNumericFunctions", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxObjQualification(), ecorePackage.getEBigInteger(),
        "mdpropMdxObjQualification", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxOuterReference(), ecorePackage.getEBigInteger(), "mdpropMdxOuterReference",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxQueryByProperty(), ecorePackage.getEBoolean(), "mdpropMdxQueryByProperty",
        null, 1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxRangeRowset(), this.getMdpropMdxRangeRowset(), "mdpropMdxRangeRowset", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxSetFunctions(), ecorePackage.getEBigInteger(), "mdpropMdxSetFunctions",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxSlicer(), this.getMdpropMdxSlicer(), "mdpropMdxSlicer", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxStringCompop(), ecorePackage.getEBigInteger(), "mdpropMdxStringCompop",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropNamedLevels(), ecorePackage.getEBigInteger(), "mdpropNamedLevels", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdMDXCompatibility(), this.getDbpropMsmdMDXCompatibility(),
        "dbpropMsmdMDXCompatibility", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdSQLCompatibility(), ecorePackage.getEBigInteger(),
        "dbpropMsmdSQLCompatibility", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdMDXUniqueNameStyle(), ecorePackage.getEBigInteger(),
        "dbpropMsmdMDXUniqueNameStyle", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCachePolicy(), ecorePackage.getEBigInteger(), "dbpropMsmdCachePolicy",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCacheRatio(), ecorePackage.getEBigInteger(), "dbpropMsmdCacheRatio", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCacheMode(), ecorePackage.getEBigInteger(), "dbpropMsmdCacheMode", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCompareCaseSensitiveStringFlags(),
        this.getDbpropMsmdCompareCaseSensitiveStringFlags(), "dbpropMsmdCompareCaseSensitiveStringFlags", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCompareCaseNotSensitiveStringFlags(), ecorePackage.getEBigInteger(),
        "dbpropMsmdCompareCaseNotSensitiveStringFlags", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdFlattened2(), ecorePackage.getEBoolean(), "dbpropMsmdFlattened2", null, 1,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropInitMode(), ecorePackage.getEBigInteger(), "dbpropInitMode", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SspropInitAppName(), ecorePackage.getEString(), "sspropInitAppName", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SspropInitWsid(), ecorePackage.getEString(), "sspropInitWsid", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SspropInitPacketsize(), ecorePackage.getEBigInteger(), "sspropInitPacketsize", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ReadOnlySession(), ecorePackage.getEBigInteger(), "readOnlySession", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SecuredCellValue(), this.getSecuredCellValue(), "securedCellValue", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_NonEmptyThreshold(), ecorePackage.getEBigInteger(), "nonEmptyThreshold", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SafetyOptions(), this.getSafetyOptions(), "safetyOptions", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdCacheRatio2(), theXMLTypePackage.getDouble(), "dbpropMsmdCacheRatio2",
        null, 1, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdUseFormulaCache(), ecorePackage.getEString(), "dbpropMsmdUseFormulaCache",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdDynamicDebugLimit(), ecorePackage.getEBigInteger(),
        "dbpropMsmdDynamicDebugLimit", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdDebugMode(), ecorePackage.getEString(), "dbpropMsmdDebugMode", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Dialect(), this.getDialect(), "dialect", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ImpactAnalysis(), ecorePackage.getEBoolean(), "impactAnalysis", null, 1, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_SQLQueryMode(), this.getSQLQueryMode(), "sQLQueryMode", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ClientProcessID(), ecorePackage.getEBigInteger(), "clientProcessID", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_Cube(), ecorePackage.getEString(), "cube", null, 0, 1, PropertyList.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ReturnCellProperties(), ecorePackage.getEBoolean(), "returnCellProperties", null, 1,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_CommitTimeout(), ecorePackage.getEBigInteger(), "commitTimeout", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ForceCommitTimeout(), ecorePackage.getEBigInteger(), "forceCommitTimeout", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ExecutionMode(), ecorePackage.getEString(), "executionMode", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_RealTimeOlap(), ecorePackage.getEBoolean(), "realTimeOlap", null, 1, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MdxMissingMemberMode(), this.getMdxMissingMemberMode(), "mdxMissingMemberMode", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxNamedSets(), ecorePackage.getEBigInteger(), "mdpropMdxNamedSets", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdSubqueries(), this.getDbpropMsmdSubqueries(), "dbpropMsmdSubqueries", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdAutoExists(), this.getDbpropMsmdAutoExists(), "dbpropMsmdAutoExists", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_CustomData(), ecorePackage.getEString(), "customData", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DisablePrefetchFacts(), ecorePackage.getEBoolean(), "disablePrefetchFacts", null, 1,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_UpdateIsolationLevel(), this.getUpdateIsolationLevel(), "updateIsolationLevel", null,
        0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdErrorMessageMode(), ecorePackage.getEBigInteger(),
        "dbpropMsmdErrorMessageMode", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_MdpropMdxDdlExtensions(), ecorePackage.getEBigInteger(), "mdpropMdxDdlExtensions",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ResponseEncoding(), this.getResponseEncoding(), "responseEncoding", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_MemoryLockingMode(), this.getMemoryLockingMode(), "memoryLockingMode", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdOptimizeResponse(), ecorePackage.getEBigInteger(),
        "dbpropMsmdOptimizeResponse", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdActivityID(), ecorePackage.getEString(), "dbpropMsmdActivityID", null, 0,
        1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdRequestID(), ecorePackage.getEString(), "dbpropMsmdRequestID", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getPropertyList_ReturnAffectedObjects(), ecorePackage.getEBigInteger(), "returnAffectedObjects",
        null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_DbpropMsmdRequestMemoryLimit(), ecorePackage.getEBigInteger(),
        "dbpropMsmdRequestMemoryLimit", null, 0, 1, PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPropertyList_ApplicationContext(), ecorePackage.getEString(), "applicationContext", null, 0, 1,
        PropertyList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(restrictionListEClass, RestrictionList.class, "RestrictionList", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRestrictionList_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1,
        RestrictionList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(restrictionsEClass, Restrictions.class, "Restrictions", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRestrictions_RestrictionList(), this.getRestrictionList(), null, "restrictionList", null, 0, 1,
        Restrictions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(returnEClass, Return.class, "Return", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getReturn_Root(), theXmla_mddatasetPackage.getMddataset(), null, "root", null, 0, 1, Return.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getReturn_Root1(), theXmla_rowsetPackage.getRowset(), null, "root1", null, 0, 1, Return.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getReturn_Root2(), theXmla_emptyPackage.getEmptyresult(), null, "root2", null, 0, 1, Return.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getReturn_Results(), theXmla_multipleresultsPackage.getResultsType(), null, "results", null, 0, 1,
        Return.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAnnotation_Name(), ecorePackage.getEString(), "name", null, 1, 1, Annotation.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnnotation_Visibility(), this.getVisibility(), "visibility", null, 0, 1, Annotation.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotation_Value(), ecorePackage.getEObject(), null, "value", null, 0, 1, Annotation.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(annotationsEClass, Annotations.class, "Annotations", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAnnotations_Annotation(), this.getAnnotation(), null, "annotation", null, 0, -1,
        Annotations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(bindingEClass, Binding.class, "Binding", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(eventSessionEClass, EventSession.class, "EventSession", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEventSession_TemplateCategory(), ecorePackage.getEString(), "templateCategory", null, 0, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_TemplateName(), ecorePackage.getEString(), "templateName", null, 0, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_TemplateDescription(), ecorePackage.getEString(), "templateDescription", null, 0, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getEventSession_Event(), ecorePackage.getEObject(), null, "event", null, 0, -1, EventSession.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getEventSession_Target(), ecorePackage.getEObject(), null, "target", null, 0, -1, EventSession.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEventSession_DispatchLatency(), theXMLTypePackage.getUnsignedInt(), "dispatchLatency", "30", 1, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_EventRetentionMode(), this.getRetentionModes(), "eventRetentionMode",
        "allowSingleEventLoss", 0, 1, EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEventSession_MaxEventSize(), theXMLTypePackage.getUnsignedInt(), "maxEventSize", "0", 1, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_MaxMemory(), theXMLTypePackage.getUnsignedLong(), "maxMemory", "4", 0, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_MemoryPartitionMode(), this.getPartitionModes(), "memoryPartitionMode", "none", 0, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEventSession_Name(), ecorePackage.getEString(), "name", null, 1, 1, EventSession.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEventSession_TrackCausality(), ecorePackage.getEBoolean(), "trackCausality", "false", 1, 1,
        EventSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    ...
    initEEnum(dbpropOutputParameterAvailableEEnum, DbpropOutputParameterAvailable.class,
    ...
    initEEnum(mdpropMdxNonMeasureExpressionsEEnum, MdpropMdxNonMeasureExpressions.class,
    ...
    initEEnum(dbpropMsmdCompareCaseSensitiveStringFlagsEEnum, DbpropMsmdCompareCaseSensitiveStringFlags.class,
  ...
  protected void createImportAnnotations() {
    ...
    addAnnotation(this, source,
        new String[] { "_xmla_empty", "xmla_empty.ecore#/", "_xmla_mddataset", "xmla_mddataset.ecore#/",
            "_xmla_multipleresults", "xmla_multipleresults.ecore#/", "_xmla_rowset", "xmla_rowset.ecore#/", "ecore",
            "http://www.eclipse.org/emf/2002/Ecore", "ecore.xml.type", "http://www.eclipse.org/emf/2003/XMLType" });
  }
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(discoverResponseEClass, source,
        new String[] { "name", "DiscoverResponse_._type", "kind", "elementOnly" });
    addAnnotation(getDiscoverResponse_Return(), source, new String[] { "kind", "element", "name", "return" });
    addAnnotation(discoverEClass, source, new String[] { "name", "Discover_._type", "kind", "elementOnly" });
    addAnnotation(getDiscover_RequestType(), source, new String[] { "kind", "element", "name", "RequestType" });
    addAnnotation(getDiscover_Restrictions(), source, new String[] { "kind", "element", "name", "Restrictions" });
    addAnnotation(getDiscover_Properties(), source, new String[] { "kind", "element", "name", "Properties" });
    addAnnotation(propertiesEClass, source, new String[] { "name", "Properties", "kind", "elementOnly" });
    addAnnotation(getProperties_PropertyList(), source, new String[] { "kind", "element", "name", "PropertyList" });
    addAnnotation(propertyListEClass, source, new String[] { "name", "PropertyList", "kind", "elementOnly" });
    addAnnotation(getPropertyList_DataSourceInfo(), source,
        new String[] { "kind", "element", "name", "DataSourceInfo" });
    addAnnotation(getPropertyList_Timeout(), source, new String[] { "kind", "element", "name", "Timeout" });
    addAnnotation(getPropertyList_UserName(), source, new String[] { "kind", "element", "name", "UserName" });
    addAnnotation(getPropertyList_Password(), source, new String[] { "kind", "element", "name", "Password" });
    addAnnotation(getPropertyList_LocaleIdentifier(), source,
        new String[] { "kind", "element", "name", "LocaleIdentifier" });
    addAnnotation(getPropertyList_Catalog(), source, new String[] { "kind", "element", "name", "Catalog" });
    addAnnotation(getPropertyList_StateSupport(), source, new String[] { "kind", "element", "name", "StateSupport" });
    addAnnotation(getPropertyList_Content(), source, new String[] { "kind", "element", "name", "Content" });
    addAnnotation(getPropertyList_Format(), source, new String[] { "kind", "element", "name", "Format" });
    addAnnotation(getPropertyList_AxisFormat(), source, new String[] { "kind", "element", "name", "AxisFormat" });
    addAnnotation(getPropertyList_BeginRange(), source, new String[] { "kind", "element", "name", "BeginRange" });
    addAnnotation(getPropertyList_EndRange(), source, new String[] { "kind", "element", "name", "EndRange" });
    addAnnotation(getPropertyList_MDXSupport(), source, new String[] { "kind", "element", "name", "MDXSupport" });
    addAnnotation(getPropertyList_ProviderName(), source, new String[] { "kind", "element", "name", "ProviderName" });
    addAnnotation(getPropertyList_ProviderVersion(), source,
        new String[] { "kind", "element", "name", "ProviderVersion" });
    addAnnotation(getPropertyList_DBMSVersion(), source, new String[] { "kind", "element", "name", "DBMSVersion" });
    addAnnotation(getPropertyList_ProviderType(), source, new String[] { "kind", "element", "name", "ProviderType" });
    addAnnotation(getPropertyList_ShowHiddenCubes(), source,
        new String[] { "kind", "element", "name", "ShowHiddenCubes" });
    addAnnotation(getPropertyList_SQLSupport(), source, new String[] { "kind", "element", "name", "SQLSupport" });
    addAnnotation(getPropertyList_TransactionDDL(), source,
        new String[] { "kind", "element", "name", "TransactionDDL" });
    addAnnotation(getPropertyList_MaximumRows(), source, new String[] { "kind", "element", "name", "MaximumRows" });
    addAnnotation(getPropertyList_Roles(), source, new String[] { "kind", "element", "name", "Roles" });
    addAnnotation(getPropertyList_VisualMode(), source, new String[] { "kind", "element", "name", "VisualMode" });
    addAnnotation(getPropertyList_EffectiveRoles(), source,
        new String[] { "kind", "element", "name", "EffectiveRoles" });
    addAnnotation(getPropertyList_EffectiveUserName(), source,
        new String[] { "kind", "element", "name", "EffectiveUserName" });
    addAnnotation(getPropertyList_ServerName(), source, new String[] { "kind", "element", "name", "ServerName" });
    addAnnotation(getPropertyList_CatalogLocation(), source,
        new String[] { "kind", "element", "name", "CatalogLocation" });
    addAnnotation(getPropertyList_DbpropCatalogTerm(), source,
        new String[] { "kind", "element", "name", "DbpropCatalogTerm" });
    addAnnotation(getPropertyList_DbpropCatalogUsage(), source,
        new String[] { "kind", "element", "name", "DbpropCatalogUsage" });
    addAnnotation(getPropertyList_DbpropColumnDefinition(), source,
        new String[] { "kind", "element", "name", "DbpropColumnDefinition" });
    addAnnotation(getPropertyList_DbpropConcatNullBehavior(), source,
        new String[] { "kind", "element", "name", "DbpropConcatNullBehavior" });
    addAnnotation(getPropertyList_DbpropDataSourceReadOnly(), source,
        new String[] { "kind", "element", "name", "DbpropDataSourceReadOnly" });
    addAnnotation(getPropertyList_DbpropGroupBy(), source, new String[] { "kind", "element", "name", "DbpropGroupBy" });
    addAnnotation(getPropertyList_DbpropHeterogeneousTables(), source,
        new String[] { "kind", "element", "name", "DbpropHeterogeneousTables" });
    addAnnotation(getPropertyList_DbpropIdentifierCase(), source,
        new String[] { "kind", "element", "name", "DbpropIdentifierCase" });
    addAnnotation(getPropertyList_DbpropMaxIndexSize(), source,
        new String[] { "kind", "element", "name", "DbpropMaxIndexSize" });
    addAnnotation(getPropertyList_DbpropMaxOpenChapters(), source,
        new String[] { "kind", "element", "name", "DbpropMaxOpenChapters" });
    addAnnotation(getPropertyList_DbpropMaxRowSize(), source,
        new String[] { "kind", "element", "name", "DbpropMaxRowSize" });
    addAnnotation(getPropertyList_DbpropMaxRowSizeIncludeBlob(), source,
        new String[] { "kind", "element", "name", "DbpropMaxRowSizeIncludeBlob" });
    addAnnotation(getPropertyList_DbpropMaxTablesInSelect(), source,
        new String[] { "kind", "element", "name", "DbpropMaxTablesInSelect" });
    addAnnotation(getPropertyList_DbpropMultiTableUpdate(), source,
        new String[] { "kind", "element", "name", "DbpropMultiTableUpdate" });
    addAnnotation(getPropertyList_DbpropNullCollation(), source,
        new String[] { "kind", "element", "name", "DbpropNullCollation" });
    addAnnotation(getPropertyList_DbpropOrderByColumnsInSelect(), source,
        new String[] { "kind", "element", "name", "DbpropOrderByColumnsInSelect" });
    addAnnotation(getPropertyList_DbpropOutputParameterAvailable(), source,
        new String[] { "kind", "element", "name", "DbpropOutputParameterAvailable" });
    addAnnotation(getPropertyList_DbpropPersistentIdType(), source,
        new String[] { "kind", "element", "name", "DbpropPersistentIdType" });
    addAnnotation(getPropertyList_DbpropPrepareAbortBehavior(), source,
        new String[] { "kind", "element", "name", "DbpropPrepareAbortBehavior" });
    addAnnotation(getPropertyList_DbpropPrepareCommitBehavior(), source,
        new String[] { "kind", "element", "name", "DbpropPrepareCommitBehavior" });
    addAnnotation(getPropertyList_DbpropProcedureTerm(), source,
        new String[] { "kind", "element", "name", "DbpropProcedureTerm" });
    addAnnotation(getPropertyList_DbpropQuotedIdentifierCase(), source,
        new String[] { "kind", "element", "name", "DbpropQuotedIdentifierCase" });
    addAnnotation(getPropertyList_DbpropSchemaUsage(), source,
        new String[] { "kind", "element", "name", "DbpropSchemaUsage" });
    addAnnotation(getPropertyList_DbpropSqlSupport(), source,
        new String[] { "kind", "element", "name", "DbpropSqlSupport" });
    addAnnotation(getPropertyList_DbpropSubqueries(), source,
        new String[] { "kind", "element", "name", "DbpropSubqueries" });
    addAnnotation(getPropertyList_DbpropSupportedTxnDdl(), source,
        new String[] { "kind", "element", "name", "DbpropSupportedTxnDdl" });
    addAnnotation(getPropertyList_MdpropMdxSubqueries(), source,
        new String[] { "kind", "element", "name", "MdpropMdxSubqueries" });
    addAnnotation(getPropertyList_DbpropSupportedTxnIsoLevels(), source,
        new String[] { "kind", "element", "name", "DbpropSupportedTxnIsoLevels" });
    addAnnotation(getPropertyList_DbpropSupportedTxnIsoRetain(), source,
        new String[] { "kind", "element", "name", "DbpropSupportedTxnIsoRetain" });
    addAnnotation(getPropertyList_DbpropTableTerm(), source,
        new String[] { "kind", "element", "name", "DbpropTableTerm" });
    addAnnotation(getPropertyList_MdpropAggregateCellUpdate(), source,
        new String[] { "kind", "element", "name", "MdpropAggregateCellUpdate" });
    addAnnotation(getPropertyList_MdpropAxes(), source, new String[] { "kind", "element", "name", "MdpropAxes" });
    addAnnotation(getPropertyList_MdpropFlatteningSupport(), source,
        new String[] { "kind", "element", "name", "MdpropFlatteningSupport" });
    addAnnotation(getPropertyList_MdpropMdxCaseSupport(), source,
        new String[] { "kind", "element", "name", "MdpropMdxCaseSupport" });
    addAnnotation(getPropertyList_MdpropMdxDescFlags(), source,
        new String[] { "kind", "element", "name", "MdpropMdxDescFlags" });
    addAnnotation(getPropertyList_MdpropMdxDrillFunctions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxDrillFunctions" });
    addAnnotation(getPropertyList_MdpropMdxFormulas(), source,
        new String[] { "kind", "element", "name", "MdpropMdxFormulas" });
    addAnnotation(getPropertyList_MdpropMdxJoinCubes(), source,
        new String[] { "kind", "element", "name", "MdpropMdxJoinCubes" });
    addAnnotation(getPropertyList_MdpropMdxMemberFunctions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxMemberFunctions" });
    addAnnotation(getPropertyList_MdpropMdxNonMeasureExpressions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxNonMeasureExpressions" });
    addAnnotation(getPropertyList_MdpropMdxNumericFunctions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxNumericFunctions" });
    addAnnotation(getPropertyList_MdpropMdxObjQualification(), source,
        new String[] { "kind", "element", "name", "MdpropMdxObjQualification" });
    addAnnotation(getPropertyList_MdpropMdxOuterReference(), source,
        new String[] { "kind", "element", "name", "MdpropMdxOuterReference" });
    addAnnotation(getPropertyList_MdpropMdxQueryByProperty(), source,
        new String[] { "kind", "element", "name", "MdpropMdxQueryByProperty" });
    addAnnotation(getPropertyList_MdpropMdxRangeRowset(), source,
        new String[] { "kind", "element", "name", "MdpropMdxRangeRowset" });
    addAnnotation(getPropertyList_MdpropMdxSetFunctions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxSetFunctions" });
    addAnnotation(getPropertyList_MdpropMdxSlicer(), source,
        new String[] { "kind", "element", "name", "MdpropMdxSlicer" });
    addAnnotation(getPropertyList_MdpropMdxStringCompop(), source,
        new String[] { "kind", "element", "name", "MdpropMdxStringCompop" });
    addAnnotation(getPropertyList_MdpropNamedLevels(), source,
        new String[] { "kind", "element", "name", "MdpropNamedLevels" });
    addAnnotation(getPropertyList_DbpropMsmdMDXCompatibility(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdMDXCompatibility" });
    addAnnotation(getPropertyList_DbpropMsmdSQLCompatibility(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdSQLCompatibility" });
    addAnnotation(getPropertyList_DbpropMsmdMDXUniqueNameStyle(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdMDXUniqueNameStyle" });
    addAnnotation(getPropertyList_DbpropMsmdCachePolicy(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCachePolicy" });
    addAnnotation(getPropertyList_DbpropMsmdCacheRatio(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCacheRatio" });
    addAnnotation(getPropertyList_DbpropMsmdCacheMode(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCacheMode" });
    addAnnotation(getPropertyList_DbpropMsmdCompareCaseSensitiveStringFlags(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCompareCaseSensitiveStringFlags" });
    addAnnotation(getPropertyList_DbpropMsmdCompareCaseNotSensitiveStringFlags(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCompareCaseNotSensitiveStringFlags" });
    addAnnotation(getPropertyList_DbpropMsmdFlattened2(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdFlattened2" });
    addAnnotation(getPropertyList_DbpropInitMode(), source,
        new String[] { "kind", "element", "name", "DbpropInitMode" });
    addAnnotation(getPropertyList_SspropInitAppName(), source,
        new String[] { "kind", "element", "name", "SspropInitAppName" });
    addAnnotation(getPropertyList_SspropInitWsid(), source,
        new String[] { "kind", "element", "name", "SspropInitWsid" });
    addAnnotation(getPropertyList_SspropInitPacketsize(), source,
        new String[] { "kind", "element", "name", "SspropInitPacketsize" });
    addAnnotation(getPropertyList_ReadOnlySession(), source,
        new String[] { "kind", "element", "name", "ReadOnlySession" });
    addAnnotation(getPropertyList_SecuredCellValue(), source,
        new String[] { "kind", "element", "name", "SecuredCellValue" });
    addAnnotation(getPropertyList_NonEmptyThreshold(), source,
        new String[] { "kind", "element", "name", "NonEmptyThreshold" });
    addAnnotation(getPropertyList_SafetyOptions(), source, new String[] { "kind", "element", "name", "SafetyOptions" });
    addAnnotation(getPropertyList_DbpropMsmdCacheRatio2(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdCacheRatio2" });
    addAnnotation(getPropertyList_DbpropMsmdUseFormulaCache(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdUseFormulaCache" });
    addAnnotation(getPropertyList_DbpropMsmdDynamicDebugLimit(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdDynamicDebugLimit" });
    addAnnotation(getPropertyList_DbpropMsmdDebugMode(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdDebugMode" });
    addAnnotation(getPropertyList_Dialect(), source, new String[] { "kind", "element", "name", "Dialect" });
    addAnnotation(getPropertyList_ImpactAnalysis(), source,
        new String[] { "kind", "element", "name", "ImpactAnalysis" });
    addAnnotation(getPropertyList_SQLQueryMode(), source, new String[] { "kind", "element", "name", "SQLQueryMode" });
    addAnnotation(getPropertyList_ClientProcessID(), source,
        new String[] { "kind", "element", "name", "ClientProcessID" });
    addAnnotation(getPropertyList_Cube(), source, new String[] { "kind", "element", "name", "Cube" });
    addAnnotation(getPropertyList_ReturnCellProperties(), source,
        new String[] { "kind", "element", "name", "ReturnCellProperties" });
    addAnnotation(getPropertyList_CommitTimeout(), source, new String[] { "kind", "element", "name", "CommitTimeout" });
    addAnnotation(getPropertyList_ForceCommitTimeout(), source,
        new String[] { "kind", "element", "name", "ForceCommitTimeout" });
    addAnnotation(getPropertyList_ExecutionMode(), source, new String[] { "kind", "element", "name", "ExecutionMode" });
    addAnnotation(getPropertyList_RealTimeOlap(), source, new String[] { "kind", "element", "name", "RealTimeOlap" });
    addAnnotation(getPropertyList_MdxMissingMemberMode(), source,
        new String[] { "kind", "element", "name", "MdxMissingMemberMode" });
    addAnnotation(getPropertyList_MdpropMdxNamedSets(), source,
        new String[] { "kind", "element", "name", "MdpropMdxNamedSets" });
    addAnnotation(getPropertyList_DbpropMsmdSubqueries(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdSubqueries" });
    addAnnotation(getPropertyList_DbpropMsmdAutoExists(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdAutoExists" });
    addAnnotation(getPropertyList_CustomData(), source, new String[] { "kind", "element", "name", "CustomData" });
    addAnnotation(getPropertyList_DisablePrefetchFacts(), source,
        new String[] { "kind", "element", "name", "DisablePrefetchFacts" });
    addAnnotation(getPropertyList_UpdateIsolationLevel(), source,
        new String[] { "kind", "element", "name", "UpdateIsolationLevel" });
    addAnnotation(getPropertyList_DbpropMsmdErrorMessageMode(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdErrorMessageMode" });
    addAnnotation(getPropertyList_MdpropMdxDdlExtensions(), source,
        new String[] { "kind", "element", "name", "MdpropMdxDdlExtensions" });
    addAnnotation(getPropertyList_ResponseEncoding(), source,
        new String[] { "kind", "element", "name", "ResponseEncoding" });
    addAnnotation(getPropertyList_MemoryLockingMode(), source,
        new String[] { "kind", "element", "name", "MemoryLockingMode" });
    addAnnotation(getPropertyList_DbpropMsmdOptimizeResponse(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdOptimizeResponse" });
    addAnnotation(getPropertyList_DbpropMsmdActivityID(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdActivityID" });
    addAnnotation(getPropertyList_DbpropMsmdRequestID(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdRequestID" });
    addAnnotation(getPropertyList_ReturnAffectedObjects(), source,
        new String[] { "kind", "element", "name", "ReturnAffectedObjects" });
    addAnnotation(getPropertyList_DbpropMsmdRequestMemoryLimit(), source,
        new String[] { "kind", "element", "name", "DbpropMsmdRequestMemoryLimit" });
    addAnnotation(getPropertyList_ApplicationContext(), source,
        new String[] { "kind", "element", "name", "ApplicationContext" });
    addAnnotation(requestEEnum, source, new String[] { "name", "RequestType_._type" });
    addAnnotation(responseEncodingEEnum, source, new String[] { "name", "ResponseEncoding_._type" });
    addAnnotation(restrictionListEClass, source,
        new String[] { "name", "RestrictionList_._type", "kind", "elementOnly" });
    addAnnotation(getRestrictionList_Any(), source,
        new String[] { "kind", "elementWildcard", "wildcards", "##any", "name", ":0", "processing", "strict" });
    addAnnotation(restrictionsEClass, source, new String[] { "name", "Restrictions_._type", "kind", "elementOnly" });
    addAnnotation(getRestrictions_RestrictionList(), source,
        new String[] { "kind", "element", "name", "RestrictionList" });
    addAnnotation(returnEClass, source, new String[] { "name", "return", "kind", "elementOnly" });
    addAnnotation(getReturn_Root(), source, new String[] { "kind", "element", "name", "root", "namespace",
        "urn:schemas-microsoft-com:xml-analysis:mddataset" });
    addAnnotation(getReturn_Root1(), source, new String[] { "kind", "element", "name", "root", "namespace",
        "urn:schemas-microsoft-com:xml-analysis:rowset" });
    addAnnotation(getReturn_Root2(), source, new String[] { "kind", "element", "name", "root", "namespace",
        "urn:schemas-microsoft-com:xml-analysis:empty" });
    addAnnotation(getReturn_Results(), source, new String[] { "kind", "element", "name", "results", "namespace",
        "http://schemas.microsoft.com/analysisservices/2003/xmla-multipleresults" });
    addAnnotation(stateSupportEEnum, source, new String[] { "name", "StateSupport_._type" });
    addAnnotation(formatEEnum, source, new String[] { "name", "Format_._1_._type" });
    addAnnotation(contentEEnum, source, new String[] { "name", "Content_._1_._type" });
    addAnnotation(axisFormatEEnum, source, new String[] { "name", "AxisFormat_._type" });
    addAnnotation(mdxSupportEEnum, source, new String[] { "name", "MDXSupport_._type" });
    addAnnotation(providerTypeEEnum, source, new String[] { "name", "ProviderType_._type" });
    addAnnotation(visualModeEEnum, source, new String[] { "name", "VisualMode_._type" });
    addAnnotation(catalogLocationEEnum, source, new String[] { "name", "CatalogLocation_._type" });
    addAnnotation(dbpropConcatNullBehaviorEEnum, source, new String[] { "name", "DbpropConcatNullBehavior_._type" });
    addAnnotation(dbpropNullCollationEEnum, source, new String[] { "name", "DbpropNullCollation_._type" });
    addAnnotation(dbpropOutputParameterAvailableEEnum, source,
        new String[] { "name", "DbpropOutputParameterAvailable_._type" });
    addAnnotation(dbpropPersistentIdTypeEEnum, source, new String[] { "name", "DbpropPersistentIdType_._type" });
    addAnnotation(dbpropPrepareAbortBehaviorEEnum, source,
        new String[] { "name", "DbpropPrepareAbortBehavior_._type" });
    addAnnotation(dbpropPrepareCommitBehaviorEEnum, source,
        new String[] { "name", "DbpropPrepareCommitBehavior_._type" });
    addAnnotation(dbpropQuotedIdentifierCaseEEnum, source,
        new String[] { "name", "DbpropQuotedIdentifierCase_._type" });
    addAnnotation(mdpropAggregateCellUpdateEEnum, source, new String[] { "name", "MdpropAggregateCellUpdate_._type" });
    addAnnotation(mdpropFlatteningSupportEEnum, source, new String[] { "name", "MdpropFlatteningSupport_._type" });
    addAnnotation(mdpropMdxNonMeasureExpressionsEEnum, source,
        new String[] { "name", "MdpropMdxNonMeasureExpressions_._type" });
    addAnnotation(mdpropMdxRangeRowsetEEnum, source, new String[] { "name", "MdpropMdxRangeRowset_._type" });
    addAnnotation(mdpropMdxSlicerEEnum, source, new String[] { "name", "MdpropMdxSlicer_._type" });
    addAnnotation(mdxMissingMemberModeEEnum, source, new String[] { "name", "MdxMissingMemberMode_._type" });
    addAnnotation(dbpropMsmdMDXCompatibilityEEnum, source,
        new String[] { "name", "DbpropMsmdMDXCompatibility_._type" });
    addAnnotation(dbpropMsmdCompareCaseSensitiveStringFlagsEEnum, source,
        new String[] { "name", "DbpropMsmdCompareCaseSensitiveStringFlags_._type" });
    addAnnotation(securedCellValueEEnum, source, new String[] { "name", "SecuredCellValue_._type" });
    addAnnotation(safetyOptionsEEnum, source, new String[] { "name", "SafetyOptions_._type" });
    addAnnotation(dialectEEnum, source, new String[] { "name", "Dialect_._type" });
    addAnnotation(sqlQueryModeEEnum, source, new String[] { "name", "SQLQueryMode_._type" });
    addAnnotation(dbpropMsmdSubqueriesEEnum, source, new String[] { "name", "DbpropMsmdSubqueries_._type" });
    addAnnotation(dbpropMsmdAutoExistsEEnum, source, new String[] { "name", "DbpropMsmdAutoExists_._type" });
    addAnnotation(updateIsolationLevelEEnum, source, new String[] { "name", "UpdateIsolationLevel_._type" });
    addAnnotation(memoryLockingModeEEnum, source, new String[] { "name", "MemoryLockingMode_._type" });
    addAnnotation(visibilityEEnum, source, new String[] { "name", "Visibility_._type" });
    addAnnotation(annotationEClass, source, new String[] { "name", "Annotation", "kind", "elementOnly" });
    addAnnotation(getAnnotation_Name(), source, new String[] { "kind", "element", "name", "Name" });
    addAnnotation(getAnnotation_Visibility(), source, new String[] { "kind", "element", "name", "Visibility" });
    addAnnotation(getAnnotation_Value(), source, new String[] { "kind", "element", "name", "Value" });
    addAnnotation(annotationsEClass, source, new String[] { "name", "Annotations_._type", "kind", "elementOnly" });
    addAnnotation(getAnnotations_Annotation(), source, new String[] { "kind", "element", "name", "Annotation" });
    addAnnotation(bindingEClass, source, new String[] { "name", "Binding", "kind", "empty" });
    addAnnotation(eventSessionEClass, source, new String[] { "name", "event_session_._type", "kind", "elementOnly" });
    addAnnotation(getEventSession_TemplateCategory(), source,
        new String[] { "kind", "element", "name", "templateCategory" });
    addAnnotation(getEventSession_TemplateName(), source, new String[] { "kind", "element", "name", "templateName" });
    addAnnotation(getEventSession_TemplateDescription(), source,
        new String[] { "kind", "element", "name", "templateDescription" });
    addAnnotation(getEventSession_Event(), source, new String[] { "kind", "element", "name", "event" });
    addAnnotation(getEventSession_Target(), source, new String[] { "kind", "element", "name", "target" });
    addAnnotation(getEventSession_DispatchLatency(), source,
        new String[] { "kind", "attribute", "name", "dispatchLatency" });
    addAnnotation(getEventSession_EventRetentionMode(), source,
        new String[] { "kind", "attribute", "name", "eventRetentionMode" });
    addAnnotation(getEventSession_MaxEventSize(), source, new String[] { "kind", "attribute", "name", "maxEventSize" });
    addAnnotation(getEventSession_MaxMemory(), source, new String[] { "kind", "attribute", "name", "maxMemory" });
    addAnnotation(getEventSession_MemoryPartitionMode(), source,
        new String[] { "kind", "attribute", "name", "memoryPartitionMode" });
    addAnnotation(getEventSession_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getEventSession_TrackCausality(), source,
        new String[] { "kind", "attribute", "name", "trackCausality" });
    addAnnotation(retentionModesEEnum, source, new String[] { "name", "retentionModes" });
    addAnnotation(partitionModesEEnum, source, new String[] { "name", "partitionModes" });
  }
