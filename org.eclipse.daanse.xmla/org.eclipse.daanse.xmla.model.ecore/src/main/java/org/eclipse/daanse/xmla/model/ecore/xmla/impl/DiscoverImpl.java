 ...
 * '<em><b>Discover</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.DiscoverImpl#getRequestType
 * <em>Request Type</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.DiscoverImpl#getRestrictions
 * <em>Restrictions</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.DiscoverImpl#getProperties
 * <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
...
public class DiscoverImpl extends MinimalEObjectImpl.Container implements Discover {
  /**
   * The default value of the '{@link #getRequestType() <em>Request Type</em>}'
  ...
  /**
   * The cached value of the '{@link #getRequestType() <em>Request Type</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getRequestType()
   * @generated
  ...
  /**
   * This is true if the Request Type attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  public void setRequestType(Request newRequestType) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER__REQUEST_TYPE, oldRequestType,
          requestType, !oldRequestTypeESet));
  }
  ...
  public void unsetRequestType() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.DISCOVER__REQUEST_TYPE, oldRequestType,
          REQUEST_TYPE_EDEFAULT, oldRequestTypeESet));
  }
  ...
  public NotificationChain basicSetRestrictions(Restrictions newRestrictions, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER__RESTRICTIONS,
          oldRestrictions, newRestrictions);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newRestrictions != restrictions) {
      ...
      if (restrictions != null)
        msgs = ((InternalEObject) restrictions).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - XmlaPackage.DISCOVER__RESTRICTIONS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER__RESTRICTIONS, newRestrictions,
          newRestrictions));
  }
  ...
  public NotificationChain basicSetProperties(Properties newProperties, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER__PROPERTIES,
    ...
    if (newProperties != properties) {
      ...
      if (properties != null)
        msgs = ((InternalEObject) properties).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - XmlaPackage.DISCOVER__PROPERTIES, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER__PROPERTIES, newProperties,
          newProperties));
  }
