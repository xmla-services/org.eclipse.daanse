 ...
 * '<em><b>Rowset</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_rowset.impl.RowsetImpl#getRow
 * <em>Row</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_rowset.impl.RowsetImpl#getException
 * <em>Exception</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_rowset.impl.RowsetImpl#getMessages
 * <em>Messages</em>}</li>
 * </ul>
 *
 * @generated
...
public class RowsetImpl extends MinimalEObjectImpl.Container implements Rowset {
  /**
   * The cached value of the '{@link #getRow() <em>Row</em>}' containment
  ...
  public NotificationChain basicSetException(org.eclipse.daanse.xmla.model.ecore.xmla_exception.Exception newException,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_rowsetPackage.ROWSET__EXCEPTION, oldException, newException);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newException != exception) {
      ...
      if (exception != null)
        msgs = ((InternalEObject) exception).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_rowsetPackage.ROWSET__EXCEPTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_rowsetPackage.ROWSET__EXCEPTION, newException,
          newException));
  }
  ...
  public NotificationChain basicSetMessages(Messages newMessages, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_rowsetPackage.ROWSET__MESSAGES, oldMessages, newMessages);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newMessages != messages) {
      ...
      if (messages != null)
        msgs = ((InternalEObject) messages).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_rowsetPackage.ROWSET__MESSAGES, null, msgs);
      if (newMessages != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, Xmla_rowsetPackage.ROWSET__MESSAGES, newMessages, newMessages));
  }
