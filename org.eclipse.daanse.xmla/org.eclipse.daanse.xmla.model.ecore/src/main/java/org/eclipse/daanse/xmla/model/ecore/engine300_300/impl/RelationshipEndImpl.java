 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getRole
 * <em>Role</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getMultiplicity
 * <em>Multiplicity</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getDimensionID
 * <em>Dimension ID</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getAttributes
 * <em>Attributes</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getTranslations
 * <em>Translations</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndImpl#getVisualizationProperties
 * <em>Visualization Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipEndImpl extends MinimalEObjectImpl.Container implements RelationshipEnd {
  ...
  /**
   * The default value of the '{@link #getDimensionID() <em>Dimension ID</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getDimensionID()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getDimensionID() <em>Dimension ID</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getDimensionID()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getVisualizationProperties()
   * <em>Visualization Properties</em>}' containment reference. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__ROLE, oldRole, role));
  }
  ...
  public void setMultiplicity(MultiplicityType newMultiplicity) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__MULTIPLICITY,
  ...
  public void unsetMultiplicity() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Engine300_300Package.RELATIONSHIP_END__MULTIPLICITY,
  ...
  public void setDimensionID(String newDimensionID) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__DIMENSION_ID,
  ...
  public NotificationChain basicSetAttributes(AttributesType newAttributes, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END__ATTRIBUTES, oldAttributes, newAttributes);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newAttributes != attributes) {
      ...
      if (attributes != null)
        msgs = ((InternalEObject) attributes).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END__ATTRIBUTES, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__ATTRIBUTES,
  ...
  public NotificationChain basicSetTranslations(TranslationsType newTranslations, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END__TRANSLATIONS, oldTranslations, newTranslations);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setTranslations(TranslationsType newTranslations) {
    if (newTranslations != translations) {
      ...
      if (translations != null)
        msgs = ((InternalEObject) translations).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END__TRANSLATIONS, null, msgs);
      if (newTranslations != null)
        msgs = ((InternalEObject) newTranslations).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END__TRANSLATIONS, null, msgs);
      msgs = basicSetTranslations(newTranslations, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__TRANSLATIONS,
   ...
   * @generated
   */
  public NotificationChain basicSetVisualizationProperties(
      RelationshipEndVisualizationProperties newVisualizationProperties, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END__VISUALIZATION_PROPERTIES, oldVisualizationProperties,
  ...
  public void setVisualizationProperties(RelationshipEndVisualizationProperties newVisualizationProperties) {
    if (newVisualizationProperties != visualizationProperties) {
      ...
      if (visualizationProperties != null)
        msgs = ((InternalEObject) visualizationProperties).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END__VISUALIZATION_PROPERTIES, null, msgs);
      if (newVisualizationProperties != null)
        msgs = ((InternalEObject) newVisualizationProperties).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END__VISUALIZATION_PROPERTIES, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END__VISUALIZATION_PROPERTIES,
              newVisualizationProperties, newVisualizationProperties));
  }
