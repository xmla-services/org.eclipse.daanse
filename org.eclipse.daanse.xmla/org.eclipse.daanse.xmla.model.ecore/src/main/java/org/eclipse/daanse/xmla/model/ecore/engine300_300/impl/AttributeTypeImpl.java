 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.AttributeTypeImpl#getAttributeID
 * <em>Attribute ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeTypeImpl extends MinimalEObjectImpl.Container implements AttributeType {
  /**
   * The default value of the '{@link #getAttributeID() <em>Attribute ID</em>}'
  ...
  /**
   * The cached value of the '{@link #getAttributeID() <em>Attribute ID</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getAttributeID()
   * @generated
  ...
  public void setAttributeID(String newAttributeID) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.ATTRIBUTE_TYPE__ATTRIBUTE_ID,
          oldAttributeID, attributeID));
  }
