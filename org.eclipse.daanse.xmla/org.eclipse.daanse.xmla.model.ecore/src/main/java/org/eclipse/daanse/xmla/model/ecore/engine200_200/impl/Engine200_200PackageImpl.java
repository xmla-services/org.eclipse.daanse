...
public class Engine200_200PackageImpl extends EPackageImpl implements Engine200_200Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine200_200Package#eINSTANCE} when
  ...
  public static Engine200_200Package init() {
    if (isInited)
      return (Engine200_200Package) EPackage.Registry.INSTANCE.getEPackage(Engine200_200Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine200_200Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine200_200PackageImpl theEngine200_200Package = registeredEngine200_200Package instanceof Engine200_200PackageImpl
        ? (Engine200_200PackageImpl) registeredEngine200_200Package
        : new Engine200_200PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEClass(expressionBindingEClass, ExpressionBinding.class, "ExpressionBinding", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getExpressionBinding_Expression(), theXMLTypePackage.getString(), "expression", null, 1, 1,
        ExpressionBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(rowNumberBindingEClass, RowNumberBinding.class, "RowNumberBinding", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    ...
    initEAttribute(getDocumentRoot_ImagePath(), theXMLTypePackage.getString(), "imagePath", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ImageUniqueID(), theXMLTypePackage.getString(), "imageUniqueID", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ImageUrl(), theXMLTypePackage.getString(), "imageUrl", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ImageVersion(), theXMLTypePackage.getString(), "imageVersion", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ProcessingRecommendation(), this.getProcessingRecommendationType(),
        "processingRecommendation", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getDocumentRoot_ShareDimensionStorage(), this.getShareDimensionStorageType(),
        "shareDimensionStorage", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_StorageEngineUsed(), this.getStorageEngineUsedType(), "storageEngineUsed", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Token(), theXMLTypePackage.getString(), "token", null, 0, -2, null, IS_TRANSIENT,
    ...
    initEDataType(processingRecommendationTypeObjectEDataType, ProcessingRecommendationType.class,
        "ProcessingRecommendationTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(processingStateTypeObjectEDataType, ProcessingStateType.class, "ProcessingStateTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(shareDimensionStorageTypeObjectEDataType, ShareDimensionStorageType.class,
        "ShareDimensionStorageTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(storageEngineUsedTypeObjectEDataType, StorageEngineUsedType.class, "StorageEngineUsedTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(expressionBindingEClass, source, new String[] { "name", "ExpressionBinding", "kind", "elementOnly" });
    addAnnotation(getExpressionBinding_Expression(), source, new String[] { "kind", "element", "name", "Expression" });
    addAnnotation(processingRecommendationTypeEEnum, source,
        new String[] { "name", "ProcessingRecommendation_._type" });
    addAnnotation(processingRecommendationTypeObjectEDataType, source, new String[] { "name",
        "ProcessingRecommendation_._type:Object", "baseType", "ProcessingRecommendation_._type" });
    ...
    addAnnotation(rowNumberBindingEClass, source, new String[] { "name", "RowNumberBinding", "kind", "empty" });
    addAnnotation(shareDimensionStorageTypeEEnum, source, new String[] { "name", "ShareDimensionStorage_._type" });
    addAnnotation(shareDimensionStorageTypeObjectEDataType, source,
        new String[] { "name", "ShareDimensionStorage_._type:Object", "baseType", "ShareDimensionStorage_._type" });
    addAnnotation(storageEngineUsedTypeEEnum, source, new String[] { "name", "StorageEngineUsed_._type" });
    addAnnotation(storageEngineUsedTypeObjectEDataType, source,
        new String[] { "name", "StorageEngineUsed_._type:Object", "baseType", "StorageEngineUsed_._type" });
    ...
    addAnnotation(getDocumentRoot_ImagePath(), source,
        new String[] { "kind", "element", "name", "ImagePath", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ImageUniqueID(), source,
        new String[] { "kind", "element", "name", "ImageUniqueID", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ImageUrl(), source,
        new String[] { "kind", "element", "name", "ImageUrl", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ImageVersion(), source,
        new String[] { "kind", "element", "name", "ImageVersion", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ProcessingRecommendation(), source,
        new String[] { "kind", "element", "name", "ProcessingRecommendation", "namespace", "##targetNamespace" });
    ...
    addAnnotation(getDocumentRoot_ShareDimensionStorage(), source,
        new String[] { "kind", "element", "name", "ShareDimensionStorage", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_StorageEngineUsed(), source,
        new String[] { "kind", "element", "name", "StorageEngineUsed", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Token(), source,
        new String[] { "kind", "element", "name", "Token", "namespace", "##targetNamespace" });
  }
