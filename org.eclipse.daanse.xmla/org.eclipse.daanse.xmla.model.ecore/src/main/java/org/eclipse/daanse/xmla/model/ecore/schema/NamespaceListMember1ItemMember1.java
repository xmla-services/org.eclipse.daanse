 ...
 * '<em><b>Namespace List Member1 Item Member1</b></em>', and utility methods
...
public enum NamespaceListMember1ItemMember1 implements Enumerator {
  /**
   * The '<em><b>Target Namespace</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Target Namespace</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Local</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #LOCAL
  ...
  /**
   * An array of all the '<em><b>Namespace List Member1 Item Member1</b></em>'
   * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final NamespaceListMember1ItemMember1[] VALUES_ARRAY = new NamespaceListMember1ItemMember1[] {
      TARGET_NAMESPACE, LOCAL, };

  /**
   * A public read-only list of all the '<em><b>Namespace List Member1 Item
   * Member1</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<NamespaceListMember1ItemMember1> VALUES = Collections
      .unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Namespace List Member1 Item Member1</b></em>' literal
