 ...
 * '<em><b>Multiplicity Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum MultiplicityType implements Enumerator {
  ...
  /**
   * The '<em><b>Many</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #MANY
   * @model name="Many"
   ...
   * @generated
   */
  private static final MultiplicityType[] VALUES_ARRAY = new MultiplicityType[] { ONE, MANY, };

  /**
   * A public read-only list of all the '<em><b>Multiplicity Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Multiplicity Type</b></em>' literal with the specified
