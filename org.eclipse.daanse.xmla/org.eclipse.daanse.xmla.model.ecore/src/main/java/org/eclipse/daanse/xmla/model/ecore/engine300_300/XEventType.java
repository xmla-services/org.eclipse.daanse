...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>XEvent
 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.XEventType#getEventSession
...
public interface XEventType extends EObject {
  /**
   * Returns the value of the '<em><b>Event Session</b></em>' containment
   ...
   * <em>Event Session</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Event Session</em>' containment
   *              reference.
   * @see #getEventSession()
   * @generated
   */
