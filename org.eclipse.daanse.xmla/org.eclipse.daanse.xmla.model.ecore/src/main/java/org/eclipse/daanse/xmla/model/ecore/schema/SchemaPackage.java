 ...
 * 
 * Part 1 version: Id: structures.xsd,v 1.2 2004/01/15 11:34:25 ht Exp Part 2
 * version: Id: datatypes.xsd,v 1.3 2004/01/23 18:11:13 ht Exp
 * 
 * 
 * The schema corresponding to this document is normative, with respect to the
 * syntactic constraints it expresses in the XML Schema language. The
 * documentation (within <documentation> elements) below, is not normative, but
 * rather highlights important aspects of the W3C Recommendation of which this
 * is a part
 * 
 * The simpleType element and all of its members are defined towards the end of
 ...
 * 
 * ##other - - any non-conflicting WFXML/attribute from namespace other than
 * targetNS
 * 
 * ##local - - any unqualified non-conflicting WFXML/attribute
 * 
 * one or - - any non-conflicting WFXML/attribute from more URI the listed
 * namespaces references (space separated)
 * 
 * ##targetNamespace or ##local may appear in the above list, to refer to the
 * targetNamespace of the enclosing schema or an absent targetNamespace
 * respectively
 * 
 * notations for use within XML Schema schemas
 * 
 * First the built-in primitive datatypes. These definitions are for information
 * only, the real built-in definitions are magic.
 * 
 * 
 * For each built-in datatype in this schema (both primitive and derived) can be
 * uniquely addressed via a URI constructed as follows: 1) the base URI is the
 * URI of the XML Schema namespace 2) the fragment identifier is the name of the
 * datatype
 * 
 ...
 * 
 * Additionally, each facet definition element can be uniquely addressed via a
 * URI constructed as follows: 1) the base URI is the URI of the XML Schema
 * namespace 2) the fragment identifier is the name of the facet
 * 
 ...
 * uniquely addressed via a URI constructed as follows: 1) the base URI is the
 * URI of the XML Schema namespace 2) the fragment identifier is the name of the
 * datatype, followed by a period (".") followed by the name of the facet
 * 
 * For example, to address the usage of the maxInclusive facet in the definition
 * of int, the URI is:
 * 
 ...
 * 
 * <a href="http://www.w3.org/TR/REC-xml"> http://www.w3.org/TR/REC-xml</a> for
 * information about this namespace.
 * 
 * </p>
 * 
 * <p>
 * Note that local names in this namespace are intended to be defined only by
 * the World Wide Web Consortium or its subgroups. The names currently defined
 * in this namespace are listed below. They should not be used with conflicting
 ...
 * <a href="#usage">how to refer to this schema document from your own XSD
 * schema documents</a> and about <a href="#nsversioning">the
 ...
 * 
 * <p>
 * denotes Jon Bosak, the chair of the original XML Working Group. This name is
 * reserved by the following decision of the W3C XML Plenary and XML
 * Coordination groups:
 * </p>
 * 
 * <blockquote>
 ...
 * on this 10th day of February, 2000, reserves for Jon Bosak in perpetuity the
 * XML name "xml:Father".
 * </p>
 * 
 * </blockquote>
 ...
 * 
 * <p>
 * This schema defines attributes and an attribute group suitable for use by
 * schemas wishing to allow <code>xml:base</code> ,
 * 
 ...
 * defined below will have the desired effect, e.g.
 * </p>
 * 
 * <pre>
 *           &lt;type . . .&gt;
 ...
 * 
 * 
 * <div id="nsversioning" xml:id="nsversioning" xmlns=
 * "http://www.w3.org/1999/xhtml">
 * 
 * <h2><a name="nsversioning">Versioning policy for this schema document</a>
 * </h2>
 * 
 * <div class="bodytext">
 * 
 * <p>
 * In keeping with the XML Schema WG's standard versioning policy, this schema
 * document will persist at
 * 
 ...
 * 
 * <p>
 * The schema document at that URI may however change in the future, in order to
 * remain compatible with the latest version of XML Schema itself, or with the
 * XML namespace itself. In other words, if the XML Schema or XML namespaces
...
public interface SchemaPackage extends EPackage {
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.OpenAttrsImpl
   * <em>Open Attrs</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AnnotatedImpl
   * <em>Annotated</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.GroupImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExplicitGroupImpl
   * <em>Explicit Group</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AllImpl
   * <em>All</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The number of operations of the '<em>All</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AnnotationTypeImpl
   * <em>Annotation Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.WildcardImpl
   * <em>Wildcard</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AnyTypeImpl <em>Any
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AppinfoTypeImpl
   * <em>Appinfo Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AttributeImpl
  ...
  /**
   * The feature id for the '<em><b>Use</b></em>' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AttributeGroupImpl
   * <em>Attribute Group</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Attribute Group</b></em>' containment
  ...
  /**
   * The feature id for the '<em><b>Any Attribute1</b></em>' containment
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.AttributeGroupRefImpl
   * <em>Attribute Group Ref</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Attribute Group Ref</em>'
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexContentTypeImpl
   * <em>Complex Content Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Mixed</b></em>' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>Complex Content Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.RestrictionTypeImpl
   * <em>Restriction Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Fraction Digits</b></em>' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexRestrictionTypeImpl
   * <em>Complex Restriction Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Complex Restriction Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl
   * <em>Complex Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Simple Content</b></em>' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Complex Content</b></em>' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Block</b></em>' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.DocumentationTypeImpl
   * <em>Documentation Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.DocumentRootImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl
   * <em>Extension Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.FacetImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.FieldTypeImpl
  ...
  /**
   * The feature id for the '<em><b>Xpath</b></em>' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.RealGroupImpl
   * <em>Real Group</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.GroupRefImpl
   * <em>Group Ref</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ImportTypeImpl
   * <em>Import Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.IncludeTypeImpl
   * <em>Include Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.KeybaseImpl
   * <em>Keybase</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The number of operations of the '<em>Keybase</em>' class. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.KeyrefTypeImpl
   * <em>Keyref Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Refer</b></em>' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ListTypeImpl <em>List
   * Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.LocalComplexTypeImpl
   * <em>Local Complex Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.LocalElementImpl
   * <em>Local Element</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.LocalSimpleTypeImpl
   * <em>Local Simple Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NamedAttributeGroupImpl
   * <em>Named Attribute Group</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Named Attribute Group</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NamedGroupImpl
   * <em>Named Group</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NarrowMaxMinImpl
   * <em>Narrow Max Min</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NoFixedFacetImpl
   * <em>No Fixed Facet</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NotationTypeImpl
   * <em>Notation Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.NumFacetImpl <em>Num
   * Facet</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.PatternTypeImpl
   * <em>Pattern Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.RedefineTypeImpl
   * <em>Redefine Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.RestrictionType1Impl
   * <em>Restriction Type1</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaTypeImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SelectorTypeImpl
   * <em>Selector Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleContentTypeImpl
   * <em>Simple Content Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Simple Content Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleExplicitGroupImpl
   * <em>Simple Explicit Group</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Simple Explicit Group</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleExtensionTypeImpl
   * <em>Simple Extension Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Simple Extension Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleRestrictionTypeImpl
   * <em>Simple Restriction Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Simple Restriction Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.TopLevelAttributeImpl
   * <em>Top Level Attribute</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Top Level Attribute</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.TopLevelComplexTypeImpl
   * <em>Top Level Complex Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Top Level Complex Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.TopLevelElementImpl
   * <em>Top Level Element</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.TopLevelSimpleTypeImpl
   * <em>Top Level Simple Type</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Top Level Simple Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.TotalDigitsTypeImpl
   * <em>Total Digits Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.UnionTypeImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.WhiteSpaceTypeImpl
   * <em>White Space Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AllNNIMember1 <em>All NNI
   * Member1</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember0 <em>Block
   * Set Member0</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item
   * <em>Block Set Member1 Item</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationControl
   * <em>Derivation Control</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
   * <em>Derivation Set Member0</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FormChoice <em>Form
   * Choice</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
   * <em>Full Derivation Set Member0</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
   * <em>Namespace List Member0</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
   * <em>Namespace List Member1 Item Member1</em>}' enum. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType
   * <em>Process Contents Type</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
   * <em>Reduced Derivation Control</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0
   * <em>Simple Derivation Set Member0</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
   * <em>Simple Derivation Set Member1 Item</em>}' enum. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
   * <em>Type Derivation Control</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.UseType <em>Use
  ...
  /**
   * The meta object id for the '<em>All NNI</em>' data type. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the '<em>Block Set Member1 Item Object</em>' data
  ...
  /**
   * The meta object id for the '<em>Derivation Set Member0 Object</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
  ...
  /**
   * The meta object id for the '<em>Full Derivation Set Member0 Object</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
  ...
  /**
   * The meta object id for the '<em>Namespace List Member0 Object</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
  ...
  /**
   * The meta object id for the '<em>Namespace List Member1 Item Member1
  ...
  /**
   * The meta object id for the '<em>Public</em>' data type. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the '<em>Reduced Derivation Control Object</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
  ...
  /**
   * The meta object id for the '<em>Simple Derivation Set Member0 Object</em>'
  ...
  /**
   * The meta object id for the '<em>Simple Derivation Set Member1</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see java.util.List
  ...
  /**
   * The meta object id for the '<em>Simple Derivation Set Member1 Item
   * Object</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
  ...
  /**
   * The meta object id for the '<em>Type Derivation Control Object</em>' data
   * type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
   ...
   * <em>Annotated</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Annotated#getAnnotation
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Annotated#getId
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnnotationType#getGroup
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnnotationType#getAppinfo
   * <em>Appinfo</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnnotationType#getDocumentation
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnnotationType#getId
   * <em>Id</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Id</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnyType#getMaxOccurs
   * <em>Max Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AnyType#getMinOccurs
   * <em>Min Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AppinfoType#getMixed
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AppinfoType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AppinfoType#getAny
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AppinfoType#getSource
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AppinfoType#getAnyAttribute
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getSimpleType
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getDefault
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getFixed
   * <em>Fixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getForm
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getName
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getRef
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getType
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Attribute#getUse
   ...
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getAnyAttribute1
   * <em>Any Attribute1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Any
   *         Attribute1</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup#getRef
   * <em>Ref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Ref</em>'.
   ...
   * <em>Attribute Group Ref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Complex Content Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexContentType#getRestriction
   * <em>Restriction</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexContentType#getExtension
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexContentType#isMixed
   * <em>Mixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Complex Restriction Type</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getSimpleContent
   * <em>Simple Content</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getComplexContent
   * <em>Complex Content</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Complex
   *         Content</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getAll
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getChoice
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getSequence
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getGroup1
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getAnyAttribute1
   * <em>Any Attribute1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Any
   *         Attribute1</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#isAbstract
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getBlock
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getFinal
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#isMixed
   * <em>Mixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Mixed</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ComplexType#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
   ...
   * <em>Documentation Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getMixed
   * <em>Mixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Mixed</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getAny
   * <em>Any</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Any</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getLang
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getSource
   * <em>Source</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Source</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentationType#getAnyAttribute
   * <em>Any Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Any Attribute</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMixed
   * <em>Mixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Mixed</em>'.
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getXSISchemaLocation
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAll
   * <em>All</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>All</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAnnotation
   * <em>Annotation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Annotation</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAny
   * <em>Any</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAnyAttribute
   * <em>Any Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Any
   *         Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAppinfo
   * <em>Appinfo</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getChoice
   * <em>Choice</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Choice</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getComplexContent
   * <em>Complex Content</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Complex
   *         Content</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getComplexType
   * <em>Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Complex
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getDocumentation
   * <em>Documentation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getElement
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getEnumeration
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getField
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getFractionDigits
   * <em>Fraction Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Fraction
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getImport
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getInclude
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getKey
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getKeyref
   * <em>Keyref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getLength
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getList
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMaxExclusive
   * <em>Max Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Max
   *         Exclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMaxInclusive
   * <em>Max Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Max
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMaxLength
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMinExclusive
   * <em>Min Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Min
   *         Exclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMinInclusive
   * <em>Min Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Min
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getMinLength
   * <em>Min Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getNotation
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getPattern
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getRedefine
   * <em>Redefine</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getRestriction
   * <em>Restriction</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Restriction</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getSchema
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getSelector
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getSequence
   * <em>Sequence</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Sequence</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getSimpleContent
   * <em>Simple Content</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple
   *         Content</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getTotalDigits
   * <em>Total Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Total
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getUnion
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getUnique
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DocumentRoot#getWhiteSpace
   * <em>White Space</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getComplexType
   * <em>Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Complex
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getIdentityConstraint
   * <em>Identity Constraint</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Identity
   *         Constraint</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getUnique
   * <em>Unique</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getKey
   * <em>Key</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getKeyref
   * <em>Keyref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#isAbstract
   * <em>Abstract</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Abstract</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getBlock
   * <em>Block</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Block</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getDefault
   * <em>Default</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Default</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getFinal
   * <em>Final</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Final</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getFixed
   * <em>Fixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Fixed</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getForm
   * <em>Form</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Form</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getMaxOccurs
   * <em>Max Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Max Occurs</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getMinOccurs
   * <em>Min Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Min Occurs</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#isNillable
   * <em>Nillable</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getRef
   * <em>Ref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Ref</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getSubstitutionGroup
   * <em>Substitution Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Element#getType
   * <em>Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getAll
   * <em>All</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>All</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getChoice
   * <em>Choice</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Choice</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getSequence
   * <em>Sequence</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getGroup1
   * <em>Group1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group1</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getAnyAttribute1
   * <em>Any Attribute1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Any
   *         Attribute1</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType#getBase
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Facet#isFixed
   * <em>Fixed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Fixed</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Facet#getValue
   ...
   * <em>Xpath</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getParticle
   * <em>Particle</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getElement
   * <em>Element</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Element</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getAll
   * <em>All</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getChoice
   * <em>Choice</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getSequence
   * <em>Sequence</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Sequence</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getAny
   * <em>Any</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getMaxOccurs <em>Max
   * Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Max Occurs</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getMinOccurs <em>Min
   * Occurs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Min Occurs</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Group#getRef
   * <em>Ref</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Ref</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ImportType#getNamespace
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ImportType#getSchemaLocation
   * <em>Schema Location</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.IncludeType#getSchemaLocation
   * <em>Schema Location</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Schema Location</em>'.
   ...
   * <em>Keybase</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Keybase#getSelector
   * <em>Selector</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Selector</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Keybase#getField
   * <em>Field</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Keybase#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.KeyrefType#getRefer
   * <em>Refer</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ListType#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ListType#getItemType
   * <em>Item Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Named Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Max Min</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Facet</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NotationType#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NotationType#getPublic
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NotationType#getSystem
   ...
   * Attrs</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.OpenAttrs#getAnyAttribute
   * <em>Any Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Any Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RealGroup#getAll1
   * <em>All1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RealGroup#getChoice1
   * <em>Choice1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RealGroup#getSequence1
   * <em>Sequence1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getAnnotation
   * <em>Annotation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Annotation</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Simple
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getComplexType
   * <em>Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Complex
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getGroup1
   * <em>Group1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getId
   * <em>Id</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Id</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RedefineType#getSchemaLocation
   * <em>Schema Location</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Schema Location</em>'.
   ...
   * <em>Restriction Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getAll
   * <em>All</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>All</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getChoice
   * <em>Choice</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Choice</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getSequence
   * <em>Sequence</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Sequence</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getFacets
   * <em>Facets</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMinExclusive
   * <em>Min Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMinInclusive
   * <em>Min Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Min
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMaxExclusive
   * <em>Max Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMaxInclusive
   * <em>Max Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Max
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getTotalDigits
   * <em>Total Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Total
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getFractionDigits
   * <em>Fraction Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Fraction
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getLength
   * <em>Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMinLength
   * <em>Min Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Min
   *         Length</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getMaxLength
   * <em>Max Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Max
   *         Length</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getEnumeration
   * <em>Enumeration</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Enumeration</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getWhiteSpace
   * <em>White Space</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>White
   *         Space</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getPattern
   * <em>Pattern</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Pattern</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getGroup1
   * <em>Group1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group1</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getAnyAttribute1
   * <em>Any Attribute1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Any
   *         Attribute1</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType#getBase
   * <em>Base</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Base</em>'.
   ...
   * <em>Restriction Type1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Simple Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getFacets
   * <em>Facets</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Facets</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMinExclusive
   * <em>Min Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Min
   *         Exclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMinInclusive
   * <em>Min Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Min
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMaxExclusive
   * <em>Max Exclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Max
   *         Exclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMaxInclusive
   * <em>Max Inclusive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Max
   *         Inclusive</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getTotalDigits
   * <em>Total Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Total
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getFractionDigits
   * <em>Fraction Digits</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Fraction
   *         Digits</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getLength
   * <em>Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Length</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMinLength
   * <em>Min Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Min
   *         Length</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getMaxLength
   * <em>Max Length</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Max
   *         Length</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getEnumeration
   * <em>Enumeration</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Enumeration</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getWhiteSpace
   * <em>White Space</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>White
   *         Space</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getPattern
   * <em>Pattern</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Pattern</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1#getBase
   * <em>Base</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Base</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getGroup
   * <em>Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getInclude
   * <em>Include</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Include</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getImport
   * <em>Import</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getRedefine
   * <em>Redefine</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Redefine</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getAnnotation
   * <em>Annotation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Annotation</em>'.
  ...
  /**
   * Returns the meta object for the attribute list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getGroup1
   * <em>Group1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute list '<em>Group1</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Simple
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getComplexType
   * <em>Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Complex
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getGroup2
   * <em>Group2</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getAttributeGroup
   * <em>Attribute Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Attribute
   *         Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getElement
   * <em>Element</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Element</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getAttribute
   * <em>Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Attribute</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getNotation
   * <em>Notation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Notation</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getAnnotation1
   * <em>Annotation1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list
   *         '<em>Annotation1</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getAttributeFormDefault
   * <em>Attribute Form Default</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getBlockDefault
   * <em>Block Default</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getElementFormDefault
   * <em>Element Form Default</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getFinalDefault
   * <em>Final Default</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getId
   * <em>Id</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Id</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getLang
   * <em>Lang</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Lang</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getTargetNamespace
   * <em>Target Namespace</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SchemaType#getVersion
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SelectorType#getXpath
   * <em>Xpath</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Xpath</em>'.
   ...
   * <em>Simple Content Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Simple Explicit Group</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * <em>Simple Extension Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * <em>Simple Restriction Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleType#getRestriction
   * <em>Restriction</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Restriction</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleType#getList
   * <em>List</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>List</em>'.
  ...
  /**
   * Returns the meta object for the containment reference
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleType#getUnion
   * <em>Union</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference '<em>Union</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleType#getFinal
   * <em>Final</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Final</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleType#getName
   * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Name</em>'.
   ...
   * Level Attribute</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Top Level Complex Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Level Element</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Level Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Digits Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.UnionType#getSimpleType
   * <em>Simple Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Simple
   *         Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.UnionType#getMemberTypes
   * <em>Member Types</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Space Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Wildcard</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getNamespace
   * <em>Namespace</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Namespace</em>'.
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.Wildcard#getProcessContents
   * <em>Process Contents</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AllNNIMember1 <em>All NNI
   * Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember0 <em>Block
   * Set Member0</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item
   * <em>Block Set Member1 Item</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationControl
   * <em>Derivation Control</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
   * <em>Derivation Set Member0</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FormChoice <em>Form
   * Choice</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
   * <em>Full Derivation Set Member0</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
   * <em>Namespace List Member0</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
   * <em>Namespace List Member1 Item Member1</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for enum '<em>Namespace List Member1 Item
   *         Member1</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
   * @generated
   */
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType
   * <em>Process Contents Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
   * <em>Reduced Derivation Control</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0
   * <em>Simple Derivation Set Member0</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
   * <em>Simple Derivation Set Member1 Item</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for enum '<em>Simple Derivation Set Member1
   *         Item</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
   * @generated
   */
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
   * <em>Type Derivation Control</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>All
   * NNI</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc -->
   * 
   * for maxOccurs <!-- end-model-doc -->
   * 
   * @return the meta object for data type '<em>All NNI</em>'.
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData="name='allNNI'
   *        memberTypes='http://www.eclipse.org/emf/2003/XMLType#nonNegativeInteger
   *        allNNI_._member_._1'"
   * @generated
   */
  EDataType getAllNNI();
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.AllNNIMember1 <em>All NNI
   * Member1 Object</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   *        extendedMetaData="name='allNNI_._member_._1:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Block
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData="name='blockSet'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember0 <em>Block
   * Set Member0 Object</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   *        extendedMetaData="name='blockSet_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Block Set
   * Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Block Set Member1</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='blockSet_._member_._1'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item
   * <em>Block Set Member1 Item Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Block Set Member1 Item
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item"
   *        extendedMetaData="name='blockSet_._member_._1_._item:Object'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationControl
   * <em>Derivation Control Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   *        extendedMetaData="name='derivationControl:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Derivation
   * Set</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc -->
   * 
   * A utility type, not for public use
   ...
   *        extendedMetaData="name='derivationSet'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
   * <em>Derivation Set Member0 Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Derivation Set Member0
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0"
   *        extendedMetaData="name='derivationSet_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Derivation
   * Set Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Derivation Set Member1</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='derivationSet_._member_._1'
  ...
  /**
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FormChoice <em>Form Choice
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Full
   * Derivation Set</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc -->
   * 
   * A utility type, not for public use
   * 
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object"
   *        extendedMetaData="name='fullDerivationSet'
   *        memberTypes='fullDerivationSet_._member_._0
   *        fullDerivationSet_._member_._1'"
   * @generated
   */
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
   * <em>Full Derivation Set Member0 Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Full Derivation Set Member0
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0"
   *        extendedMetaData="name='fullDerivationSet_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Full
   * Derivation Set Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Full Derivation Set Member1</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='fullDerivationSet_._member_._1'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Member Types
   * Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Member Types Type</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='memberTypes_._type'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Namespace
   * List</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc -->
   * 
   * A utility type, not for public use <!-- end-model-doc -->
   * 
   * @return the meta object for data type '<em>Namespace List</em>'.
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object"
   *        extendedMetaData="name='namespaceList'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
   * <em>Namespace List Member0 Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Namespace List Member0
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0"
   *        extendedMetaData="name='namespaceList_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Namespace
   * List Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Namespace List Member1</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='namespaceList_._member_._1'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Namespace
   * List Member1 Item</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Namespace List Member1 Item</em>'.
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object"
   *        extendedMetaData="name='namespaceList_._member_._1_._item'
   *        memberTypes='http://www.eclipse.org/emf/2003/XMLType#anyURI
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
   * <em>Namespace List Member1 Item Member1 Object</em>}'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Namespace List Member1 Item
   *         Member1 Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1"
   *        extendedMetaData="name='namespaceList_._member_._1_._item_._member_._1:Object'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType
   * <em>Process Contents Type Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Process Contents Type
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType"
   *        extendedMetaData="name='processContents_._type:Object'
   ...
   * A utility type, not for public use
   * 
   * A public identifier, per ISO 8879 <!-- end-model-doc -->
   * 
   * @return the meta object for data type '<em>Public</em>'.
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='public'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
   * <em>Reduced Derivation Control Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Reduced Derivation Control
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl"
   *        extendedMetaData="name='reducedDerivationControl:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Simple
   * Derivation Set</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc -->
   * 
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object"
   *        extendedMetaData="name='simpleDerivationSet'
   *        memberTypes='simpleDerivationSet_._member_._0
   *        simpleDerivationSet_._member_._1'"
   * @generated
   */
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0
   * <em>Simple Derivation Set Member0 Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Simple Derivation Set Member0
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0"
   *        extendedMetaData="name='simpleDerivationSet_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Simple
   * Derivation Set Member1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Simple Derivation Set
   *         Member1</em>'.
   * @see java.util.List
   * @model instanceClass="java.util.List"
   *        extendedMetaData="name='simpleDerivationSet_._member_._1'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
   * <em>Simple Derivation Set Member1 Item Object</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Simple Derivation Set Member1 Item
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item"
   *        extendedMetaData="name='simpleDerivationSet_._member_._1_._item:Object'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
   * <em>Type Derivation Control Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Type Derivation Control
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl"
   *        extendedMetaData="name='typeDerivationControl:Object'
  ...
  /**
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.schema.UseType <em>Use Type
   * Object</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Xpath
   * Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc --> A subset of XPath expressions for use in fields A utility
   * type, not for public use The following pattern is intended to allow XPath
   * expressions per the same EBNF as for selector, with the following change:
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='xpath_._type'
   *        baseType='http://www.eclipse.org/emf/2003/XMLType#token'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Xpath
   * Type1</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
   * begin-model-doc --> A subset of XPath expressions for use in selectors A
   * utility type, not for public use The following pattern is intended to allow
   * XPath expressions per the following EBNF: Selector ::= Path ( '|' Path )*
   * Path ::= ('.//')? Step ( '/' Step )* Step ::= '.' | NameTest NameTest ::=
   * QName | '*' | NCName ':' '*' child:: is also allowed
   * 
   * <!-- end-model-doc -->
   * 
   ...
   *        extendedMetaData="name='xpath_._1_._type'
   *        baseType='http://www.eclipse.org/emf/2003/XMLType#token'
  ...
  interface Literals {
    ...
    /**
     * The meta object literal for the '<em><b>Group</b></em>' attribute list
    ...
    /**
     * The meta object literal for the '<em><b>Appinfo</b></em>' containment
    ...
    /**
     * The meta object literal for the '<em><b>Max Occurs</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Min Occurs</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Any Attribute</b></em>' attribute
    ...
    /**
     * The meta object literal for the '<em><b>Simple Type</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Attribute</b></em>' containment
     * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Attribute Group</b></em>' containment
     * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Any Attribute1</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Restriction</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Extension</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Simple Content</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Complex Content</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Group</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>All</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Choice</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Sequence</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Group1</b></em>' attribute list
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Any</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Any Attribute</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Complex Type</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Fraction Digits</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Include</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Key</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Keyref</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Length</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>List</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Max Exclusive</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Max Inclusive</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Max Length</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Min Exclusive</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Min Inclusive</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Min Length</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Notation</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Pattern</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Redefine</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Schema</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Selector</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Total Digits</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Union</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Unique</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>White Space</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Identity Constraint</b></em>'
    ...
    /**
     * The meta object literal for the '<em><b>Substitution Group</b></em>'
    ...
    /**
     * The meta object literal for the '<em><b>Particle</b></em>' attribute list
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Schema Location</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>All1</b></em>' containment reference
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Choice1</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Sequence1</b></em>' containment
     * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Group1</b></em>' containment
     * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Facets</b></em>' attribute list
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Group2</b></em>' containment
     * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Annotation1</b></em>' containment
     * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Attribute Form Default</b></em>'
     * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Block Default</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Element Form Default</b></em>'
     * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Final Default</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Target Namespace</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Member Types</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Process Contents</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em>Block Set Member0 Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember0
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getBlockSetMember0Object()
    ...
    /**
     * The meta object literal for the '<em>Block Set Member1 Item Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getBlockSetMember1ItemObject()
    ...
    /**
     * The meta object literal for the '<em>Derivation Control Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.DerivationControl
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getDerivationControlObject()
    ...
    /**
     * The meta object literal for the '<em>Derivation Set Member0 Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getDerivationSetMember0Object()
    ...
    /**
     * The meta object literal for the '<em>Full Derivation Set Member0 Object</em>'
     * data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getFullDerivationSetMember0Object()
    ...
    /**
     * The meta object literal for the '<em>Full Derivation Set Member1</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.util.List
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getFullDerivationSetMember1()
    ...
    /**
     * The meta object literal for the '<em>Namespace List Member0 Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getNamespaceListMember0Object()
    ...
    /**
     * The meta object literal for the '<em>Namespace List Member1 Item</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.Object
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getNamespaceListMember1Item()
    ...
    /**
     * The meta object literal for the '<em>Namespace List Member1 Item Member1
     * Object</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getNamespaceListMember1ItemMember1Object()
    ...
    /**
     * The meta object literal for the '<em>Process Contents Type Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getProcessContentsTypeObject()
    ...
    /**
     * The meta object literal for the '<em>Reduced Derivation Control Object</em>'
     * data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getReducedDerivationControlObject()
    ...
    /**
     * The meta object literal for the '<em>Simple Derivation Set Member0
     * Object</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getSimpleDerivationSetMember0Object()
    ...
    /**
     * The meta object literal for the '<em>Simple Derivation Set Member1</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.util.List
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getSimpleDerivationSetMember1()
    ...
    /**
     * The meta object literal for the '<em>Simple Derivation Set Member1 Item
     * Object</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getSimpleDerivationSetMember1ItemObject()
    ...
    /**
     * The meta object literal for the '<em>Type Derivation Control Object</em>'
     * data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl
     * @see org.eclipse.daanse.xmla.model.ecore.schema.impl.SchemaPackageImpl#getTypeDerivationControlObject()
