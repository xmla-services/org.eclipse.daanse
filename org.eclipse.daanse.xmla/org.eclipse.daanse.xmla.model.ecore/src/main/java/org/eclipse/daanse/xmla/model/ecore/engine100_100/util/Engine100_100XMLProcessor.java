 ...
 * @generated
 */
@Component(name = Engine100_100Package.eNAME
    + "XMLProcessor", service = Engine100_100XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine100_100XMLProcessor extends XMLProcessor {
   ...
   * Engine100_100ResourceFactoryImpl factory. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
