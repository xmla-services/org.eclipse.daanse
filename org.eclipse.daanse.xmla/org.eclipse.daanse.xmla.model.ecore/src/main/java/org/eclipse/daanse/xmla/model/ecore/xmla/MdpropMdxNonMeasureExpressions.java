 ...
 * '<em><b>Mdprop Mdx Non Measure Expressions</b></em>', and utility methods for
...
public enum MdpropMdxNonMeasureExpressions implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Mdprop Mdx Non Measure Expressions</b></em>'
   * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final MdpropMdxNonMeasureExpressions[] VALUES_ARRAY = new MdpropMdxNonMeasureExpressions[] { _0, _1, };

  /**
   * A public read-only list of all the '<em><b>Mdprop Mdx Non Measure
   * Expressions</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @generated
   */
  public static final List<MdpropMdxNonMeasureExpressions> VALUES = Collections
      .unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Mdprop Mdx Non Measure Expressions</b></em>' literal with
