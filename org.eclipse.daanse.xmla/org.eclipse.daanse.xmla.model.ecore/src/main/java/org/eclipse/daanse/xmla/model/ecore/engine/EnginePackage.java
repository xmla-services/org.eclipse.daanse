...
public interface EnginePackage extends EPackage {
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.ImpersonationInfoImpl
   * <em>Impersonation Info</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The feature id for the '<em><b>Impersonation Info Security</b></em>'
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfoSecurityType
   * <em>Impersonation Info Security Type</em>}' enum. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType
   * <em>Impersonation Mode Type</em>}' enum. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the '<em>Impersonation Info Security Type Object</em>'
  ...
  /**
   * The meta object id for the '<em>Impersonation Mode Type Object</em>' data
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot <em>Document
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot#getMixed
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot#getXSISchemaLocation
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot#getLastDataUpdate
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot#getLastSchemaUpdate
  ...
  /**
   * Returns the meta object for class
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo
   * <em>Impersonation Info</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo#getImpersonationMode
   * <em>Impersonation Mode</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo#getAccount
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo#getPassword
  ...
  /**
   * Returns the meta object for the attribute
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo#getImpersonationInfoSecurity
   * <em>Impersonation Info Security</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for the attribute '<em>Impersonation Info
   *         Security</em>'.
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfoSecurityType
   * <em>Impersonation Info Security Type</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * Returns the meta object for enum
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType
   * <em>Impersonation Mode Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfoSecurityType
   * <em>Impersonation Info Security Type Object</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Impersonation Info Security Type
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfoSecurityType
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfoSecurityType"
   *        extendedMetaData="name='ImpersonationInfoSecurity_._type:Object'
   ...
   * Returns the meta object for data type
   * '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType
   * <em>Impersonation Mode Type Object</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Impersonation Mode Type
   *         Object</em>'.
   * @see org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType
   * @model instanceClass="org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType"
   *        extendedMetaData="name='ImpersonationMode_._type:Object'
  ...
  interface Literals {
    ...
    /**
     * The meta object literal for the '<em><b>Impersonation Mode</b></em>'
     * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Impersonation Info Security</b></em>'
     * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    EAttribute IMPERSONATION_INFO__IMPERSONATION_INFO_SECURITY = eINSTANCE
    ...
    /**
     * The meta object literal for the '<em>Impersonation Info Security Type
    ...
    /**
     * The meta object literal for the '<em>Impersonation Mode Type Object</em>'
     * data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationModeType
     * @see org.eclipse.daanse.xmla.model.ecore.engine.impl.EnginePackageImpl#getImpersonationModeTypeObject()
