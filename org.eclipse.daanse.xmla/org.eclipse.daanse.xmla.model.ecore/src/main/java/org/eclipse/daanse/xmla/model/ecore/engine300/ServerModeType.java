 ...
 * '<em><b>Server Mode Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum ServerModeType implements Enumerator {
  ...
  /**
   * The '<em><b>Share Point</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Share Point</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #SHARE_POINT
   ...
   * @generated
   */
  private static final ServerModeType[] VALUES_ARRAY = new ServerModeType[] { MULTIDIMENSIONAL, TABULAR, SHARE_POINT, };

  /**
   * A public read-only list of all the '<em><b>Server Mode Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Server Mode Type</b></em>' literal with the specified
