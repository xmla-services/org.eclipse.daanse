 ...
 * '<em><b>Relationship End Translation</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getLanguage
 * <em>Language</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getCaption
 * <em>Caption</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getCollectionCaption
 * <em>Collection Caption</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getDisplayFolder
 * <em>Display Folder</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipEndTranslationImpl#getAnnotations
...
public class RelationshipEndTranslationImpl extends MinimalEObjectImpl.Container implements RelationshipEndTranslation {
  ...
  /**
   * The default value of the '{@link #getCollectionCaption() <em>Collection
   * Caption</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getCollectionCaption() <em>Collection
   * Caption</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCollectionCaption()
   * @generated
  ...
  /**
   * The default value of the '{@link #getDisplayFolder() <em>Display
   * Folder</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getDisplayFolder() <em>Display Folder</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getDisplayFolder()
   * @generated
  ...
  public void setLanguage(long newLanguage) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END_TRANSLATION__LANGUAGE,
          oldLanguage, language, !oldLanguageESet));
  }
  ...
  public void unsetLanguage() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.UNSET, Engine300_300Package.RELATIONSHIP_END_TRANSLATION__LANGUAGE,
  ...
  public void setCaption(String newCaption) {
    ...
    caption = newCaption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP_END_TRANSLATION__CAPTION,
          oldCaption, caption));
  }
  ...
  public void setCollectionCaption(String newCollectionCaption) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END_TRANSLATION__COLLECTION_CAPTION, oldCollectionCaption,
          collectionCaption));
  }
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END_TRANSLATION__DESCRIPTION, oldDescription, description));
  }
  ...
  public void setDisplayFolder(String newDisplayFolder) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END_TRANSLATION__DISPLAY_FOLDER, oldDisplayFolder, displayFolder));
  }
  ...
  public NotificationChain basicSetAnnotations(AnnotationsType newAnnotations, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END_TRANSLATION__ANNOTATIONS, oldAnnotations, newAnnotations);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newAnnotations != annotations) {
      ...
      if (annotations != null)
        msgs = ((InternalEObject) annotations).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP_END_TRANSLATION__ANNOTATIONS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP_END_TRANSLATION__ANNOTATIONS, newAnnotations, newAnnotations));
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Engine300_300Package.RELATIONSHIP_END_TRANSLATION__COLLECTION_CAPTION:
      return COLLECTION_CAPTION_EDEFAULT == null ? collectionCaption != null
          : !COLLECTION_CAPTION_EDEFAULT.equals(collectionCaption);
    case Engine300_300Package.RELATIONSHIP_END_TRANSLATION__DESCRIPTION:
