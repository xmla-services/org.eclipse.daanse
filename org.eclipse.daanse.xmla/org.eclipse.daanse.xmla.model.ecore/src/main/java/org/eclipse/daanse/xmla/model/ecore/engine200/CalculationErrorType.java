 ...
 * '<em><b>Calculation Error Type</b></em>', and utility methods for working
...
public enum CalculationErrorType implements Enumerator {
  /**
   * The '<em><b>Ignore Error</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Report And Stop</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Ignore Error</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #IGNORE_ERROR
  ...
  /**
   * The '<em><b>Report And Stop</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #REPORT_AND_STOP
   ...
   * @generated
   */
  private static final CalculationErrorType[] VALUES_ARRAY = new CalculationErrorType[] { IGNORE_ERROR,
      REPORT_AND_STOP, };

  /**
   * A public read-only list of all the '<em><b>Calculation Error Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Calculation Error Type</b></em>' literal with the
  ...
  public static CalculationErrorType get(int value) {
    switch (value) {
    case IGNORE_ERROR_VALUE:
      return IGNORE_ERROR;
    case REPORT_AND_STOP_VALUE:
