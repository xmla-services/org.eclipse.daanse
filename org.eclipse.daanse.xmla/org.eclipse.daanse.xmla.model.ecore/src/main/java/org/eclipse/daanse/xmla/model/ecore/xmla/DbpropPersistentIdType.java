 ...
 * '<em><b>Dbprop Persistent Id Type</b></em>', and utility methods for working
...
public enum DbpropPersistentIdType implements Enumerator {
  ...
  /**
   * The '<em><b>4</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_4_VALUE
   * @generated
  ...
  /**
   * The '<em><b>8</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_8_VALUE
   * @generated
  ...
  /**
   * The '<em><b>32</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_32_VALUE
   * @generated
  ...
  /**
   * The '<em><b>64</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_64_VALUE
   * @generated
  ...
  /**
   * The '<em><b>4</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_4
   * @model literal="4"
  ...
  /**
   * The '<em><b>8</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_8
   * @model literal="8"
  ...
  /**
   * The '<em><b>32</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_32
   * @model literal="32"
  ...
  /**
   * The '<em><b>64</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #_64
   * @model literal="64"
   ...
   * @generated
   */
  private static final DbpropPersistentIdType[] VALUES_ARRAY = new DbpropPersistentIdType[] { _1, _2, _4, _8, _16, _32,
      _64, };

  /**
   * A public read-only list of all the '<em><b>Dbprop Persistent Id
  ...
  /**
   * Returns the '<em><b>Dbprop Persistent Id Type</b></em>' literal with the
