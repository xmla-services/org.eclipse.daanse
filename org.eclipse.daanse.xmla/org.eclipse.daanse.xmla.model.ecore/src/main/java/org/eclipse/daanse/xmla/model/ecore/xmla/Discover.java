 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.Discover#getRequestType
 * <em>Request Type</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.Discover#getRestrictions
 * <em>Restrictions</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.Discover#getProperties
 * <em>Properties</em>}</li>
 * </ul>
 *
...
public interface Discover extends EObject {
  /**
   * Returns the value of the '<em><b>Request Type</b></em>' attribute. The
   * literals are from the enumeration
   * {@link org.eclipse.daanse.xmla.model.ecore.xmla.Request}. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   ...
   * <em>Request Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * '{@link org.eclipse.daanse.xmla.model.ecore.xmla.Discover#getRequestType
   * <em>Request Type</em>}' attribute is set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Restrictions</b></em>' containment
   ...
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Restrictions</em>' containment
   *              reference.
   * @see #getRestrictions()
   * @generated
   */
   ...
   * <em>Properties</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Properties</em>' containment
   *              reference.
   * @see #getProperties()
   * @generated
   */
