 ...
 * Location Object</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.WarningLocationObjectImpl#getWarningColumn
 * <em>Warning Column</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.WarningLocationObjectImpl#getWarningMeasure
...
public class WarningLocationObjectImpl extends MinimalEObjectImpl.Container implements WarningLocationObject {
  /**
   * The cached value of the '{@link #getWarningColumn() <em>Warning Column</em>}'
  ...
  /**
   * The cached value of the '{@link #getWarningMeasure() <em>Warning
   * Measure</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  public NotificationChain basicSetWarningColumn(WarningColumnType newWarningColumn, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine200Package.WARNING_LOCATION_OBJECT__WARNING_COLUMN, oldWarningColumn, newWarningColumn);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setWarningColumn(WarningColumnType newWarningColumn) {
    if (newWarningColumn != warningColumn) {
      ...
      if (warningColumn != null)
        msgs = ((InternalEObject) warningColumn).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine200Package.WARNING_LOCATION_OBJECT__WARNING_COLUMN, null, msgs);
      if (newWarningColumn != null)
        msgs = ((InternalEObject) newWarningColumn).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine200Package.WARNING_LOCATION_OBJECT__WARNING_COLUMN, null, msgs);
      msgs = basicSetWarningColumn(newWarningColumn, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine200Package.WARNING_LOCATION_OBJECT__WARNING_COLUMN,
          newWarningColumn, newWarningColumn));
  }
  ...
  public NotificationChain basicSetWarningMeasure(WarningMeasureType newWarningMeasure, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine200Package.WARNING_LOCATION_OBJECT__WARNING_MEASURE, oldWarningMeasure, newWarningMeasure);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setWarningMeasure(WarningMeasureType newWarningMeasure) {
    if (newWarningMeasure != warningMeasure) {
      ...
      if (warningMeasure != null)
        msgs = ((InternalEObject) warningMeasure).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine200Package.WARNING_LOCATION_OBJECT__WARNING_MEASURE, null, msgs);
      if (newWarningMeasure != null)
        msgs = ((InternalEObject) newWarningMeasure).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine200Package.WARNING_LOCATION_OBJECT__WARNING_MEASURE, null, msgs);
      msgs = basicSetWarningMeasure(newWarningMeasure, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine200Package.WARNING_LOCATION_OBJECT__WARNING_MEASURE,
          newWarningMeasure, newWarningMeasure));
  }
