 ...
 * '<em><b>MDX Support</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum MDXSupport implements Enumerator {
  /**
   * The '<em><b>Core</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #CORE_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Core</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #CORE
   * @model name="Core"
   ...
   * @generated
   */
  private static final MDXSupport[] VALUES_ARRAY = new MDXSupport[] { CORE, };
  ...
  /**
   * Returns the '<em><b>MDX Support</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>MDX Support</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
