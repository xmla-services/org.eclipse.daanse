...
public class Engine600PackageImpl extends EPackageImpl implements Engine600Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine600Package#eINSTANCE} when
  ...
  public static Engine600Package init() {
    if (isInited)
      return (Engine600Package) EPackage.Registry.INSTANCE.getEPackage(Engine600Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine600Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine600PackageImpl theEngine600Package = registeredEngine600Package instanceof Engine600PackageImpl
        ? (Engine600PackageImpl) registeredEngine600Package
        : new Engine600PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_SupportedCompatibilityLevels(), theXMLTypePackage.getString(),
        "supportedCompatibilityLevels", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(getDocumentRoot_SupportedCompatibilityLevels(), source,
        new String[] { "kind", "element", "name", "SupportedCompatibilityLevels", "namespace", "##targetNamespace" });
  }
