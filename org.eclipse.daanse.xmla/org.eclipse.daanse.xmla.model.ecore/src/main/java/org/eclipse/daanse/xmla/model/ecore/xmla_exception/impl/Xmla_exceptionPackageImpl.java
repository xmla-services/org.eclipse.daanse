...
public class Xmla_exceptionPackageImpl extends EPackageImpl implements Xmla_exceptionPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link Xmla_exceptionPackage#eINSTANCE}
  ...
  public static Xmla_exceptionPackage init() {
    if (isInited)
      return (Xmla_exceptionPackage) EPackage.Registry.INSTANCE.getEPackage(Xmla_exceptionPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmla_exceptionPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Xmla_exceptionPackageImpl theXmla_exceptionPackage = registeredXmla_exceptionPackage instanceof Xmla_exceptionPackageImpl
        ? (Xmla_exceptionPackageImpl) registeredXmla_exceptionPackage
        : new Xmla_exceptionPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    Engine200Package theEngine200Package = (Engine200Package) EPackage.Registry.INSTANCE
        .getEPackage(Engine200Package.eNS_URI);
    ...
    initEAttribute(getEndType_Line(), theXMLTypePackage.getInt(), "line", null, 1, 1, EndType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEndType_Column(), theXMLTypePackage.getInt(), "column", null, 1, 1, EndType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(errorTypeEClass, ErrorType.class, "ErrorType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getErrorType_Location(), this.getMessageLocation(), null, "location", null, 0, 1, ErrorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getErrorType_Callstack(), theXMLTypePackage.getString(), "callstack", null, 0, 1, ErrorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getErrorType_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
        ErrorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getErrorType_ErrorCode(), theXMLTypePackage.getLong(), "errorCode", null, 0, 1, ErrorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getErrorType_HelpFile(), theXMLTypePackage.getString(), "helpFile", null, 0, 1, ErrorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getErrorType_Source(), theXMLTypePackage.getString(), "source", null, 0, 1, ErrorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(exceptionEClass, org.eclipse.daanse.xmla.model.ecore.xmla_exception.Exception.class, "Exception",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(messageLocationEClass, MessageLocation.class, "MessageLocation", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMessageLocation_Start(), this.getStartType(), null, "start", null, 1, 1, MessageLocation.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getMessageLocation_End(), this.getEndType(), null, "end", null, 1, 1, MessageLocation.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMessageLocation_LineOffset(), theXMLTypePackage.getInt(), "lineOffset", null, 0, 1,
        MessageLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMessageLocation_TextLength(), theXMLTypePackage.getInt(), "textLength", null, 0, 1,
        MessageLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getMessageLocation_SourceObject(), theEngine200Package.getWarningLocationObject(), null,
        "sourceObject", null, 0, 1, MessageLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMessageLocation_DependsOnObject(), theEngine200Package.getWarningLocationObject(), null,
        "dependsOnObject", null, 0, 1, MessageLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMessageLocation_RowNumber(), theXMLTypePackage.getInt(), "rowNumber", null, 0, 1,
        MessageLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(messagesEClass, Messages.class, "Messages", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMessages_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, Messages.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMessages_Warning(), this.getWarningType(), null, "warning", null, 0, -1, Messages.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getMessages_Error(), this.getErrorType(), null, "error", null, 0, -1, Messages.class, IS_TRANSIENT,
    ...
    initEAttribute(getStartType_Line(), theXMLTypePackage.getInt(), "line", null, 1, 1, StartType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStartType_Column(), theXMLTypePackage.getInt(), "column", null, 1, 1, StartType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(warningTypeEClass, WarningType.class, "WarningType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getWarningType_Location(), this.getMessageLocation(), null, "location", null, 0, 1,
        WarningType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningType_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
        WarningType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getWarningType_HelpFile(), theXMLTypePackage.getString(), "helpFile", null, 0, 1, WarningType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningType_Source(), theXMLTypePackage.getString(), "source", null, 0, 1, WarningType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningType_WarningCode(), theXMLTypePackage.getInt(), "warningCode", null, 0, 1,
        WarningType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(endTypeEClass, source, new String[] { "name", "End_._type", "kind", "elementOnly" });
    addAnnotation(getEndType_Line(), source, new String[] { "kind", "element", "name", "Line" });
    addAnnotation(getEndType_Column(), source, new String[] { "kind", "element", "name", "Column" });
    addAnnotation(errorTypeEClass, source, new String[] { "name", "ErrorType", "kind", "elementOnly" });
    addAnnotation(getErrorType_Location(), source, new String[] { "kind", "element", "name", "Location" });
    addAnnotation(getErrorType_Callstack(), source, new String[] { "kind", "element", "name", "Callstack" });
    addAnnotation(getErrorType_Description(), source, new String[] { "kind", "attribute", "name", "Description" });
    addAnnotation(getErrorType_ErrorCode(), source, new String[] { "kind", "attribute", "name", "ErrorCode" });
    addAnnotation(getErrorType_HelpFile(), source, new String[] { "kind", "attribute", "name", "HelpFile" });
    addAnnotation(getErrorType_Source(), source, new String[] { "kind", "attribute", "name", "Source" });
    addAnnotation(exceptionEClass, source, new String[] { "name", "Exception", "kind", "empty" });
    addAnnotation(messageLocationEClass, source, new String[] { "name", "MessageLocation", "kind", "elementOnly" });
    addAnnotation(getMessageLocation_Start(), source, new String[] { "kind", "element", "name", "Start" });
    addAnnotation(getMessageLocation_End(), source, new String[] { "kind", "element", "name", "End" });
    addAnnotation(getMessageLocation_LineOffset(), source, new String[] { "kind", "element", "name", "LineOffset" });
    addAnnotation(getMessageLocation_TextLength(), source, new String[] { "kind", "element", "name", "TextLength" });
    addAnnotation(getMessageLocation_SourceObject(), source,
        new String[] { "kind", "element", "name", "SourceObject" });
    addAnnotation(getMessageLocation_DependsOnObject(), source,
        new String[] { "kind", "element", "name", "DependsOnObject" });
    addAnnotation(getMessageLocation_RowNumber(), source, new String[] { "kind", "element", "name", "RowNumber" });
    addAnnotation(messagesEClass, source, new String[] { "name", "Messages", "kind", "elementOnly" });
    addAnnotation(getMessages_Group(), source, new String[] { "kind", "group", "name", "group:0" });
    addAnnotation(getMessages_Warning(), source,
        new String[] { "kind", "element", "name", "Warning", "group", "#group:0" });
    addAnnotation(getMessages_Error(), source,
        new String[] { "kind", "element", "name", "Error", "group", "#group:0" });
    addAnnotation(startTypeEClass, source, new String[] { "name", "Start_._type", "kind", "elementOnly" });
    addAnnotation(getStartType_Line(), source, new String[] { "kind", "element", "name", "Line" });
    addAnnotation(getStartType_Column(), source, new String[] { "kind", "element", "name", "Column" });
    addAnnotation(warningTypeEClass, source, new String[] { "name", "WarningType", "kind", "elementOnly" });
    addAnnotation(getWarningType_Location(), source, new String[] { "kind", "element", "name", "Location" });
    addAnnotation(getWarningType_Description(), source, new String[] { "kind", "attribute", "name", "Description" });
    addAnnotation(getWarningType_HelpFile(), source, new String[] { "kind", "attribute", "name", "HelpFile" });
    addAnnotation(getWarningType_Source(), source, new String[] { "kind", "attribute", "name", "Source" });
    addAnnotation(getWarningType_WarningCode(), source, new String[] { "kind", "attribute", "name", "WarningCode" });
  }
