 ...
 * Measure Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.WarningMeasureTypeImpl#getCube
 * <em>Cube</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.WarningMeasureTypeImpl#getMeasureGroup
 * <em>Measure Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.WarningMeasureTypeImpl#getMeasureName
 * <em>Measure Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WarningMeasureTypeImpl extends MinimalEObjectImpl.Container implements WarningMeasureType {
  ...
  /**
   * The default value of the '{@link #getMeasureGroup() <em>Measure Group</em>}'
  ...
  /**
   * The cached value of the '{@link #getMeasureGroup() <em>Measure Group</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMeasureGroup()
   * @generated
  ...
  /**
   * The default value of the '{@link #getMeasureName() <em>Measure Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMeasureName()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getMeasureName() <em>Measure Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMeasureName()
   * @generated
  ...
  public void setCube(String newCube) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, Engine200Package.WARNING_MEASURE_TYPE__CUBE, oldCube, cube));
  }
  ...
  public void setMeasureGroup(String newMeasureGroup) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine200Package.WARNING_MEASURE_TYPE__MEASURE_GROUP,
          oldMeasureGroup, measureGroup));
  }
  ...
  public void setMeasureName(String newMeasureName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine200Package.WARNING_MEASURE_TYPE__MEASURE_NAME,
          oldMeasureName, measureName));
  }
