 ...
 * @generated
 */
@Component(name = Engine100Package.eNAME
    + "XMLProcessor", service = Engine100XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine100XMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the Engine100ResourceFactoryImpl
