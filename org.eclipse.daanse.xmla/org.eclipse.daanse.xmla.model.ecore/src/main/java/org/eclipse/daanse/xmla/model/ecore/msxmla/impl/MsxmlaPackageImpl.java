...
public class MsxmlaPackageImpl extends EPackageImpl implements MsxmlaPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link MsxmlaPackage#eINSTANCE} when that
  ...
  public static MsxmlaPackage init() {
    if (isInited)
      return (MsxmlaPackage) EPackage.Registry.INSTANCE.getEPackage(MsxmlaPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMsxmlaPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MsxmlaPackageImpl theMsxmlaPackage = registeredMsxmlaPackage instanceof MsxmlaPackageImpl
        ? (MsxmlaPackageImpl) registeredMsxmlaPackage
        : new MsxmlaPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEClass(memberRefTypeEClass, MemberRefType.class, "MemberRefType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMemberRefType_MemberOrdinal(), theXMLTypePackage.getInt(), "memberOrdinal", null, 1, 1,
        MemberRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getMemberRefType_MemberDispInfo(), theXMLTypePackage.getInt(), "memberDispInfo", null, 0, 1,
        MemberRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(membersLookupTypeEClass, MembersLookupType.class, "MembersLookupType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMembersLookupType_Members(), theXmla_mddatasetPackage.getTupleType(), null, "members", null, 1,
        -1, MembersLookupType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(normTupleSetTypeEClass, NormTupleSetType.class, "NormTupleSetType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNormTupleSetType_NormTuples(), this.getNormTuplesType(), null, "normTuples", null, 1, 1,
        NormTupleSetType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNormTupleSetType_MembersLookup(), this.getMembersLookupType(), null, "membersLookup", null, 1, 1,
        NormTupleSetType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(normTuplesTypeEClass, NormTuplesType.class, "NormTuplesType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNormTuplesType_NormTuple(), this.getNormTupleType(), null, "normTuple", null, 0, -1,
        NormTuplesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(normTupleTypeEClass, NormTupleType.class, "NormTupleType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNormTupleType_MemberRef(), this.getMemberRefType(), null, "memberRef", null, 0, -1,
        NormTupleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_NormTupleSet(), this.getNormTupleSetType(), null, "normTupleSet", null, 0, -2, null,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(memberRefTypeEClass, source, new String[] { "name", "MemberRef_._type", "kind", "elementOnly" });
    addAnnotation(getMemberRefType_MemberOrdinal(), source,
        new String[] { "kind", "element", "name", "MemberOrdinal" });
    addAnnotation(getMemberRefType_MemberDispInfo(), source,
        new String[] { "kind", "element", "name", "MemberDispInfo" });
    addAnnotation(membersLookupTypeEClass, source,
        new String[] { "name", "MembersLookup_._type", "kind", "elementOnly" });
    addAnnotation(getMembersLookupType_Members(), source, new String[] { "kind", "element", "name", "Members" });
    addAnnotation(normTupleSetTypeEClass, source,
        new String[] { "name", "NormTupleSet_._type", "kind", "elementOnly" });
    addAnnotation(getNormTupleSetType_NormTuples(), source, new String[] { "kind", "element", "name", "NormTuples" });
    addAnnotation(getNormTupleSetType_MembersLookup(), source,
        new String[] { "kind", "element", "name", "MembersLookup" });
    addAnnotation(normTuplesTypeEClass, source, new String[] { "name", "NormTuplesType", "kind", "elementOnly" });
    addAnnotation(getNormTuplesType_NormTuple(), source, new String[] { "kind", "element", "name", "NormTuple" });
    addAnnotation(normTupleTypeEClass, source, new String[] { "name", "NormTuple_._type", "kind", "elementOnly" });
    addAnnotation(getNormTupleType_MemberRef(), source, new String[] { "kind", "element", "name", "MemberRef" });
    ...
    addAnnotation(getDocumentRoot_NormTupleSet(), source,
        new String[] { "kind", "element", "name", "NormTupleSet", "namespace", "##targetNamespace" });
  }
