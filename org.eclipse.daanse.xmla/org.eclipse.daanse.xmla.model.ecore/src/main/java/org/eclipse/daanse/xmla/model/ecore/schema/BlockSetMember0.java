 ...
 * '<em><b>Block Set Member0</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum BlockSetMember0 implements Enumerator {
   ...
   * @generated
   */
  private static final BlockSetMember0[] VALUES_ARRAY = new BlockSetMember0[] { ALL, };

  /**
   * A public read-only list of all the '<em><b>Block Set Member0</b></em>'
  ...
  /**
   * Returns the '<em><b>Block Set Member0</b></em>' literal with the specified
