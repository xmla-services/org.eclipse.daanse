 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.MemberRefTypeImpl#getMemberOrdinal
 * <em>Member Ordinal</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.MemberRefTypeImpl#getMemberDispInfo
 * <em>Member Disp Info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberRefTypeImpl extends MinimalEObjectImpl.Container implements MemberRefType {
  /**
   * The default value of the '{@link #getMemberOrdinal() <em>Member
   * Ordinal</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getMemberOrdinal() <em>Member Ordinal</em>}'
  ...
  /**
   * The default value of the '{@link #getMemberDispInfo() <em>Member Disp
  ...
  /**
   * The cached value of the '{@link #getMemberDispInfo() <em>Member Disp
   * Info</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMemberDispInfo()
   * @generated
  ...
  public void setMemberOrdinal(int newMemberOrdinal) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MsxmlaPackage.MEMBER_REF_TYPE__MEMBER_ORDINAL,
          oldMemberOrdinal, memberOrdinal, !oldMemberOrdinalESet));
  }
  ...
  public void unsetMemberOrdinal() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, MsxmlaPackage.MEMBER_REF_TYPE__MEMBER_ORDINAL,
          oldMemberOrdinal, MEMBER_ORDINAL_EDEFAULT, oldMemberOrdinalESet));
  }
  ...
  public void setMemberDispInfo(int newMemberDispInfo) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MsxmlaPackage.MEMBER_REF_TYPE__MEMBER_DISP_INFO,
          oldMemberDispInfo, memberDispInfo, !oldMemberDispInfoESet));
  }
  ...
  public void unsetMemberDispInfo() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, MsxmlaPackage.MEMBER_REF_TYPE__MEMBER_DISP_INFO,
          oldMemberDispInfo, MEMBER_DISP_INFO_EDEFAULT, oldMemberDispInfoESet));
  }
  ...
  public String toString() {
    ...
    if (memberOrdinalESet)
      result.append(memberOrdinal);
    else
      result.append("<unset>");
    result.append(", memberDispInfo: ");
    if (memberDispInfoESet)
      result.append(memberDispInfo);
    else
      result.append("<unset>");
    result.append(')');
