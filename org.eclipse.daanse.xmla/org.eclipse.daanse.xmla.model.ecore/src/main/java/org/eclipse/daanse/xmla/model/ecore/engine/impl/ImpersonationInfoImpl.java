 ...
 * '<em><b>Impersonation Info</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.ImpersonationInfoImpl#getImpersonationMode
 * <em>Impersonation Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.ImpersonationInfoImpl#getAccount
 * <em>Account</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.ImpersonationInfoImpl#getPassword
 * <em>Password</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.ImpersonationInfoImpl#getImpersonationInfoSecurity
 * <em>Impersonation Info Security</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImpersonationInfoImpl extends MinimalEObjectImpl.Container implements ImpersonationInfo {
  /**
   * The default value of the '{@link #getImpersonationMode() <em>Impersonation
  ...
  /**
   * The cached value of the '{@link #getImpersonationMode() <em>Impersonation
   * Mode</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getImpersonationMode()
   * @generated
  ...
  /**
   * The default value of the '{@link #getImpersonationInfoSecurity()
   * <em>Impersonation Info Security</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getImpersonationInfoSecurity()
   * <em>Impersonation Info Security</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getImpersonationInfoSecurity()
  ...
  public void setImpersonationMode(ImpersonationModeType newImpersonationMode) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EnginePackage.IMPERSONATION_INFO__IMPERSONATION_MODE,
          oldImpersonationMode, impersonationMode, !oldImpersonationModeESet));
  }
  ...
  public void unsetImpersonationMode() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, EnginePackage.IMPERSONATION_INFO__IMPERSONATION_MODE,
          oldImpersonationMode, IMPERSONATION_MODE_EDEFAULT, oldImpersonationModeESet));
  }
  ...
  public void setAccount(String newAccount) {
    ...
    account = newAccount;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EnginePackage.IMPERSONATION_INFO__ACCOUNT, oldAccount,
          account));
  }
  ...
  public void setPassword(String newPassword) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EnginePackage.IMPERSONATION_INFO__PASSWORD, oldPassword,
          password));
  }
  ...
  public void setImpersonationInfoSecurity(ImpersonationInfoSecurityType newImpersonationInfoSecurity) {
    ...
    impersonationInfoSecurity = newImpersonationInfoSecurity == null ? IMPERSONATION_INFO_SECURITY_EDEFAULT
        : newImpersonationInfoSecurity;
    boolean oldImpersonationInfoSecurityESet = impersonationInfoSecurityESet;
    impersonationInfoSecurityESet = true;
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, EnginePackage.IMPERSONATION_INFO__IMPERSONATION_INFO_SECURITY,
              oldImpersonationInfoSecurity, impersonationInfoSecurity, !oldImpersonationInfoSecurityESet));
  }
  ...
  public void unsetImpersonationInfoSecurity() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.UNSET, EnginePackage.IMPERSONATION_INFO__IMPERSONATION_INFO_SECURITY,
              oldImpersonationInfoSecurity, IMPERSONATION_INFO_SECURITY_EDEFAULT, oldImpersonationInfoSecurityESet));
  }
  ...
  public String toString() {
    ...
    if (impersonationInfoSecurityESet)
      result.append(impersonationInfoSecurity);
    else
      result.append("<unset>");
    result.append(')');
