 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_multipleresults.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_multipleresults.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_multipleresults.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_multipleresults.impl.DocumentRootImpl#getResults
 * <em>Results</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Xmla_multipleresultsPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Xmla_multipleresultsPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Xmla_multipleresultsPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Xmla_multipleresultsPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetResults(ResultsType newResults, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(Xmla_multipleresultsPackage.Literals.DOCUMENT_ROOT__RESULTS,
        newResults, msgs);
  }
