 ...
 * '<em><b>Discover Response</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.DiscoverResponseImpl#getReturn
 * <em>Return</em>}</li>
 * </ul>
 *
 * @generated
  ...
  public NotificationChain basicSetReturn(Return newReturn, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          XmlaPackage.DISCOVER_RESPONSE__RETURN, oldReturn, newReturn);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newReturn != return_) {
      ...
      if (return_ != null)
        msgs = ((InternalEObject) return_).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - XmlaPackage.DISCOVER_RESPONSE__RETURN, null, msgs);
      if (newReturn != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, XmlaPackage.DISCOVER_RESPONSE__RETURN, newReturn, newReturn));
  }
