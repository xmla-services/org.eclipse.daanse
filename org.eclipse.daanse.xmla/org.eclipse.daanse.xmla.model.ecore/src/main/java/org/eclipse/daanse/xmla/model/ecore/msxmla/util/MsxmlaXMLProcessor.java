 ...
 * @generated
 */
@Component(name = MsxmlaPackage.eNAME
    + "XMLProcessor", service = MsxmlaXMLProcessor.class, scope = ServiceScope.SINGLETON)
public class MsxmlaXMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the MsxmlaResourceFactoryImpl
