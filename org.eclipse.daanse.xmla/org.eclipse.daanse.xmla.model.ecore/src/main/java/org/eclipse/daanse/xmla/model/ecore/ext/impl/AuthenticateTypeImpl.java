 ...
 * '<em><b>Authenticate Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.ext.impl.AuthenticateTypeImpl#getSspiHandshake
 * <em>Sspi Handshake</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthenticateTypeImpl extends MinimalEObjectImpl.Container implements AuthenticateType {
  /**
   * The default value of the '{@link #getSspiHandshake() <em>Sspi
   * Handshake</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getSspiHandshake() <em>Sspi Handshake</em>}'
  ...
  public void setSspiHandshake(byte[] newSspiHandshake) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtPackage.AUTHENTICATE_TYPE__SSPI_HANDSHAKE,
          oldSspiHandshake, sspiHandshake));
  }
