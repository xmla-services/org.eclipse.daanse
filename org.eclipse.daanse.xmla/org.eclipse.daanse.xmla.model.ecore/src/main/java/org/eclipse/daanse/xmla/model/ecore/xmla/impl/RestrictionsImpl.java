 ...
 * '<em><b>Restrictions</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.RestrictionsImpl#getRestrictionList
 * <em>Restriction List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RestrictionsImpl extends MinimalEObjectImpl.Container implements Restrictions {
  /**
   * The cached value of the '{@link #getRestrictionList() <em>Restriction
  ...
  public NotificationChain basicSetRestrictionList(RestrictionList newRestrictionList, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          XmlaPackage.RESTRICTIONS__RESTRICTION_LIST, oldRestrictionList, newRestrictionList, !oldRestrictionListESet);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setRestrictionList(RestrictionList newRestrictionList) {
    if (newRestrictionList != restrictionList) {
      ...
      if (restrictionList != null)
        msgs = ((InternalEObject) restrictionList).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - XmlaPackage.RESTRICTIONS__RESTRICTION_LIST, null, msgs);
      if (newRestrictionList != null)
        msgs = ((InternalEObject) newRestrictionList).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - XmlaPackage.RESTRICTIONS__RESTRICTION_LIST, null, msgs);
      ...
      restrictionListESet = true;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.RESTRICTIONS__RESTRICTION_LIST,
            newRestrictionList, newRestrictionList, !oldRestrictionListESet));
    }
  }
  ...
  public NotificationChain basicUnsetRestrictionList(NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
          XmlaPackage.RESTRICTIONS__RESTRICTION_LIST, oldRestrictionList, null, oldRestrictionListESet);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void unsetRestrictionList() {
    if (restrictionList != null) {
      ...
      restrictionListESet = false;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.RESTRICTIONS__RESTRICTION_LIST, null, null,
            oldRestrictionListESet));
    }
  }
