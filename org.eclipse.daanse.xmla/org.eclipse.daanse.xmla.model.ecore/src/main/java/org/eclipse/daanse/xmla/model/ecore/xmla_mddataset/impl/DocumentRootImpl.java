 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.DocumentRootImpl#getRoot
 * <em>Root</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Xmla_mddatasetPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Xmla_mddatasetPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Xmla_mddatasetPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Xmla_mddatasetPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetRoot(Mddataset newRoot, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(Xmla_mddatasetPackage.Literals.DOCUMENT_ROOT__ROOT, newRoot,
        msgs);
  }
