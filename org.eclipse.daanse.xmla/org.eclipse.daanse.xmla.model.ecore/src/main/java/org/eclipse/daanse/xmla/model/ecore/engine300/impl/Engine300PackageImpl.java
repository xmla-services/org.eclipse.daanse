...
public class Engine300PackageImpl extends EPackageImpl implements Engine300Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine300Package#eINSTANCE} when
  ...
  public static Engine300Package init() {
    if (isInited)
      return (Engine300Package) EPackage.Registry.INSTANCE.getEPackage(Engine300Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine300Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine300PackageImpl theEngine300Package = registeredEngine300Package instanceof Engine300PackageImpl
        ? (Engine300PackageImpl) registeredEngine300Package
        : new Engine300PackageImpl();
  ...
  public void createPackageContents() {
    ...
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__FOLDER_POSITION);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__CONTEXTUAL_NAME_RULE);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__ALIGNMENT);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__IS_FOLDER_DEFAULT);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__IS_RIGHT_TO_LEFT);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__SORT_DIRECTION);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__UNITS);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__WIDTH);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__IS_DEFAULT_MEASURE);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__DEFAULT_DETAILS_POSITION);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__SORT_PROPERTIES_POSITION);
    createEAttribute(calculationPropertiesVisualizationPropertiesEClass,
        CALCULATION_PROPERTIES_VISUALIZATION_PROPERTIES__IS_SIMPLE_MEASURE);

    dimensionAttributeVisualizationPropertiesEClass = createEClass(DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__FOLDER_POSITION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__CONTEXTUAL_NAME_RULE);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__ALIGNMENT);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__IS_FOLDER_DEFAULT);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__IS_RIGHT_TO_LEFT);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__SORT_DIRECTION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__UNITS);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__WIDTH);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__DEFAULT_DETAILS_POSITION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__COMMON_IDENTIFIER_POSITION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__SORT_PROPERTIES_POSITION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__DISPLAY_KEY_POSITION);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__IS_DEFAULT_IMAGE);
    createEAttribute(dimensionAttributeVisualizationPropertiesEClass,
        DIMENSION_ATTRIBUTE_VISUALIZATION_PROPERTIES__DEFAULT_AGGREGATE_FUNCTION);
    ...
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__FOLDER_POSITION);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__CONTEXTUAL_NAME_RULE);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__DEFAULT_DETAILS_POSITION);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__DISPLAY_KEY_POSITION);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__COMMON_IDENTIFIER_POSITION);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__IS_DEFAULT_MEASURE);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__IS_DEFAULT_IMAGE);
    createEAttribute(relationshipEndVisualizationPropertiesEClass,
        RELATIONSHIP_END_VISUALIZATION_PROPERTIES__SORT_PROPERTIES_POSITION);
    ...
    currentStringStoresCompatibilityLevelTypeObjectEDataType = createEDataType(
        CURRENT_STRING_STORES_COMPATIBILITY_LEVEL_TYPE_OBJECT);
  ...
  public void initializePackageContents() {
    ...
    initEClass(calculationPropertiesVisualizationPropertiesEClass, CalculationPropertiesVisualizationProperties.class,
        "CalculationPropertiesVisualizationProperties", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCalculationPropertiesVisualizationProperties_FolderPosition(), theXMLTypePackage.getInteger(),
        "folderPosition", "-1", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_ContextualNameRule(),
        this.getContextualNameRuleType3(), "contextualNameRule", "None", 0, 1,
        CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_Alignment(), this.getAlignmentType1(), "alignment",
        "Default", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_IsFolderDefault(), theXMLTypePackage.getBoolean(),
        "isFolderDefault", "false", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_IsRightToLeft(), theXMLTypePackage.getBoolean(),
        "isRightToLeft", "false", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_SortDirection(), this.getSortDirectionType1(),
        "sortDirection", "Default", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_Units(), theXMLTypePackage.getString(), "units", "",
        0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_Width(), theXMLTypePackage.getInteger(), "width",
        "-1", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_IsDefaultMeasure(), theXMLTypePackage.getBoolean(),
        "isDefaultMeasure", "false", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_DefaultDetailsPosition(),
        theXMLTypePackage.getInteger(), "defaultDetailsPosition", "-1", 0, 1,
        CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_SortPropertiesPosition(),
        theXMLTypePackage.getInteger(), "sortPropertiesPosition", "-1", 0, 1,
        CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCalculationPropertiesVisualizationProperties_IsSimpleMeasure(), theXMLTypePackage.getBoolean(),
        "isSimpleMeasure", "false", 0, 1, CalculationPropertiesVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(dimensionAttributeVisualizationPropertiesEClass, DimensionAttributeVisualizationProperties.class,
        "DimensionAttributeVisualizationProperties", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDimensionAttributeVisualizationProperties_FolderPosition(), theXMLTypePackage.getInteger(),
        "folderPosition", "-1", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_ContextualNameRule(), this.getContextualNameRuleType1(),
        "contextualNameRule", "None", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_Alignment(), this.getAlignmentType(), "alignment",
        "Default", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_IsFolderDefault(), theXMLTypePackage.getBoolean(),
        "isFolderDefault", "false", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_IsRightToLeft(), theXMLTypePackage.getBoolean(),
        "isRightToLeft", "false", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_SortDirection(), this.getSortDirectionType(),
        "sortDirection", "Default", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_Units(), theXMLTypePackage.getString(), "units", "", 0,
        1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_Width(), theXMLTypePackage.getInteger(), "width", "-1",
        0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_DefaultDetailsPosition(),
        theXMLTypePackage.getInteger(), "defaultDetailsPosition", "-1", 0, 1,
        DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_CommonIdentifierPosition(),
        theXMLTypePackage.getInteger(), "commonIdentifierPosition", "-1", 0, 1,
        DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_SortPropertiesPosition(),
        theXMLTypePackage.getInteger(), "sortPropertiesPosition", "-1", 0, 1,
        DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_DisplayKeyPosition(), theXMLTypePackage.getInteger(),
        "displayKeyPosition", "-1", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_IsDefaultImage(), theXMLTypePackage.getBoolean(),
        "isDefaultImage", "false", 0, 1, DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDimensionAttributeVisualizationProperties_DefaultAggregateFunction(),
        this.getDefaultAggregateFunctionType(), "defaultAggregateFunction", "Default", 0, 1,
        DimensionAttributeVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getDocumentRoot_CurrentStringStoresCompatibilityLevel(),
        this.getCurrentStringStoresCompatibilityLevelType(), "currentStringStoresCompatibilityLevel", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_DataEmbeddingStyle(), this.getDataEmbeddingStyleType(), "dataEmbeddingStyle", null,
        0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getDocumentRoot_ProcessingState(), this.getProcessingStateType(), "processingState", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_QueryHints(), theXMLTypePackage.getString(), "queryHints", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_QueryImpersonationInfo(), theEnginePackage.getImpersonationInfo(), null,
        "queryImpersonationInfo", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ServerMode(), this.getServerModeType(), "serverMode", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_StringStoresCompatibilityLevel(), this.getStringStoresCompatibilityLevelType(),
        "stringStoresCompatibilityLevel", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_StructureType(), this.getStructureTypeType(), "structureType", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(hierarchyVisualizationPropertiesEClass, HierarchyVisualizationProperties.class,
        "HierarchyVisualizationProperties", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getHierarchyVisualizationProperties_ContextualNameRule(), this.getContextualNameRuleType2(),
        "contextualNameRule", "None", 0, 1, HierarchyVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHierarchyVisualizationProperties_FolderPosition(), theXMLTypePackage.getInteger(),
        "folderPosition", "-1", 0, 1, HierarchyVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(relationshipEndVisualizationPropertiesEClass, RelationshipEndVisualizationProperties.class,
        "RelationshipEndVisualizationProperties", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRelationshipEndVisualizationProperties_FolderPosition(), theXMLTypePackage.getInteger(),
        "folderPosition", "-1", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_ContextualNameRule(), this.getContextualNameRuleType(),
        "contextualNameRule", "None", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_DefaultDetailsPosition(), theXMLTypePackage.getInteger(),
        "defaultDetailsPosition", "-1", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_DisplayKeyPosition(), theXMLTypePackage.getInteger(),
        "displayKeyPosition", "-1", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_CommonIdentifierPosition(), theXMLTypePackage.getInteger(),
        "commonIdentifierPosition", "-1", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_IsDefaultMeasure(), theXMLTypePackage.getBoolean(),
        "isDefaultMeasure", "false", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_IsDefaultImage(), theXMLTypePackage.getBoolean(),
        "isDefaultImage", "false", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndVisualizationProperties_SortPropertiesPosition(), theXMLTypePackage.getInteger(),
        "sortPropertiesPosition", "-1", 0, 1, RelationshipEndVisualizationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEEnum(attributeHierarchyProcessingStateEEnum, AttributeHierarchyProcessingState.class,
    ...
    initEEnum(currentStringStoresCompatibilityLevelTypeEEnum, CurrentStringStoresCompatibilityLevelType.class,
    ...
    initEEnum(stringStoresCompatibilityLevelTypeEEnum, StringStoresCompatibilityLevelType.class,
    ...
    initEDataType(alignmentTypeObjectEDataType, AlignmentType.class, "AlignmentTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(alignmentTypeObject1EDataType, AlignmentType1.class, "AlignmentTypeObject1", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(attributeHierarchyProcessingStateObjectEDataType, AttributeHierarchyProcessingState.class,
        "AttributeHierarchyProcessingStateObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(contextualNameRuleTypeObjectEDataType, ContextualNameRuleType.class, "ContextualNameRuleTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(contextualNameRuleTypeObject1EDataType, ContextualNameRuleType1.class,
        "ContextualNameRuleTypeObject1", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(contextualNameRuleTypeObject2EDataType, ContextualNameRuleType2.class,
        "ContextualNameRuleTypeObject2", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(contextualNameRuleTypeObject3EDataType, ContextualNameRuleType3.class,
        "ContextualNameRuleTypeObject3", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(currentStringStoresCompatibilityLevelTypeObjectEDataType,
        CurrentStringStoresCompatibilityLevelType.class, "CurrentStringStoresCompatibilityLevelTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(dataEmbeddingStyleTypeObjectEDataType, DataEmbeddingStyleType.class, "DataEmbeddingStyleTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(defaultAggregateFunctionTypeObjectEDataType, DefaultAggregateFunctionType.class,
        "DefaultAggregateFunctionTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(processingStateTypeObjectEDataType, ProcessingStateType.class, "ProcessingStateTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(serverModeTypeObjectEDataType, ServerModeType.class, "ServerModeTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(sortDirectionTypeObjectEDataType, SortDirectionType.class, "SortDirectionTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(sortDirectionTypeObject1EDataType, SortDirectionType1.class, "SortDirectionTypeObject1",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(stringStoresCompatibilityLevelTypeObjectEDataType, StringStoresCompatibilityLevelType.class,
        "StringStoresCompatibilityLevelTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(structureTypeTypeObjectEDataType, StructureTypeType.class, "StructureTypeTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(alignmentTypeEEnum, source, new String[] { "name", "Alignment_._type" });
    addAnnotation(alignmentType1EEnum, source, new String[] { "name", "Alignment_._1_._type" });
    addAnnotation(alignmentTypeObjectEDataType, source,
        new String[] { "name", "Alignment_._type:Object", "baseType", "Alignment_._type" });
    addAnnotation(alignmentTypeObject1EDataType, source,
        new String[] { "name", "Alignment_._1_._type:Object", "baseType", "Alignment_._1_._type" });
    addAnnotation(attributeHierarchyProcessingStateEEnum, source,
        new String[] { "name", "AttributeHierarchyProcessingState" });
    addAnnotation(attributeHierarchyProcessingStateObjectEDataType, source, new String[] { "name",
        "AttributeHierarchyProcessingState:Object", "baseType", "AttributeHierarchyProcessingState" });
    addAnnotation(calculationPropertiesVisualizationPropertiesEClass, source,
        new String[] { "name", "CalculationPropertiesVisualizationProperties", "kind", "elementOnly" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_FolderPosition(), source,
        new String[] { "kind", "element", "name", "FolderPosition" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_ContextualNameRule(), source,
        new String[] { "kind", "element", "name", "ContextualNameRule" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_Alignment(), source,
        new String[] { "kind", "element", "name", "Alignment" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_IsFolderDefault(), source,
        new String[] { "kind", "element", "name", "IsFolderDefault" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_IsRightToLeft(), source,
        new String[] { "kind", "element", "name", "IsRightToLeft" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_SortDirection(), source,
        new String[] { "kind", "element", "name", "SortDirection" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_Units(), source,
        new String[] { "kind", "element", "name", "Units" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_Width(), source,
        new String[] { "kind", "element", "name", "Width" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_IsDefaultMeasure(), source,
        new String[] { "kind", "element", "name", "IsDefaultMeasure" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_DefaultDetailsPosition(), source,
        new String[] { "kind", "element", "name", "DefaultDetailsPosition" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_SortPropertiesPosition(), source,
        new String[] { "kind", "element", "name", "SortPropertiesPosition" });
    addAnnotation(getCalculationPropertiesVisualizationProperties_IsSimpleMeasure(), source,
        new String[] { "kind", "element", "name", "IsSimpleMeasure" });
    addAnnotation(contextualNameRuleTypeEEnum, source, new String[] { "name", "ContextualNameRule_._type" });
    addAnnotation(contextualNameRuleType1EEnum, source, new String[] { "name", "ContextualNameRule_._1_._type" });
    addAnnotation(contextualNameRuleType2EEnum, source, new String[] { "name", "ContextualNameRule_._2_._type" });
    addAnnotation(contextualNameRuleType3EEnum, source, new String[] { "name", "ContextualNameRule_._3_._type" });
    addAnnotation(contextualNameRuleTypeObjectEDataType, source,
        new String[] { "name", "ContextualNameRule_._type:Object", "baseType", "ContextualNameRule_._type" });
    addAnnotation(contextualNameRuleTypeObject1EDataType, source,
        new String[] { "name", "ContextualNameRule_._1_._type:Object", "baseType", "ContextualNameRule_._1_._type" });
    addAnnotation(contextualNameRuleTypeObject2EDataType, source,
        new String[] { "name", "ContextualNameRule_._2_._type:Object", "baseType", "ContextualNameRule_._2_._type" });
    addAnnotation(contextualNameRuleTypeObject3EDataType, source,
        new String[] { "name", "ContextualNameRule_._3_._type:Object", "baseType", "ContextualNameRule_._3_._type" });
    addAnnotation(currentStringStoresCompatibilityLevelTypeEEnum, source,
        new String[] { "name", "CurrentStringStoresCompatibilityLevel_._type" });
    addAnnotation(currentStringStoresCompatibilityLevelTypeObjectEDataType, source,
        new String[] { "name", "CurrentStringStoresCompatibilityLevel_._type:Object", "baseType",
            "CurrentStringStoresCompatibilityLevel_._type" });
    addAnnotation(dataEmbeddingStyleTypeEEnum, source, new String[] { "name", "DataEmbeddingStyle_._type" });
    addAnnotation(dataEmbeddingStyleTypeObjectEDataType, source,
        new String[] { "name", "DataEmbeddingStyle_._type:Object", "baseType", "DataEmbeddingStyle_._type" });
    addAnnotation(defaultAggregateFunctionTypeEEnum, source,
        new String[] { "name", "DefaultAggregateFunction_._type" });
    addAnnotation(defaultAggregateFunctionTypeObjectEDataType, source, new String[] { "name",
        "DefaultAggregateFunction_._type:Object", "baseType", "DefaultAggregateFunction_._type" });
    addAnnotation(dimensionAttributeVisualizationPropertiesEClass, source,
        new String[] { "name", "DimensionAttributeVisualizationProperties", "kind", "elementOnly" });
    addAnnotation(getDimensionAttributeVisualizationProperties_FolderPosition(), source,
        new String[] { "kind", "element", "name", "FolderPosition" });
    addAnnotation(getDimensionAttributeVisualizationProperties_ContextualNameRule(), source,
        new String[] { "kind", "element", "name", "ContextualNameRule" });
    addAnnotation(getDimensionAttributeVisualizationProperties_Alignment(), source,
        new String[] { "kind", "element", "name", "Alignment" });
    addAnnotation(getDimensionAttributeVisualizationProperties_IsFolderDefault(), source,
        new String[] { "kind", "element", "name", "IsFolderDefault" });
    addAnnotation(getDimensionAttributeVisualizationProperties_IsRightToLeft(), source,
        new String[] { "kind", "element", "name", "IsRightToLeft" });
    addAnnotation(getDimensionAttributeVisualizationProperties_SortDirection(), source,
        new String[] { "kind", "element", "name", "SortDirection" });
    addAnnotation(getDimensionAttributeVisualizationProperties_Units(), source,
        new String[] { "kind", "element", "name", "Units" });
    addAnnotation(getDimensionAttributeVisualizationProperties_Width(), source,
        new String[] { "kind", "element", "name", "Width" });
    addAnnotation(getDimensionAttributeVisualizationProperties_DefaultDetailsPosition(), source,
        new String[] { "kind", "element", "name", "DefaultDetailsPosition" });
    addAnnotation(getDimensionAttributeVisualizationProperties_CommonIdentifierPosition(), source,
        new String[] { "kind", "element", "name", "CommonIdentifierPosition" });
    addAnnotation(getDimensionAttributeVisualizationProperties_SortPropertiesPosition(), source,
        new String[] { "kind", "element", "name", "SortPropertiesPosition" });
    addAnnotation(getDimensionAttributeVisualizationProperties_DisplayKeyPosition(), source,
        new String[] { "kind", "element", "name", "DisplayKeyPosition" });
    addAnnotation(getDimensionAttributeVisualizationProperties_IsDefaultImage(), source,
        new String[] { "kind", "element", "name", "IsDefaultImage" });
    addAnnotation(getDimensionAttributeVisualizationProperties_DefaultAggregateFunction(), source,
        new String[] { "kind", "element", "name", "DefaultAggregateFunction" });
    ...
    addAnnotation(getDocumentRoot_CurrentStringStoresCompatibilityLevel(), source, new String[] { "kind", "element",
        "name", "CurrentStringStoresCompatibilityLevel", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_DataEmbeddingStyle(), source,
        new String[] { "kind", "element", "name", "DataEmbeddingStyle", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ProcessingState(), source,
        new String[] { "kind", "element", "name", "ProcessingState", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_QueryHints(), source,
        new String[] { "kind", "element", "name", "QueryHints", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_QueryImpersonationInfo(), source,
        new String[] { "kind", "element", "name", "QueryImpersonationInfo", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ServerMode(), source,
        new String[] { "kind", "element", "name", "ServerMode", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_StringStoresCompatibilityLevel(), source,
        new String[] { "kind", "element", "name", "StringStoresCompatibilityLevel", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_StructureType(), source,
        new String[] { "kind", "element", "name", "StructureType", "namespace", "##targetNamespace" });
    addAnnotation(hierarchyVisualizationPropertiesEClass, source,
        new String[] { "name", "HierarchyVisualizationProperties", "kind", "elementOnly" });
    addAnnotation(getHierarchyVisualizationProperties_ContextualNameRule(), source,
        new String[] { "kind", "element", "name", "ContextualNameRule" });
    addAnnotation(getHierarchyVisualizationProperties_FolderPosition(), source,
        new String[] { "kind", "element", "name", "FolderPosition" });
    addAnnotation(processingStateTypeEEnum, source, new String[] { "name", "ProcessingState_._type" });
    addAnnotation(processingStateTypeObjectEDataType, source,
        new String[] { "name", "ProcessingState_._type:Object", "baseType", "ProcessingState_._type" });
    addAnnotation(relationshipEndVisualizationPropertiesEClass, source,
        new String[] { "name", "RelationshipEndVisualizationProperties", "kind", "elementOnly" });
    addAnnotation(getRelationshipEndVisualizationProperties_FolderPosition(), source,
        new String[] { "kind", "element", "name", "FolderPosition" });
    addAnnotation(getRelationshipEndVisualizationProperties_ContextualNameRule(), source,
        new String[] { "kind", "element", "name", "ContextualNameRule" });
    addAnnotation(getRelationshipEndVisualizationProperties_DefaultDetailsPosition(), source,
        new String[] { "kind", "element", "name", "DefaultDetailsPosition" });
    addAnnotation(getRelationshipEndVisualizationProperties_DisplayKeyPosition(), source,
        new String[] { "kind", "element", "name", "DisplayKeyPosition" });
    addAnnotation(getRelationshipEndVisualizationProperties_CommonIdentifierPosition(), source,
        new String[] { "kind", "element", "name", "CommonIdentifierPosition" });
    addAnnotation(getRelationshipEndVisualizationProperties_IsDefaultMeasure(), source,
        new String[] { "kind", "element", "name", "IsDefaultMeasure" });
    addAnnotation(getRelationshipEndVisualizationProperties_IsDefaultImage(), source,
        new String[] { "kind", "element", "name", "IsDefaultImage" });
    addAnnotation(getRelationshipEndVisualizationProperties_SortPropertiesPosition(), source,
        new String[] { "kind", "element", "name", "SortPropertiesPosition" });
    addAnnotation(serverModeTypeEEnum, source, new String[] { "name", "ServerMode_._type" });
    addAnnotation(serverModeTypeObjectEDataType, source,
        new String[] { "name", "ServerMode_._type:Object", "baseType", "ServerMode_._type" });
    addAnnotation(sortDirectionTypeEEnum, source, new String[] { "name", "SortDirection_._type" });
    addAnnotation(sortDirectionType1EEnum, source, new String[] { "name", "SortDirection_._1_._type" });
    addAnnotation(sortDirectionTypeObjectEDataType, source,
        new String[] { "name", "SortDirection_._type:Object", "baseType", "SortDirection_._type" });
    addAnnotation(sortDirectionTypeObject1EDataType, source,
        new String[] { "name", "SortDirection_._1_._type:Object", "baseType", "SortDirection_._1_._type" });
    addAnnotation(stringStoresCompatibilityLevelTypeEEnum, source,
        new String[] { "name", "StringStoresCompatibilityLevel_._type" });
    addAnnotation(stringStoresCompatibilityLevelTypeObjectEDataType, source, new String[] { "name",
        "StringStoresCompatibilityLevel_._type:Object", "baseType", "StringStoresCompatibilityLevel_._type" });
    addAnnotation(structureTypeTypeEEnum, source, new String[] { "name", "StructureType_._type" });
    addAnnotation(structureTypeTypeObjectEDataType, source,
        new String[] { "name", "StructureType_._type:Object", "baseType", "StructureType_._type" });
  }
