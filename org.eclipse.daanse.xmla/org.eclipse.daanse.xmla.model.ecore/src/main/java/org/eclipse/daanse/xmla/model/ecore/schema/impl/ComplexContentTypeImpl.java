 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexContentTypeImpl#getRestriction
 * <em>Restriction</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexContentTypeImpl#getExtension
 * <em>Extension</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexContentTypeImpl#isMixed
 * <em>Mixed</em>}</li>
 * </ul>
 *
 * @generated
...
public class ComplexContentTypeImpl extends AnnotatedImpl implements ComplexContentType {
  ...
  public NotificationChain basicSetRestriction(ComplexRestrictionType newRestriction, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_CONTENT_TYPE__RESTRICTION, oldRestriction, newRestriction);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newRestriction != restriction) {
      ...
      if (restriction != null)
        msgs = ((InternalEObject) restriction).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_CONTENT_TYPE__RESTRICTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_CONTENT_TYPE__RESTRICTION,
  ...
  public NotificationChain basicSetExtension(ExtensionType newExtension, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_CONTENT_TYPE__EXTENSION, oldExtension, newExtension);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setExtension(ExtensionType newExtension) {
    if (newExtension != extension) {
      NotificationChain msgs = null;
      if (extension != null)
        msgs = ((InternalEObject) extension).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_CONTENT_TYPE__EXTENSION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_CONTENT_TYPE__EXTENSION, newExtension,
          newExtension));
  }
  ...
  public void setMixed(boolean newMixed) {
    ...
    mixedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_CONTENT_TYPE__MIXED, oldMixed, mixed,
          !oldMixedESet));
  }
  ...
  public void unsetMixed() {
    ...
    mixedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.COMPLEX_CONTENT_TYPE__MIXED, oldMixed,
