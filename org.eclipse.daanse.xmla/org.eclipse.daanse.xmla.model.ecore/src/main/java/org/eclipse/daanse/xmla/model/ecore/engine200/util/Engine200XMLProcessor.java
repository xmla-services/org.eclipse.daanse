 ...
 * @generated
 */
@Component(name = Engine200Package.eNAME
    + "XMLProcessor", service = Engine200XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine200XMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the Engine200ResourceFactoryImpl
