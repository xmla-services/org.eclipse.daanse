 ...
 * '<em><b>Partition Modes</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum PartitionModes implements Enumerator {
  ...
  /**
   * The '<em><b>Per Node</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #PER_NODE_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Per Cpu</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #PER_CPU_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Per Node</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #PER_NODE
   * @model name="perNode"
  ...
  /**
   * The '<em><b>Per Cpu</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #PER_CPU
   * @model name="perCpu"
   ...
   * @generated
   */
  private static final PartitionModes[] VALUES_ARRAY = new PartitionModes[] { NONE, PER_NODE, PER_CPU, };

  /**
   * A public read-only list of all the '<em><b>Partition Modes</b></em>'
  ...
  /**
   * Returns the '<em><b>Partition Modes</b></em>' literal with the specified
