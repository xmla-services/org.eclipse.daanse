...
public interface Xmla_multipleresultsFactory extends EFactory {
   ...
   * @generated
   */
  Xmla_multipleresultsFactory eINSTANCE = org.eclipse.daanse.xmla.model.ecore.xmla_multipleresults.impl.Xmla_multipleresultsFactoryImpl
      .init();

  /**
   * Returns a new object of class '<em>Results Type</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
