...
public interface Engine300_300Factory extends EFactory {
   ...
   * @generated
   */
  Engine300_300Factory eINSTANCE = org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.Engine300_300FactoryImpl
      .init();
  ...
  /**
   * Returns a new object of class '<em>Attributes Type</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Attribute Type</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Relationships</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>XEvent Type</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
