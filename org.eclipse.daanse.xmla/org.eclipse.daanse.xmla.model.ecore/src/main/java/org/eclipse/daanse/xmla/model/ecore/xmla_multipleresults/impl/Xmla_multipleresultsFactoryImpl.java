...
public class Xmla_multipleresultsFactoryImpl extends EFactoryImpl implements Xmla_multipleresultsFactory {
  ...
  public static Xmla_multipleresultsFactory init() {
    try {
      Xmla_multipleresultsFactory theXmla_multipleresultsFactory = (Xmla_multipleresultsFactory) EPackage.Registry.INSTANCE
          .getEFactory(Xmla_multipleresultsPackage.eNS_URI);
