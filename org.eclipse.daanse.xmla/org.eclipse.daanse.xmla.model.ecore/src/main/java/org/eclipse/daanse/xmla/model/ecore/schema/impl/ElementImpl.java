 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getSimpleType
 * <em>Simple Type</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getComplexType
 * <em>Complex Type</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getIdentityConstraint
 * <em>Identity Constraint</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getUnique
 * <em>Unique</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getKey
 * <em>Key</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getKeyref
 * <em>Keyref</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#isAbstract
 * <em>Abstract</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getBlock
 * <em>Block</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getDefault
 * <em>Default</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getFinal
 * <em>Final</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getFixed
 * <em>Fixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getForm
 * <em>Form</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getMaxOccurs
 * <em>Max Occurs</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getMinOccurs
 * <em>Min Occurs</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#isNillable
 * <em>Nillable</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getRef
 * <em>Ref</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getSubstitutionGroup
 * <em>Substitution Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ElementImpl#getType
 * <em>Type</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class ElementImpl extends AnnotatedImpl implements Element {
  ...
  /**
   * The cached value of the '{@link #getComplexType() <em>Complex Type</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getComplexType()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getIdentityConstraint() <em>Identity
   * Constraint</em>}' attribute list. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * This is true if the Abstract attribute has been set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * This is true if the Form attribute has been set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getMaxOccurs() <em>Max Occurs</em>}'
   ...
   * @ordered
   */
  protected static final Object MAX_OCCURS_EDEFAULT = SchemaFactory.eINSTANCE
      .createFromString(SchemaPackage.eINSTANCE.getAllNNI(), "1");

  /**
   * The cached value of the '{@link #getMaxOccurs() <em>Max Occurs</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMaxOccurs()
   * @generated
  ...
  /**
   * This is true if the Max Occurs attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getMinOccurs() <em>Min Occurs</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMinOccurs()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getMinOccurs() <em>Min Occurs</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMinOccurs()
   * @generated
  ...
  /**
   * This is true if the Min Occurs attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * This is true if the Nillable attribute has been set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getSubstitutionGroup() <em>Substitution
  ...
  /**
   * The cached value of the '{@link #getSubstitutionGroup() <em>Substitution
   * Group</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getSubstitutionGroup()
   * @generated
  ...
  public NotificationChain basicSetSimpleType(LocalSimpleType newSimpleType, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__SIMPLE_TYPE,
          oldSimpleType, newSimpleType);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setSimpleType(LocalSimpleType newSimpleType) {
    if (newSimpleType != simpleType) {
      ...
      if (simpleType != null)
        msgs = ((InternalEObject) simpleType).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.ELEMENT__SIMPLE_TYPE, null, msgs);
      if (newSimpleType != null)
        msgs = ((InternalEObject) newSimpleType).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.ELEMENT__SIMPLE_TYPE, null, msgs);
      msgs = basicSetSimpleType(newSimpleType, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__SIMPLE_TYPE, newSimpleType,
          newSimpleType));
  }
  ...
  public NotificationChain basicSetComplexType(LocalComplexType newComplexType, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.ELEMENT__COMPLEX_TYPE, oldComplexType, newComplexType);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setComplexType(LocalComplexType newComplexType) {
    if (newComplexType != complexType) {
      NotificationChain msgs = null;
      if (complexType != null)
        msgs = ((InternalEObject) complexType).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.ELEMENT__COMPLEX_TYPE, null, msgs);
      if (newComplexType != null)
        msgs = ((InternalEObject) newComplexType).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.ELEMENT__COMPLEX_TYPE, null, msgs);
      msgs = basicSetComplexType(newComplexType, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__COMPLEX_TYPE, newComplexType,
          newComplexType));
  }
  ...
  public void setAbstract(boolean newAbstract) {
    ...
    abstractESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__ABSTRACT, oldAbstract, abstract_,
          !oldAbstractESet));
  }
  ...
  public void unsetAbstract() {
    ...
    abstractESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.ELEMENT__ABSTRACT, oldAbstract,
          ABSTRACT_EDEFAULT, oldAbstractESet));
  }
  ...
  public void unsetForm() {
    ...
    formESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.ELEMENT__FORM, oldForm, FORM_EDEFAULT,
          oldFormESet));
  }
  ...
  public void setMaxOccurs(Object newMaxOccurs) {
    ...
    maxOccursESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__MAX_OCCURS, oldMaxOccurs, maxOccurs,
          !oldMaxOccursESet));
  }
  ...
  public void unsetMaxOccurs() {
    ...
    maxOccursESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.ELEMENT__MAX_OCCURS, oldMaxOccurs,
          MAX_OCCURS_EDEFAULT, oldMaxOccursESet));
  }
  ...
  public void setMinOccurs(BigInteger newMinOccurs) {
    ...
    minOccursESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__MIN_OCCURS, oldMinOccurs, minOccurs,
          !oldMinOccursESet));
  }
  ...
  public void unsetMinOccurs() {
    ...
    minOccursESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.ELEMENT__MIN_OCCURS, oldMinOccurs,
          MIN_OCCURS_EDEFAULT, oldMinOccursESet));
  }
  ...
  public void setNillable(boolean newNillable) {
    ...
    nillableESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__NILLABLE, oldNillable, nillable,
          !oldNillableESet));
  }
  ...
  public void unsetNillable() {
    ...
    nillableESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.ELEMENT__NILLABLE, oldNillable,
          NILLABLE_EDEFAULT, oldNillableESet));
  }
  ...
  public void setSubstitutionGroup(QName newSubstitutionGroup) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ELEMENT__SUBSTITUTION_GROUP,
          oldSubstitutionGroup, substitutionGroup));
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case SchemaPackage.ELEMENT__SUBSTITUTION_GROUP:
      return SUBSTITUTION_GROUP_EDEFAULT == null ? substitutionGroup != null
          : !SUBSTITUTION_GROUP_EDEFAULT.equals(substitutionGroup);
    case SchemaPackage.ELEMENT__TYPE:
