 ...
 * '<em><b>Namespace List Member0</b></em>', and utility methods for working
...
public enum NamespaceListMember0 implements Enumerator {
   ...
   * @generated
   */
  private static final NamespaceListMember0[] VALUES_ARRAY = new NamespaceListMember0[] { ANY, OTHER, };

  /**
   * A public read-only list of all the '<em><b>Namespace List Member0</b></em>'
  ...
  /**
   * Returns the '<em><b>Namespace List Member0</b></em>' literal with the
