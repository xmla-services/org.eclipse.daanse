 ...
 * @generated
 */
@Component(name = Xmla_multipleresultsPackage.eNAME
    + "XMLProcessor", service = Xmla_multipleresultsXMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Xmla_multipleresultsXMLProcessor extends XMLProcessor {
   ...
   * Xmla_multipleresultsResourceFactoryImpl factory. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
