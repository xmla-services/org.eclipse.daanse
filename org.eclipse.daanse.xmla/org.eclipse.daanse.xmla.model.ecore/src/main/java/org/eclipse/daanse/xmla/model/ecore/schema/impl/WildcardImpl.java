 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.WildcardImpl#getNamespace
 * <em>Namespace</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.WildcardImpl#getProcessContents
...
public class WildcardImpl extends AnnotatedImpl implements Wildcard {
   ...
   * @ordered
   */
  protected static final Object NAMESPACE_EDEFAULT = SchemaFactory.eINSTANCE
      .createFromString(SchemaPackage.eINSTANCE.getNamespaceList(), "##any");
  ...
  /**
   * This is true if the Namespace attribute has been set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getProcessContents() <em>Process
  ...
  /**
   * The cached value of the '{@link #getProcessContents() <em>Process
   * Contents</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getProcessContents()
   * @generated
  ...
  public void unsetNamespace() {
    ...
    namespaceESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.WILDCARD__NAMESPACE, oldNamespace,
          NAMESPACE_EDEFAULT, oldNamespaceESet));
  }
  ...
  public void setProcessContents(ProcessContentsType newProcessContents) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.WILDCARD__PROCESS_CONTENTS,
          oldProcessContents, processContents, !oldProcessContentsESet));
  }
  ...
  public void unsetProcessContents() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.WILDCARD__PROCESS_CONTENTS,
          oldProcessContents, PROCESS_CONTENTS_EDEFAULT, oldProcessContentsESet));
  }
