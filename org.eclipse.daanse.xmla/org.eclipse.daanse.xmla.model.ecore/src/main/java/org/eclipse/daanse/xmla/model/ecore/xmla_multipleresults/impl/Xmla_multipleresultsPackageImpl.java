...
public class Xmla_multipleresultsPackageImpl extends EPackageImpl implements Xmla_multipleresultsPackage {
   ...
   * {@link Xmla_multipleresultsPackage#eINSTANCE} when that field is accessed.
  ...
  public static Xmla_multipleresultsPackage init() {
    if (isInited)
      return (Xmla_multipleresultsPackage) EPackage.Registry.INSTANCE.getEPackage(Xmla_multipleresultsPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmla_multipleresultsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Xmla_multipleresultsPackageImpl theXmla_multipleresultsPackage = registeredXmla_multipleresultsPackage instanceof Xmla_multipleresultsPackageImpl
        ? (Xmla_multipleresultsPackageImpl) registeredXmla_multipleresultsPackage
        : new Xmla_multipleresultsPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEClass(resultsTypeEClass, ResultsType.class, "ResultsType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResultsType_Root(), theXmla_emptyPackage.getEmptyresult(), null, "root", null, 0, -1,
        ResultsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
    ...
    initEReference(getDocumentRoot_Results(), this.getResultsType(), null, "results", null, 0, -2, null, IS_TRANSIENT,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(resultsTypeEClass, source, new String[] { "name", "results_._type", "kind", "elementOnly" });
    addAnnotation(getResultsType_Root(), source, new String[] { "kind", "element", "name", "root", "namespace",
    ...
    addAnnotation(getDocumentRoot_Results(), source,
        new String[] { "kind", "element", "name", "results", "namespace", "##targetNamespace" });
  }
