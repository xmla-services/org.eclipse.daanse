 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.NormTuplesTypeImpl#getNormTuple
 * <em>Norm Tuple</em>}</li>
 * </ul>
 *
 * @generated
...
public class NormTuplesTypeImpl extends MinimalEObjectImpl.Container implements NormTuplesType {
  /**
   * The cached value of the '{@link #getNormTuple() <em>Norm Tuple</em>}'
  ...
  public EList<NormTupleType> getNormTuple() {
    if (normTuple == null) {
      normTuple = new EObjectContainmentEList<NormTupleType>(NormTupleType.class, this,
          MsxmlaPackage.NORM_TUPLES_TYPE__NORM_TUPLE);
    }
    return normTuple;
  }
