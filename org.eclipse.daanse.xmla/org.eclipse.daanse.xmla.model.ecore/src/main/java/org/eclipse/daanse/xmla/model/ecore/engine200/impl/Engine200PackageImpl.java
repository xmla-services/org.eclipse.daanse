...
public class Engine200PackageImpl extends EPackageImpl implements Engine200Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine200Package#eINSTANCE} when
  ...
  public static Engine200Package init() {
    if (isInited)
      return (Engine200Package) EPackage.Registry.INSTANCE.getEPackage(Engine200Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine200Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine200PackageImpl theEngine200Package = registeredEngine200Package instanceof Engine200PackageImpl
        ? (Engine200PackageImpl) registeredEngine200Package
        : new Engine200PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_CalculationError(), this.getCalculationErrorType(), "calculationError", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_CompatibilityLevel(), theXMLTypePackage.getInteger(), "compatibilityLevel", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_WarningColumn(), this.getWarningColumnType(), null, "warningColumn", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_WarningMeasure(), this.getWarningMeasureType(), null, "warningMeasure", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);

    initEClass(warningColumnTypeEClass, WarningColumnType.class, "WarningColumnType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getWarningColumnType_Dimension(), theXMLTypePackage.getString(), "dimension", null, 1, 1,
        WarningColumnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningColumnType_Attribute(), theXMLTypePackage.getString(), "attribute", null, 1, 1,
        WarningColumnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(warningLocationObjectEClass, WarningLocationObject.class, "WarningLocationObject", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getWarningLocationObject_WarningColumn(), this.getWarningColumnType(), null, "warningColumn", null,
        0, 1, WarningLocationObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getWarningLocationObject_WarningMeasure(), this.getWarningMeasureType(), null, "warningMeasure",
        null, 0, 1, WarningLocationObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(warningMeasureTypeEClass, WarningMeasureType.class, "WarningMeasureType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getWarningMeasureType_Cube(), theXMLTypePackage.getString(), "cube", null, 1, 1,
        WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningMeasureType_MeasureGroup(), theXMLTypePackage.getString(), "measureGroup", null, 1, 1,
        WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWarningMeasureType_MeasureName(), theXMLTypePackage.getString(), "measureName", null, 1, 1,
        WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(calculationErrorTypeObjectEDataType, CalculationErrorType.class, "CalculationErrorTypeObject",
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(calculationErrorTypeEEnum, source, new String[] { "name", "CalculationError_._type" });
    addAnnotation(calculationErrorTypeObjectEDataType, source,
        new String[] { "name", "CalculationError_._type:Object", "baseType", "CalculationError_._type" });
    ...
    addAnnotation(getDocumentRoot_CalculationError(), source,
        new String[] { "kind", "element", "name", "CalculationError", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_CompatibilityLevel(), source,
        new String[] { "kind", "element", "name", "CompatibilityLevel", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_WarningColumn(), source,
        new String[] { "kind", "element", "name", "WarningColumn", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_WarningMeasure(), source,
        new String[] { "kind", "element", "name", "WarningMeasure", "namespace", "##targetNamespace" });
    addAnnotation(warningColumnTypeEClass, source,
        new String[] { "name", "WarningColumn_._type", "kind", "elementOnly" });
    addAnnotation(getWarningColumnType_Dimension(), source, new String[] { "kind", "element", "name", "Dimension" });
    addAnnotation(getWarningColumnType_Attribute(), source, new String[] { "kind", "element", "name", "Attribute" });
    addAnnotation(warningLocationObjectEClass, source,
        new String[] { "name", "WarningLocationObject", "kind", "elementOnly" });
    addAnnotation(getWarningLocationObject_WarningColumn(), source,
        new String[] { "kind", "element", "name", "WarningColumn", "namespace", "##targetNamespace" });
    addAnnotation(getWarningLocationObject_WarningMeasure(), source,
        new String[] { "kind", "element", "name", "WarningMeasure", "namespace", "##targetNamespace" });
    addAnnotation(warningMeasureTypeEClass, source,
        new String[] { "name", "WarningMeasure_._type", "kind", "elementOnly" });
    addAnnotation(getWarningMeasureType_Cube(), source, new String[] { "kind", "element", "name", "Cube" });
    addAnnotation(getWarningMeasureType_MeasureGroup(), source,
        new String[] { "kind", "element", "name", "MeasureGroup" });
    addAnnotation(getWarningMeasureType_MeasureName(), source,
        new String[] { "kind", "element", "name", "MeasureName" });
  }
