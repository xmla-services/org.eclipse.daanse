 ...
 * '<em><b>Derivation Set Member0</b></em>', and utility methods for working
...
public enum DerivationSetMember0 implements Enumerator {
   ...
   * @generated
   */
  private static final DerivationSetMember0[] VALUES_ARRAY = new DerivationSetMember0[] { ALL, };

  /**
   * A public read-only list of all the '<em><b>Derivation Set Member0</b></em>'
  ...
  /**
   * Returns the '<em><b>Derivation Set Member0</b></em>' literal with the
