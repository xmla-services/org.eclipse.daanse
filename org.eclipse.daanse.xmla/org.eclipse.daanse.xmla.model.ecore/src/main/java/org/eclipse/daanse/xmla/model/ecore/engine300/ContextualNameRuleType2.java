 ...
 * '<em><b>Contextual Name Rule Type2</b></em>', and utility methods for working
...
public enum ContextualNameRuleType2 implements Enumerator {
  ...
  /**
   * The '<em><b>Context</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #CONTEXT_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Merge</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #MERGE_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Context</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #CONTEXT
   * @model name="Context"
   ...
   * @generated
   */
  private static final ContextualNameRuleType2[] VALUES_ARRAY = new ContextualNameRuleType2[] { NONE, CONTEXT, MERGE, };

  /**
   * A public read-only list of all the '<em><b>Contextual Name Rule
   * Type2</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Contextual Name Rule Type2</b></em>' literal with the
