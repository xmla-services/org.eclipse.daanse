 ...
 * '<em><b>Processing Recommendation Type</b></em>', and utility methods for
...
public enum ProcessingRecommendationType implements Enumerator {
  ...
  /**
   * The '<em><b>Stale</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #STALE_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Stale</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #STALE
   * @model name="Stale"
  ...
  /**
   * An array of all the '<em><b>Processing Recommendation Type</b></em>'
   * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final ProcessingRecommendationType[] VALUES_ARRAY = new ProcessingRecommendationType[] { NONE,
      STALE, };

  /**
   * A public read-only list of all the '<em><b>Processing Recommendation
   * Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<ProcessingRecommendationType> VALUES = Collections
      .unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Processing Recommendation Type</b></em>' literal with the
