...
public class Xmla_emptyPackageImpl extends EPackageImpl implements Xmla_emptyPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link Xmla_emptyPackage#eINSTANCE} when
  ...
  public static Xmla_emptyPackage init() {
    if (isInited)
      return (Xmla_emptyPackage) EPackage.Registry.INSTANCE.getEPackage(Xmla_emptyPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredXmla_emptyPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Xmla_emptyPackageImpl theXmla_emptyPackage = registeredXmla_emptyPackage instanceof Xmla_emptyPackageImpl
        ? (Xmla_emptyPackageImpl) registeredXmla_emptyPackage
        : new Xmla_emptyPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEReference(getEmptyresult_Exception(), theXmla_exceptionPackage.getException(), null, "exception", null, 0, 1,
        Emptyresult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEmptyresult_Messages(), theXmla_exceptionPackage.getMessages(), null, "messages", null, 0, 1,
        Emptyresult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_Root(), this.getEmptyresult(), null, "root", null, 0, -2, null, IS_TRANSIENT,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(emptyresultEClass, source, new String[] { "name", "emptyresult", "kind", "elementOnly" });
    addAnnotation(getEmptyresult_Exception(), source, new String[] { "kind", "element", "name", "Exception" });
    addAnnotation(getEmptyresult_Messages(), source, new String[] { "kind", "element", "name", "Messages" });
