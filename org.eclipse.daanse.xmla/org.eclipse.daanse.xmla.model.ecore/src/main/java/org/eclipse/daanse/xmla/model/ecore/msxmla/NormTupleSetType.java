...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Norm
 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.NormTupleSetType#getNormTuples
 * <em>Norm Tuples</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.NormTupleSetType#getMembersLookup
...
public interface NormTupleSetType extends EObject {
   ...
   * <em>Norm Tuples</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Norm Tuples</em>' containment
   *              reference.
   * @see #getNormTuples()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Members Lookup</b></em>' containment
   ...
   * <em>Members Lookup</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Members Lookup</em>' containment
   *              reference.
