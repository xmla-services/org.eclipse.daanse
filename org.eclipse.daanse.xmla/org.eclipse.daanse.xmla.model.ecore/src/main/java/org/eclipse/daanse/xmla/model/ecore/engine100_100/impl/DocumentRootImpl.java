 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getDbStorageLocation
 * <em>Db Storage Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getHoldoutActualSize
 * <em>Holdout Actual Size</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getHoldoutMaxCases
 * <em>Holdout Max Cases</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getHoldoutMaxPercent
 * <em>Holdout Max Percent</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine100_100.impl.DocumentRootImpl#getHoldoutSeed
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine100_100Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine100_100Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine100_100Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine100_100Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setDbStorageLocation(String newDbStorageLocation) {
    ((FeatureMap.Internal) getMixed()).set(Engine100_100Package.Literals.DOCUMENT_ROOT__DB_STORAGE_LOCATION,
  ...
  public void setHoldoutActualSize(int newHoldoutActualSize) {
    ((FeatureMap.Internal) getMixed()).set(Engine100_100Package.Literals.DOCUMENT_ROOT__HOLDOUT_ACTUAL_SIZE,
  ...
  public void setHoldoutMaxCases(int newHoldoutMaxCases) {
    ((FeatureMap.Internal) getMixed()).set(Engine100_100Package.Literals.DOCUMENT_ROOT__HOLDOUT_MAX_CASES,
        newHoldoutMaxCases);
  }
  ...
  public void setHoldoutMaxPercent(int newHoldoutMaxPercent) {
    ((FeatureMap.Internal) getMixed()).set(Engine100_100Package.Literals.DOCUMENT_ROOT__HOLDOUT_MAX_PERCENT,
