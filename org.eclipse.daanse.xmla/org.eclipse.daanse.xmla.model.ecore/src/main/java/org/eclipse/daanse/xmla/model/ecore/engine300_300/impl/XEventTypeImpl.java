...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>XEvent
 * Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.XEventTypeImpl#getEventSession
 * <em>Event Session</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XEventTypeImpl extends MinimalEObjectImpl.Container implements XEventType {
  /**
   * The cached value of the '{@link #getEventSession() <em>Event Session</em>}'
  ...
  public NotificationChain basicSetEventSession(EventSession newEventSession, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.XEVENT_TYPE__EVENT_SESSION, oldEventSession, newEventSession);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setEventSession(EventSession newEventSession) {
    if (newEventSession != eventSession) {
      ...
      if (eventSession != null)
        msgs = ((InternalEObject) eventSession).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.XEVENT_TYPE__EVENT_SESSION, null, msgs);
      if (newEventSession != null)
        msgs = ((InternalEObject) newEventSession).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.XEVENT_TYPE__EVENT_SESSION, null, msgs);
      msgs = basicSetEventSession(newEventSession, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.XEVENT_TYPE__EVENT_SESSION,
