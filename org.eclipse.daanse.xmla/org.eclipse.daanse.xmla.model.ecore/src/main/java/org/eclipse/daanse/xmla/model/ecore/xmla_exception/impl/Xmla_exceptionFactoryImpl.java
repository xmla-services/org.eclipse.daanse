...
public class Xmla_exceptionFactoryImpl extends EFactoryImpl implements Xmla_exceptionFactory {
  ...
  public static Xmla_exceptionFactory init() {
    try {
      Xmla_exceptionFactory theXmla_exceptionFactory = (Xmla_exceptionFactory) EPackage.Registry.INSTANCE
          .getEFactory(Xmla_exceptionPackage.eNS_URI);
  ...
  public EObject create(EClass eClass) {
    ...
    case Xmla_exceptionPackage.START_TYPE:
      return createStartType();
    case Xmla_exceptionPackage.WARNING_TYPE:
      return createWarningType();
    default:
