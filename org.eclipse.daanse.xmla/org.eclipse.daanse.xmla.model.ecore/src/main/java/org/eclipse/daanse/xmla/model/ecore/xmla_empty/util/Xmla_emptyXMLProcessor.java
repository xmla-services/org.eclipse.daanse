 ...
 * @generated
 */
@Component(name = Xmla_emptyPackage.eNAME
    + "XMLProcessor", service = Xmla_emptyXMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Xmla_emptyXMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the Xmla_emptyResourceFactoryImpl
