 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.CellDataImpl#getCell
 * <em>Cell</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.CellDataImpl#getCellSet
 * <em>Cell Set</em>}</li>
 * </ul>
 *
 * @generated
...
public class CellDataImpl extends MinimalEObjectImpl.Container implements CellData {
  /**
   * The cached value of the '{@link #getCell() <em>Cell</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getCellSet() <em>Cell Set</em>}' containment
  ...
  public NotificationChain basicSetCellSet(CellSetType newCellSet, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.CELL_DATA__CELL_SET, oldCellSet, newCellSet);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setCellSet(CellSetType newCellSet) {
    if (newCellSet != cellSet) {
      ...
      if (cellSet != null)
        msgs = ((InternalEObject) cellSet).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.CELL_DATA__CELL_SET, null, msgs);
      if (newCellSet != null)
        msgs = ((InternalEObject) newCellSet).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.CELL_DATA__CELL_SET, null, msgs);
      msgs = basicSetCellSet(newCellSet, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.CELL_DATA__CELL_SET, newCellSet,
          newCellSet));
  }
