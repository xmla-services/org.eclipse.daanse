 ...
 * '<em><b>Emptyresult</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_empty.impl.EmptyresultImpl#getException
 * <em>Exception</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_empty.impl.EmptyresultImpl#getMessages
 * <em>Messages</em>}</li>
 * </ul>
 *
 * @generated
...
public class EmptyresultImpl extends MinimalEObjectImpl.Container implements Emptyresult {
  ...
  public NotificationChain basicSetException(org.eclipse.daanse.xmla.model.ecore.xmla_exception.Exception newException,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_emptyPackage.EMPTYRESULT__EXCEPTION, oldException, newException);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newException != exception) {
      ...
      if (exception != null)
        msgs = ((InternalEObject) exception).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_emptyPackage.EMPTYRESULT__EXCEPTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_emptyPackage.EMPTYRESULT__EXCEPTION, newException,
          newException));
  }
  ...
  public NotificationChain basicSetMessages(Messages newMessages, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_emptyPackage.EMPTYRESULT__MESSAGES, oldMessages, newMessages);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newMessages != messages) {
      ...
      if (messages != null)
        msgs = ((InternalEObject) messages).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_emptyPackage.EMPTYRESULT__MESSAGES, null, msgs);
      if (newMessages != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_emptyPackage.EMPTYRESULT__MESSAGES, newMessages,
          newMessages));
  }
