 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.Mddataset#getOlapInfo
 * <em>Olap Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.Mddataset#getAxes
 * <em>Axes</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.Mddataset#getCellData
 * <em>Cell Data</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.Mddataset#getException
 * <em>Exception</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.Mddataset#getMessages
 * <em>Messages</em>}</li>
 * </ul>
 *
...
public interface Mddataset extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='OlapInfo'"
   * @generated
   */
   ...
   * <em>Olap Info</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Axes'"
   * @generated
   */
  Axes getAxes();
   ...
   * <em>Axes</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData="kind='element' name='CellData'"
   * @generated
   */
   ...
   * <em>Cell Data</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Exception'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Messages'"
   * @generated
   */
   ...
   * <em>Messages</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
