 ...
 * '<em><b>Visibility</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
...
public enum Visibility implements Enumerator {
  /**
   * The '<em><b>Schema Rowset</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Schema Rowset</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #SCHEMA_ROWSET
   ...
   * @generated
   */
  private static final Visibility[] VALUES_ARRAY = new Visibility[] { SCHEMA_ROWSET, NONE, };
  ...
  /**
   * Returns the '<em><b>Visibility</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>Visibility</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public static Visibility get(int value) {
    switch (value) {
    case SCHEMA_ROWSET_VALUE:
      return SCHEMA_ROWSET;
    case NONE_VALUE:
      return NONE;
    }
    return null;
