 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getImagePath
 * <em>Image Path</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getImageUniqueID
 * <em>Image Unique ID</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getImageUrl
 * <em>Image Url</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getImageVersion
 * <em>Image Version</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getProcessingRecommendation
 * <em>Processing Recommendation</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getProcessingState
 * <em>Processing State</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getShareDimensionStorage
 * <em>Share Dimension Storage</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getStorageEngineUsed
 * <em>Storage Engine Used</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.DocumentRoot#getToken
 * <em>Token</em>}</li>
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   *        extendedMetaData="kind='element' name='ImagePath'
   ...
   * <em>Image Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
   *        upper="-2" transient="true" volatile="true" derived="true"
   *        extendedMetaData="kind='element' name='ImageUniqueID'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Image Unique ID</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * <em>Image Url</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
   *        upper="-2" transient="true" volatile="true" derived="true"
   *        extendedMetaData="kind='element' name='ImageVersion'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Image Version</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Processing Recommendation</b></em>'
   ...
   *        name='ProcessingRecommendation' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Processing Recommendation</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Processing Recommendation</em>'
   *              attribute.
   * @see org.eclipse.daanse.xmla.model.ecore.engine200_200.ProcessingRecommendationType
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element'
   *        name='ShareDimensionStorage' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Share Dimension Storage</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Share Dimension Storage</em>'
   *              attribute.
   * @see org.eclipse.daanse.xmla.model.ecore.engine200_200.ShareDimensionStorageType
  ...
  /**
   * Returns the value of the '<em><b>Storage Engine Used</b></em>' attribute. The
   * literals are from the enumeration
   ...
   * @model unique="false" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element'
   *        name='StorageEngineUsed' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Storage Engine Used</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
   *        upper="-2" transient="true" volatile="true" derived="true"
   *        extendedMetaData="kind='element' name='Token'
   *        namespace='##targetNamespace'"
   * @generated
   */
  String getToken();
   ...
   * <em>Token</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
