...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Warning
 * Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.WarningTypeImpl#getLocation
 * <em>Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.WarningTypeImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.WarningTypeImpl#getHelpFile
 * <em>Help File</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.WarningTypeImpl#getSource
 * <em>Source</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.WarningTypeImpl#getWarningCode
 * <em>Warning Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WarningTypeImpl extends MinimalEObjectImpl.Container implements WarningType {
  ...
  /**
   * The default value of the '{@link #getWarningCode() <em>Warning Code</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getWarningCode()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getWarningCode() <em>Warning Code</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getWarningCode()
   * @generated
  ...
  /**
   * This is true if the Warning Code attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  public NotificationChain basicSetLocation(MessageLocation newLocation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_exceptionPackage.WARNING_TYPE__LOCATION, oldLocation, newLocation);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newLocation != location) {
      ...
      if (location != null)
        msgs = ((InternalEObject) location).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_exceptionPackage.WARNING_TYPE__LOCATION, null, msgs);
      if (newLocation != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.WARNING_TYPE__LOCATION, newLocation,
          newLocation));
  }
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.WARNING_TYPE__DESCRIPTION,
  ...
  public void setHelpFile(String newHelpFile) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.WARNING_TYPE__HELP_FILE, oldHelpFile,
          helpFile));
  }
  ...
  public void setSource(String newSource) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.WARNING_TYPE__SOURCE, oldSource, source));
  }
  ...
  public void setWarningCode(int newWarningCode) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.WARNING_TYPE__WARNING_CODE,
          oldWarningCode, warningCode, !oldWarningCodeESet));
  }
  ...
  public void unsetWarningCode() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Xmla_exceptionPackage.WARNING_TYPE__WARNING_CODE,
          oldWarningCode, WARNING_CODE_EDEFAULT, oldWarningCodeESet));
  }
