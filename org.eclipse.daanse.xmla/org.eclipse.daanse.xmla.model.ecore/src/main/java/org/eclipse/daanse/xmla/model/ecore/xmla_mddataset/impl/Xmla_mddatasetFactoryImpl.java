...
public class Xmla_mddatasetFactoryImpl extends EFactoryImpl implements Xmla_mddatasetFactory {
  ...
  public static Xmla_mddatasetFactory init() {
    try {
      Xmla_mddatasetFactory theXmla_mddatasetFactory = (Xmla_mddatasetFactory) EPackage.Registry.INSTANCE
          .getEFactory(Xmla_mddatasetPackage.eNS_URI);
