 ...
 * '<em><b>State Support</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum StateSupport implements Enumerator {
  ...
  /**
   * The '<em><b>Sessions</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #SESSIONS_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Sessions</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #SESSIONS
   * @model name="Sessions"
   ...
   * @generated
   */
  private static final StateSupport[] VALUES_ARRAY = new StateSupport[] { NONE, SESSIONS, };

  /**
   * A public read-only list of all the '<em><b>State Support</b></em>'
  ...
  /**
   * Returns the '<em><b>State Support</b></em>' literal with the specified
