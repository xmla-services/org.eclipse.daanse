...
public class Engine300AdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
  protected Engine300Switch<Adapter> modelSwitch = new Engine300Switch<Adapter>() {
    @Override
    public Adapter caseCalculationPropertiesVisualizationProperties(
        CalculationPropertiesVisualizationProperties object) {
   ...
   * <em>Hierarchy Visualization Properties</em>}'. <!-- begin-user-doc --> This
