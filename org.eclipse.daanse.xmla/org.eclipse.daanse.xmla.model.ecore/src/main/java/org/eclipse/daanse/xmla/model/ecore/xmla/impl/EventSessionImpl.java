 ...
 * Session</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getTemplateCategory
 * <em>Template Category</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getTemplateName
 * <em>Template Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getTemplateDescription
 * <em>Template Description</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getEvent
 * <em>Event</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getTarget
 * <em>Target</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getDispatchLatency
 * <em>Dispatch Latency</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getEventRetentionMode
 * <em>Event Retention Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getMaxEventSize
 * <em>Max Event Size</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getMaxMemory
 * <em>Max Memory</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getMemoryPartitionMode
 * <em>Memory Partition Mode</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionImpl#isTrackCausality
 * <em>Track Causality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventSessionImpl extends MinimalEObjectImpl.Container implements EventSession {
  /**
   * The default value of the '{@link #getTemplateCategory() <em>Template
  ...
  /**
   * The cached value of the '{@link #getTemplateCategory() <em>Template
   * Category</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getTemplateCategory()
   * @generated
  ...
  /**
   * The default value of the '{@link #getTemplateName() <em>Template Name</em>}'
  ...
  /**
   * The default value of the '{@link #getTemplateDescription() <em>Template
  ...
  /**
   * The cached value of the '{@link #getTemplateDescription() <em>Template
   * Description</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getTemplateDescription()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getEvent() <em>Event</em>}' containment
  ...
  /**
   * The default value of the '{@link #getDispatchLatency() <em>Dispatch
   * Latency</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getDispatchLatency() <em>Dispatch
   * Latency</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getDispatchLatency()
   * @generated
  ...
  /**
   * The default value of the '{@link #getEventRetentionMode() <em>Event Retention
  ...
  /**
   * The cached value of the '{@link #getEventRetentionMode() <em>Event Retention
   * Mode</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getEventRetentionMode()
   * @generated
  ...
  /**
   * The default value of the '{@link #getMaxEventSize() <em>Max Event Size</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMaxEventSize()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getMaxEventSize() <em>Max Event Size</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMaxEventSize()
   * @generated
  ...
  /**
   * The default value of the '{@link #getMaxMemory() <em>Max Memory</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMaxMemory()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getMaxMemory() <em>Max Memory</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMaxMemory()
   * @generated
  ...
  /**
   * This is true if the Max Memory attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getMemoryPartitionMode() <em>Memory
   * Partition Mode</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The cached value of the '{@link #getMemoryPartitionMode() <em>Memory
   * Partition Mode</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #getMemoryPartitionMode()
  ...
  /**
   * The default value of the '{@link #isTrackCausality() <em>Track
   * Causality</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #isTrackCausality() <em>Track
   * Causality</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isTrackCausality()
   * @generated
  ...
  public void setTemplateCategory(String newTemplateCategory) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__TEMPLATE_CATEGORY,
          oldTemplateCategory, templateCategory));
  }
  ...
  public void setTemplateName(String newTemplateName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__TEMPLATE_NAME, oldTemplateName,
          templateName));
  }
  ...
  public void setTemplateDescription(String newTemplateDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__TEMPLATE_DESCRIPTION,
          oldTemplateDescription, templateDescription));
  }
  ...
  public void setDispatchLatency(long newDispatchLatency) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__DISPATCH_LATENCY,
          oldDispatchLatency, dispatchLatency, !oldDispatchLatencyESet));
  }
  ...
  public void unsetDispatchLatency() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__DISPATCH_LATENCY,
          oldDispatchLatency, DISPATCH_LATENCY_EDEFAULT, oldDispatchLatencyESet));
  }
  ...
  public void setEventRetentionMode(RetentionModes newEventRetentionMode) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__EVENT_RETENTION_MODE,
          oldEventRetentionMode, eventRetentionMode, !oldEventRetentionModeESet));
  }
  ...
  public void unsetEventRetentionMode() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__EVENT_RETENTION_MODE,
          oldEventRetentionMode, EVENT_RETENTION_MODE_EDEFAULT, oldEventRetentionModeESet));
  }
  ...
  public void setMaxEventSize(long newMaxEventSize) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__MAX_EVENT_SIZE, oldMaxEventSize,
          maxEventSize, !oldMaxEventSizeESet));
  }
  ...
  public void unsetMaxEventSize() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__MAX_EVENT_SIZE,
          oldMaxEventSize, MAX_EVENT_SIZE_EDEFAULT, oldMaxEventSizeESet));
  }
  ...
  public void setMaxMemory(BigInteger newMaxMemory) {
    ...
    maxMemoryESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__MAX_MEMORY, oldMaxMemory,
          maxMemory, !oldMaxMemoryESet));
  }
  ...
  public void unsetMaxMemory() {
    ...
    maxMemoryESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__MAX_MEMORY, oldMaxMemory,
          MAX_MEMORY_EDEFAULT, oldMaxMemoryESet));
  }
  ...
  public void setMemoryPartitionMode(PartitionModes newMemoryPartitionMode) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__MEMORY_PARTITION_MODE,
          oldMemoryPartitionMode, memoryPartitionMode, !oldMemoryPartitionModeESet));
  }
  ...
  public void unsetMemoryPartitionMode() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__MEMORY_PARTITION_MODE,
          oldMemoryPartitionMode, MEMORY_PARTITION_MODE_EDEFAULT, oldMemoryPartitionModeESet));
  }
  ...
  public void setTrackCausality(boolean newTrackCausality) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION__TRACK_CAUSALITY,
          oldTrackCausality, trackCausality, !oldTrackCausalityESet));
  }
  ...
  public void unsetTrackCausality() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION__TRACK_CAUSALITY,
          oldTrackCausality, TRACK_CAUSALITY_EDEFAULT, oldTrackCausalityESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
    case XmlaPackage.EVENT_SESSION__TEMPLATE_CATEGORY:
      return TEMPLATE_CATEGORY_EDEFAULT == null ? templateCategory != null
          : !TEMPLATE_CATEGORY_EDEFAULT.equals(templateCategory);
    case XmlaPackage.EVENT_SESSION__TEMPLATE_NAME:
  ...
  public String toString() {
    ...
    if (dispatchLatencyESet)
      result.append(dispatchLatency);
    else
      result.append("<unset>");
    result.append(", eventRetentionMode: ");
    if (eventRetentionModeESet)
      result.append(eventRetentionMode);
    else
      result.append("<unset>");
