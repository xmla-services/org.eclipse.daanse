 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl#getRestriction
 * <em>Restriction</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl#getList
 * <em>List</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl#getUnion
 * <em>Union</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl#getFinal
 * <em>Final</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.SimpleTypeImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class SimpleTypeImpl extends AnnotatedImpl implements SimpleType {
  ...
  /**
   * The cached value of the '{@link #getList() <em>List</em>}' containment
  ...
  public NotificationChain basicSetRestriction(RestrictionType1 newRestriction, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.SIMPLE_TYPE__RESTRICTION, oldRestriction, newRestriction);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newRestriction != restriction) {
      ...
      if (restriction != null)
        msgs = ((InternalEObject) restriction).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.SIMPLE_TYPE__RESTRICTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SIMPLE_TYPE__RESTRICTION, newRestriction,
          newRestriction));
  }
  ...
  public NotificationChain basicSetList(ListType newList, NotificationChain msgs) {
    ...
    list = newList;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.SIMPLE_TYPE__LIST,
          oldList, newList);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setList(ListType newList) {
    if (newList != list) {
      NotificationChain msgs = null;
      if (list != null)
        msgs = ((InternalEObject) list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.SIMPLE_TYPE__LIST,
            null, msgs);
      if (newList != null)
        msgs = ((InternalEObject) newList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.SIMPLE_TYPE__LIST,
            null, msgs);
  ...
  public NotificationChain basicSetUnion(UnionType newUnion, NotificationChain msgs) {
    ...
    union = newUnion;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.SIMPLE_TYPE__UNION,
          oldUnion, newUnion);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setUnion(UnionType newUnion) {
    if (newUnion != union) {
      NotificationChain msgs = null;
      if (union != null)
        msgs = ((InternalEObject) union).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.SIMPLE_TYPE__UNION,
            null, msgs);
      if (newUnion != null)
        msgs = ((InternalEObject) newUnion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.SIMPLE_TYPE__UNION,
            null, msgs);
