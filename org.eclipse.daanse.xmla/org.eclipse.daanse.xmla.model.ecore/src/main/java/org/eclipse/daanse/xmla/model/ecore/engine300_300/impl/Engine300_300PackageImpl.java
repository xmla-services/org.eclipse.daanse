...
public class Engine300_300PackageImpl extends EPackageImpl implements Engine300_300Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine300_300Package#eINSTANCE} when
  ...
  public static Engine300_300Package init() {
    if (isInited)
      return (Engine300_300Package) EPackage.Registry.INSTANCE.getEPackage(Engine300_300Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine300_300Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine300_300PackageImpl theEngine300_300Package = registeredEngine300_300Package instanceof Engine300_300PackageImpl
        ? (Engine300_300PackageImpl) registeredEngine300_300Package
        : new Engine300_300PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    Engine300Package theEngine300Package = (Engine300Package) EPackage.Registry.INSTANCE
        .getEPackage(Engine300Package.eNS_URI);
    ...
    initEClass(annotationsTypeEClass, AnnotationsType.class, "AnnotationsType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAnnotationsType_Annotation(), theXmlaPackage.getAnnotation(), null, "annotation", null, 0, -1,
        AnnotationsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributesTypeEClass, AttributesType.class, "AttributesType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAttributesType_Attribute(), this.getAttributeType(), null, "attribute", null, 0, -1,
        AttributesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributeTypeEClass, AttributeType.class, "AttributeType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAttributeType_AttributeID(), theXMLTypePackage.getString(), "attributeID", null, 1, 1,
        AttributeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    ...
    initEAttribute(getDocumentRoot_AllowedRowsExpression(), theXMLTypePackage.getString(), "allowedRowsExpression",
        null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getDocumentRoot_DirectQueryMode(), this.getDirectQueryModeType(), "directQueryMode", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_DirectQueryUsage(), this.getDirectQueryUsageType(), "directQueryUsage", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_XEvent(), this.getXEventType(), null, "xEvent", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);

    initEClass(relationshipEClass, Relationship.class, "Relationship", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRelationship_ID(), theXMLTypePackage.getString(), "iD", null, 1, 1, Relationship.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationship_Visible(), theXMLTypePackage.getBoolean(), "visible", null, 1, 1, Relationship.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationship_FromRelationshipEnd(), this.getRelationshipEnd(), null, "fromRelationshipEnd", null,
        1, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationship_ToRelationshipEnd(), this.getRelationshipEnd(), null, "toRelationshipEnd", null, 1,
        1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(relationshipEndEClass, RelationshipEnd.class, "RelationshipEnd", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRelationshipEnd_Role(), theXMLTypePackage.getString(), "role", null, 1, 1, RelationshipEnd.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEnd_Multiplicity(), this.getMultiplicityType(), "multiplicity", null, 1, 1,
        RelationshipEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEnd_DimensionID(), theXMLTypePackage.getString(), "dimensionID", null, 1, 1,
        RelationshipEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationshipEnd_Attributes(), this.getAttributesType(), null, "attributes", null, 0, 1,
        RelationshipEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationshipEnd_Translations(), this.getTranslationsType(), null, "translations", null, 0, 1,
        RelationshipEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationshipEnd_VisualizationProperties(),
        theEngine300Package.getRelationshipEndVisualizationProperties(), null, "visualizationProperties", null, 0, 1,
        RelationshipEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(relationshipEndTranslationEClass, RelationshipEndTranslation.class, "RelationshipEndTranslation",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRelationshipEndTranslation_Language(), theXMLTypePackage.getUnsignedInt(), "language", null, 1, 1,
        RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndTranslation_Caption(), theXMLTypePackage.getString(), "caption", null, 0, 1,
        RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndTranslation_CollectionCaption(), theXMLTypePackage.getString(),
        "collectionCaption", null, 1, 1, RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndTranslation_Description(), theXMLTypePackage.getString(), "description", null, 0,
        1, RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationshipEndTranslation_DisplayFolder(), theXMLTypePackage.getString(), "displayFolder", null,
        0, 1, RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationshipEndTranslation_Annotations(), this.getAnnotationsType(), null, "annotations", null, 0,
        1, RelationshipEndTranslation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(relationshipsEClass, Relationships.class, "Relationships", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRelationships_Relationship(), this.getRelationship(), null, "relationship", null, 0, -1,
        Relationships.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(translationsTypeEClass, TranslationsType.class, "TranslationsType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTranslationsType_Translation(), this.getRelationshipEndTranslation(), null, "translation", null,
        0, -1, TranslationsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(xEventTypeEClass, XEventType.class, "XEventType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getXEventType_EventSession(), theXmlaPackage.getEventSession(), null, "eventSession", null, 1, 1,
        XEventType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(directQueryModeTypeObjectEDataType, DirectQueryModeType.class, "DirectQueryModeTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(directQueryUsageTypeObjectEDataType, DirectQueryUsageType.class, "DirectQueryUsageTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(multiplicityTypeObjectEDataType, MultiplicityType.class, "MultiplicityTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(annotationsTypeEClass, source, new String[] { "name", "Annotations_._type", "kind", "elementOnly" });
    addAnnotation(getAnnotationsType_Annotation(), source, new String[] { "kind", "element", "name", "Annotation" });
    addAnnotation(attributesTypeEClass, source, new String[] { "name", "Attributes_._type", "kind", "elementOnly" });
    addAnnotation(getAttributesType_Attribute(), source, new String[] { "kind", "element", "name", "Attribute" });
    addAnnotation(attributeTypeEClass, source, new String[] { "name", "Attribute_._type", "kind", "elementOnly" });
    addAnnotation(getAttributeType_AttributeID(), source, new String[] { "kind", "element", "name", "AttributeID" });
    addAnnotation(directQueryModeTypeEEnum, source, new String[] { "name", "DirectQueryMode_._type" });
    addAnnotation(directQueryModeTypeObjectEDataType, source,
        new String[] { "name", "DirectQueryMode_._type:Object", "baseType", "DirectQueryMode_._type" });
    addAnnotation(directQueryUsageTypeEEnum, source, new String[] { "name", "DirectQueryUsage_._type" });
    addAnnotation(directQueryUsageTypeObjectEDataType, source,
        new String[] { "name", "DirectQueryUsage_._type:Object", "baseType", "DirectQueryUsage_._type" });
    ...
    addAnnotation(getDocumentRoot_AllowedRowsExpression(), source,
        new String[] { "kind", "element", "name", "AllowedRowsExpression", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_DirectQueryMode(), source,
        new String[] { "kind", "element", "name", "DirectQueryMode", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_DirectQueryUsage(), source,
        new String[] { "kind", "element", "name", "DirectQueryUsage", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_XEvent(), source,
        new String[] { "kind", "element", "name", "XEvent", "namespace", "##targetNamespace" });
    addAnnotation(multiplicityTypeEEnum, source, new String[] { "name", "Multiplicity_._type" });
    addAnnotation(multiplicityTypeObjectEDataType, source,
        new String[] { "name", "Multiplicity_._type:Object", "baseType", "Multiplicity_._type" });
    addAnnotation(relationshipEClass, source, new String[] { "name", "Relationship", "kind", "elementOnly" });
    addAnnotation(getRelationship_ID(), source, new String[] { "kind", "element", "name", "ID" });
    addAnnotation(getRelationship_Visible(), source, new String[] { "kind", "element", "name", "Visible" });
    addAnnotation(getRelationship_FromRelationshipEnd(), source,
        new String[] { "kind", "element", "name", "FromRelationshipEnd" });
    addAnnotation(getRelationship_ToRelationshipEnd(), source,
        new String[] { "kind", "element", "name", "ToRelationshipEnd" });
    addAnnotation(relationshipEndEClass, source, new String[] { "name", "RelationshipEnd", "kind", "elementOnly" });
    addAnnotation(getRelationshipEnd_Role(), source, new String[] { "kind", "element", "name", "Role" });
    addAnnotation(getRelationshipEnd_Multiplicity(), source,
        new String[] { "kind", "element", "name", "Multiplicity" });
    addAnnotation(getRelationshipEnd_DimensionID(), source, new String[] { "kind", "element", "name", "DimensionID" });
    addAnnotation(getRelationshipEnd_Attributes(), source, new String[] { "kind", "element", "name", "Attributes" });
    addAnnotation(getRelationshipEnd_Translations(), source,
        new String[] { "kind", "element", "name", "Translations" });
    addAnnotation(getRelationshipEnd_VisualizationProperties(), source,
        new String[] { "kind", "element", "name", "VisualizationProperties" });
    addAnnotation(relationshipEndTranslationEClass, source,
        new String[] { "name", "RelationshipEndTranslation", "kind", "elementOnly" });
    addAnnotation(getRelationshipEndTranslation_Language(), source,
        new String[] { "kind", "element", "name", "Language" });
    addAnnotation(getRelationshipEndTranslation_Caption(), source,
        new String[] { "kind", "element", "name", "Caption" });
    addAnnotation(getRelationshipEndTranslation_CollectionCaption(), source,
        new String[] { "kind", "element", "name", "CollectionCaption" });
    addAnnotation(getRelationshipEndTranslation_Description(), source,
        new String[] { "kind", "element", "name", "Description" });
    addAnnotation(getRelationshipEndTranslation_DisplayFolder(), source,
        new String[] { "kind", "element", "name", "DisplayFolder" });
    addAnnotation(getRelationshipEndTranslation_Annotations(), source,
        new String[] { "kind", "element", "name", "Annotations" });
    addAnnotation(relationshipsEClass, source, new String[] { "name", "Relationships", "kind", "elementOnly" });
    addAnnotation(getRelationships_Relationship(), source, new String[] { "kind", "element", "name", "Relationship" });
    addAnnotation(translationsTypeEClass, source,
        new String[] { "name", "Translations_._type", "kind", "elementOnly" });
    addAnnotation(getTranslationsType_Translation(), source, new String[] { "kind", "element", "name", "Translation" });
    addAnnotation(xEventTypeEClass, source, new String[] { "name", "XEvent_._type", "kind", "elementOnly" });
    addAnnotation(getXEventType_EventSession(), source, new String[] { "kind", "element", "name", "event_session",
