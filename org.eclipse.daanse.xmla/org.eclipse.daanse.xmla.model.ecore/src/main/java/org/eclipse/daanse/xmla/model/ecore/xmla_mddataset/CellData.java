 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.CellData#getCell
 * <em>Cell</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.CellData#getCellSet
 * <em>Cell Set</em>}</li>
 * </ul>
 *
...
public interface CellData extends EObject {
   ...
   * {@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.CellType}. <!--
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Cell'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='CellSet'"
   * @generated
   */
   ...
   * <em>Cell Set</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
