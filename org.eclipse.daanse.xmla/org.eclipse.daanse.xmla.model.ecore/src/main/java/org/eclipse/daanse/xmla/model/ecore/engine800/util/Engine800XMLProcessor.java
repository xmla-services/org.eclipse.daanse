 ...
 * @generated
 */
@Component(name = Engine800Package.eNAME
    + "XMLProcessor", service = Engine800XMLProcessor.class, scope = ServiceScope.SINGLETON)
public class Engine800XMLProcessor extends XMLProcessor {
  ...
  /**
   * Register for "*" and "xml" file extensions the Engine800ResourceFactoryImpl
