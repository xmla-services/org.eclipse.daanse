 ...
 * '<em><b>String Stores Compatibility Level Type</b></em>', and utility methods
...
public enum StringStoresCompatibilityLevelType implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>String Stores Compatibility Level Type</b></em>'
   * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final StringStoresCompatibilityLevelType[] VALUES_ARRAY = new StringStoresCompatibilityLevelType[] {
      _1050, _1100, };

  /**
   * A public read-only list of all the '<em><b>String Stores Compatibility Level
   * Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<StringStoresCompatibilityLevelType> VALUES = Collections
      .unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>String Stores Compatibility Level Type</b></em>' literal
