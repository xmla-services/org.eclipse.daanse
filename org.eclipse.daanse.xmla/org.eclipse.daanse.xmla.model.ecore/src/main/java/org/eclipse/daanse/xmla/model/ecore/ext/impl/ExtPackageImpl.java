...
public class ExtPackageImpl extends EPackageImpl implements ExtPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link ExtPackage#eINSTANCE} when that
  ...
  public static ExtPackage init() {
    if (isInited)
      return (ExtPackage) EPackage.Registry.INSTANCE.getEPackage(ExtPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredExtPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    ExtPackageImpl theExtPackage = registeredExtPackage instanceof ExtPackageImpl
        ? (ExtPackageImpl) registeredExtPackage
        : new ExtPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEClass(authenticateResponseTypeEClass, AuthenticateResponseType.class, "AuthenticateResponseType", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAuthenticateResponseType_Return(), this.getReturnType(), null, "return", null, 1, 1,
        AuthenticateResponseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(authenticateTypeEClass, AuthenticateType.class, "AuthenticateType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAuthenticateType_SspiHandshake(), theXMLTypePackage.getBase64Binary(), "sspiHandshake", null, 1,
        1, AuthenticateType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
    ...
    initEReference(getDocumentRoot_Authenticate(), this.getAuthenticateType(), null, "authenticate", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_AuthenticateResponse(), this.getAuthenticateResponseType(), null,
        "authenticateResponse", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(returnTypeEClass, ReturnType.class, "ReturnType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getReturnType_SspiHandshake(), theXMLTypePackage.getBase64Binary(), "sspiHandshake", null, 1, 1,
        ReturnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(authenticateResponseTypeEClass, source,
        new String[] { "name", "AuthenticateResponse_._type", "kind", "elementOnly" });
    addAnnotation(getAuthenticateResponseType_Return(), source, new String[] { "kind", "element", "name", "return" });
    addAnnotation(authenticateTypeEClass, source,
        new String[] { "name", "Authenticate_._type", "kind", "elementOnly" });
    addAnnotation(getAuthenticateType_SspiHandshake(), source,
        new String[] { "kind", "element", "name", "SspiHandshake" });
    ...
    addAnnotation(getDocumentRoot_Authenticate(), source,
        new String[] { "kind", "element", "name", "Authenticate", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_AuthenticateResponse(), source,
        new String[] { "kind", "element", "name", "AuthenticateResponse", "namespace", "##targetNamespace" });
    addAnnotation(returnTypeEClass, source, new String[] { "name", "return_._type", "kind", "elementOnly" });
    addAnnotation(getReturnType_SspiHandshake(), source, new String[] { "kind", "element", "name", "SspiHandshake" });
  }
