 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.impl.DocumentRootImpl#getNormTupleSet
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(MsxmlaPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, MsxmlaPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(MsxmlaPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, MsxmlaPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetNormTupleSet(NormTupleSetType newNormTupleSet, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(MsxmlaPackage.Literals.DOCUMENT_ROOT__NORM_TUPLE_SET,
        newNormTupleSet, msgs);
  }
