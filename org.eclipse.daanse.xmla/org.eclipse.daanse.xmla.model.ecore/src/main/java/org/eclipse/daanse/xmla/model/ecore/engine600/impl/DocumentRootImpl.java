 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine600.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine600.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine600.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine600.impl.DocumentRootImpl#getSupportedCompatibilityLevels
 * <em>Supported Compatibility Levels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getSupportedCompatibilityLevels()
   * <em>Supported Compatibility Levels</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine600Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine600Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine600Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine600Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setSupportedCompatibilityLevels(String newSupportedCompatibilityLevels) {
    ((FeatureMap.Internal) getMixed()).set(Engine600Package.Literals.DOCUMENT_ROOT__SUPPORTED_COMPATIBILITY_LEVELS,
        newSupportedCompatibilityLevels);
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Engine600Package.DOCUMENT_ROOT__SUPPORTED_COMPATIBILITY_LEVELS:
      return SUPPORTED_COMPATIBILITY_LEVELS_EDEFAULT == null ? getSupportedCompatibilityLevels() != null
          : !SUPPORTED_COMPATIBILITY_LEVELS_EDEFAULT.equals(getSupportedCompatibilityLevels());
    }
