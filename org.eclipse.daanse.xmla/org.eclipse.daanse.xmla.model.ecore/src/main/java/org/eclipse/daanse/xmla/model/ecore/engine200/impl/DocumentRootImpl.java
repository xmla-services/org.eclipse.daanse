 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getCalculationError
 * <em>Calculation Error</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getCompatibilityLevel
 * <em>Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getWarningColumn
 * <em>Warning Column</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.impl.DocumentRootImpl#getWarningMeasure
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getCalculationError() <em>Calculation
   * Error</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The default value of the '{@link #getCompatibilityLevel() <em>Compatibility
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine200Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine200Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine200Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine200Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setCalculationError(CalculationErrorType newCalculationError) {
    ((FeatureMap.Internal) getMixed()).set(Engine200Package.Literals.DOCUMENT_ROOT__CALCULATION_ERROR,
        newCalculationError);
  }
  ...
  public void setCompatibilityLevel(BigInteger newCompatibilityLevel) {
    ((FeatureMap.Internal) getMixed()).set(Engine200Package.Literals.DOCUMENT_ROOT__COMPATIBILITY_LEVEL,
  ...
  public NotificationChain basicSetWarningColumn(WarningColumnType newWarningColumn, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(Engine200Package.Literals.DOCUMENT_ROOT__WARNING_COLUMN,
        newWarningColumn, msgs);
  }
  ...
  public NotificationChain basicSetWarningMeasure(WarningMeasureType newWarningMeasure, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(Engine200Package.Literals.DOCUMENT_ROOT__WARNING_MEASURE,
        newWarningMeasure, msgs);
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Engine200Package.DOCUMENT_ROOT__COMPATIBILITY_LEVEL:
      return COMPATIBILITY_LEVEL_EDEFAULT == null ? getCompatibilityLevel() != null
          : !COMPATIBILITY_LEVEL_EDEFAULT.equals(getCompatibilityLevel());
    case Engine200Package.DOCUMENT_ROOT__WARNING_COLUMN:
