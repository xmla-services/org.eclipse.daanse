 ...
 * '<em><b>Processing State Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum ProcessingStateType implements Enumerator {
  ...
  /**
   * The '<em><b>Invalid Expression</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Calculation Error</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Invalid Expression</b></em>' literal value. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Calculation Error</b></em>' literal value. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   ...
   * @generated
   */
  private static final ProcessingStateType[] VALUES_ARRAY = new ProcessingStateType[] { PROCESSED, UNPROCESSED,
      INVALID_EXPRESSION, CALCULATION_ERROR, DEPENDENCY_ERROR, };

  /**
   * A public read-only list of all the '<em><b>Processing State Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Processing State Type</b></em>' literal with the
