 ...
 * '<em><b>Block Set Member1 Item</b></em>', and utility methods for working
...
public enum BlockSetMember1Item implements Enumerator {
   ...
   * @generated
   */
  private static final BlockSetMember1Item[] VALUES_ARRAY = new BlockSetMember1Item[] { EXTENSION, RESTRICTION,
      SUBSTITUTION, };

  /**
   * A public read-only list of all the '<em><b>Block Set Member1 Item</b></em>'
  ...
  /**
   * Returns the '<em><b>Block Set Member1 Item</b></em>' literal with the
