...
public class Engine300FactoryImpl extends EFactoryImpl implements Engine300Factory {
  ...
  public static Engine300Factory init() {
    try {
      Engine300Factory theEngine300Factory = (Engine300Factory) EPackage.Registry.INSTANCE
          .getEFactory(Engine300Package.eNS_URI);
   ...
   * @generated
   */
  public AttributeHierarchyProcessingState createAttributeHierarchyProcessingStateFromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public CurrentStringStoresCompatibilityLevelType createCurrentStringStoresCompatibilityLevelTypeFromString(
   ...
   * @generated
   */
  public DefaultAggregateFunctionType createDefaultAggregateFunctionTypeFromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public StringStoresCompatibilityLevelType createStringStoresCompatibilityLevelTypeFromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public AttributeHierarchyProcessingState createAttributeHierarchyProcessingStateObjectFromString(EDataType eDataType,
      String initialValue) {
    return createAttributeHierarchyProcessingStateFromString(
        Engine300Package.Literals.ATTRIBUTE_HIERARCHY_PROCESSING_STATE, initialValue);
  }
  ...
  public String convertAttributeHierarchyProcessingStateObjectToString(EDataType eDataType, Object instanceValue) {
    return convertAttributeHierarchyProcessingStateToString(
        Engine300Package.Literals.ATTRIBUTE_HIERARCHY_PROCESSING_STATE, instanceValue);
  }
   ...
   * @generated
   */
  public ContextualNameRuleType1 createContextualNameRuleTypeObject1FromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public ContextualNameRuleType2 createContextualNameRuleTypeObject2FromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public ContextualNameRuleType3 createContextualNameRuleTypeObject3FromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public CurrentStringStoresCompatibilityLevelType createCurrentStringStoresCompatibilityLevelTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createCurrentStringStoresCompatibilityLevelTypeFromString(
        Engine300Package.Literals.CURRENT_STRING_STORES_COMPATIBILITY_LEVEL_TYPE, initialValue);
  }
   ...
   * @generated
   */
  public String convertCurrentStringStoresCompatibilityLevelTypeObjectToString(EDataType eDataType,
      Object instanceValue) {
    return convertCurrentStringStoresCompatibilityLevelTypeToString(
        Engine300Package.Literals.CURRENT_STRING_STORES_COMPATIBILITY_LEVEL_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public DefaultAggregateFunctionType createDefaultAggregateFunctionTypeObjectFromString(EDataType eDataType,
      String initialValue) {
    return createDefaultAggregateFunctionTypeFromString(Engine300Package.Literals.DEFAULT_AGGREGATE_FUNCTION_TYPE,
        initialValue);
  }
  ...
  public String convertDefaultAggregateFunctionTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertDefaultAggregateFunctionTypeToString(Engine300Package.Literals.DEFAULT_AGGREGATE_FUNCTION_TYPE,
        instanceValue);
  }
   ...
   * @generated
   */
  public StringStoresCompatibilityLevelType createStringStoresCompatibilityLevelTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createStringStoresCompatibilityLevelTypeFromString(
        Engine300Package.Literals.STRING_STORES_COMPATIBILITY_LEVEL_TYPE, initialValue);
  }
  ...
  public String convertStringStoresCompatibilityLevelTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertStringStoresCompatibilityLevelTypeToString(
        Engine300Package.Literals.STRING_STORES_COMPATIBILITY_LEVEL_TYPE, instanceValue);
  }
