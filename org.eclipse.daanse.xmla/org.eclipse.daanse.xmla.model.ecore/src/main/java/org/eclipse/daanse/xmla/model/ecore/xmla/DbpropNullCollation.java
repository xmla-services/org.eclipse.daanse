 ...
 * '<em><b>Dbprop Null Collation</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum DbpropNullCollation implements Enumerator {
   ...
   * @generated
   */
  private static final DbpropNullCollation[] VALUES_ARRAY = new DbpropNullCollation[] { _1, _2, _4, _8, };

  /**
   * A public read-only list of all the '<em><b>Dbprop Null Collation</b></em>'
  ...
  /**
   * Returns the '<em><b>Dbprop Null Collation</b></em>' literal with the
