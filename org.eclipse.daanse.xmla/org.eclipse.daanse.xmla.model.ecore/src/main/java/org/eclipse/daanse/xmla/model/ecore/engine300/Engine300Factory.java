...
public interface Engine300Factory extends EFactory {
  ...
  /**
   * Returns a new object of class '<em>Calculation Properties Visualization
   * Properties</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return a new object of class '<em>Calculation Properties Visualization
   *         Properties</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Dimension Attribute Visualization
   * Properties</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return a new object of class '<em>Dimension Attribute Visualization
   *         Properties</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Relationship End Visualization
   * Properties</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return a new object of class '<em>Relationship End Visualization
   *         Properties</em>'.
   * @generated
   */
