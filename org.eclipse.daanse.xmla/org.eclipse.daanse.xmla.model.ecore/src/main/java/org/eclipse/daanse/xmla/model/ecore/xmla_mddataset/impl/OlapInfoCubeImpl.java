 ...
 * Info Cube</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoCubeImpl#getCubeName
 * <em>Cube Name</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoCubeImpl#getLastDataUpdate
 * <em>Last Data Update</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoCubeImpl#getLastSchemaUpdate
 * <em>Last Schema Update</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OlapInfoCubeImpl extends MinimalEObjectImpl.Container implements OlapInfoCube {
  /**
   * The default value of the '{@link #getCubeName() <em>Cube Name</em>}'
  ...
  /**
   * The cached value of the '{@link #getCubeName() <em>Cube Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCubeName()
   * @generated
  ...
  /**
   * The default value of the '{@link #getLastDataUpdate() <em>Last Data
   * Update</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getLastDataUpdate() <em>Last Data
   * Update</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getLastDataUpdate()
   * @generated
  ...
  /**
   * The default value of the '{@link #getLastSchemaUpdate() <em>Last Schema
   * Update</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getLastSchemaUpdate() <em>Last Schema
   * Update</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getLastSchemaUpdate()
   * @generated
  ...
  public void setCubeName(String newCubeName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO_CUBE__CUBE_NAME,
          oldCubeName, cubeName));
  }
  ...
  public void setLastDataUpdate(XMLGregorianCalendar newLastDataUpdate) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO_CUBE__LAST_DATA_UPDATE,
  ...
  public void setLastSchemaUpdate(XMLGregorianCalendar newLastSchemaUpdate) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO_CUBE__LAST_SCHEMA_UPDATE,
          oldLastSchemaUpdate, lastSchemaUpdate));
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Xmla_mddatasetPackage.OLAP_INFO_CUBE__LAST_DATA_UPDATE:
      return LAST_DATA_UPDATE_EDEFAULT == null ? lastDataUpdate != null
          : !LAST_DATA_UPDATE_EDEFAULT.equals(lastDataUpdate);
    case Xmla_mddatasetPackage.OLAP_INFO_CUBE__LAST_SCHEMA_UPDATE:
      return LAST_SCHEMA_UPDATE_EDEFAULT == null ? lastSchemaUpdate != null
          : !LAST_SCHEMA_UPDATE_EDEFAULT.equals(lastSchemaUpdate);
    }
