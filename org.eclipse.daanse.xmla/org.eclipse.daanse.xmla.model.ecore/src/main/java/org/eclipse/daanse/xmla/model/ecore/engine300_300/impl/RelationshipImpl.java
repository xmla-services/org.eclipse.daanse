 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipImpl#getID
 * <em>ID</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipImpl#isVisible
 * <em>Visible</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipImpl#getFromRelationshipEnd
 * <em>From Relationship End</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.impl.RelationshipImpl#getToRelationshipEnd
 * <em>To Relationship End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends MinimalEObjectImpl.Container implements Relationship {
  ...
  /**
   * The cached value of the '{@link #getFromRelationshipEnd() <em>From
   * Relationship End</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getToRelationshipEnd() <em>To Relationship
   * End</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  public void setVisible(boolean newVisible) {
    ...
    visibleESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP__VISIBLE, oldVisible,
  ...
  public void unsetVisible() {
    ...
    visibleESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Engine300_300Package.RELATIONSHIP__VISIBLE, oldVisible,
  ...
  public NotificationChain basicSetFromRelationshipEnd(RelationshipEnd newFromRelationshipEnd, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP__FROM_RELATIONSHIP_END, oldFromRelationshipEnd, newFromRelationshipEnd);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setFromRelationshipEnd(RelationshipEnd newFromRelationshipEnd) {
    if (newFromRelationshipEnd != fromRelationshipEnd) {
      ...
      if (fromRelationshipEnd != null)
        msgs = ((InternalEObject) fromRelationshipEnd).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP__FROM_RELATIONSHIP_END, null, msgs);
      if (newFromRelationshipEnd != null)
        msgs = ((InternalEObject) newFromRelationshipEnd).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP__FROM_RELATIONSHIP_END, null, msgs);
      msgs = basicSetFromRelationshipEnd(newFromRelationshipEnd, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP__FROM_RELATIONSHIP_END,
          newFromRelationshipEnd, newFromRelationshipEnd));
  }
  ...
  public NotificationChain basicSetToRelationshipEnd(RelationshipEnd newToRelationshipEnd, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Engine300_300Package.RELATIONSHIP__TO_RELATIONSHIP_END, oldToRelationshipEnd, newToRelationshipEnd);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setToRelationshipEnd(RelationshipEnd newToRelationshipEnd) {
    if (newToRelationshipEnd != toRelationshipEnd) {
      ...
      if (toRelationshipEnd != null)
        msgs = ((InternalEObject) toRelationshipEnd).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP__TO_RELATIONSHIP_END, null, msgs);
      if (newToRelationshipEnd != null)
        msgs = ((InternalEObject) newToRelationshipEnd).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Engine300_300Package.RELATIONSHIP__TO_RELATIONSHIP_END, null, msgs);
      msgs = basicSetToRelationshipEnd(newToRelationshipEnd, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Engine300_300Package.RELATIONSHIP__TO_RELATIONSHIP_END,
          newToRelationshipEnd, newToRelationshipEnd));
  }
