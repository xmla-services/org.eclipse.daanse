 ...
 * '<em><b>Extension Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getGroup
 * <em>Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getAll
 * <em>All</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getChoice
 * <em>Choice</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getSequence
 * <em>Sequence</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getGroup1
 * <em>Group1</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getAttribute
 * <em>Attribute</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getAttributeGroup
 * <em>Attribute Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getAnyAttribute1
 * <em>Any Attribute1</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ExtensionTypeImpl#getBase
 * <em>Base</em>}</li>
 * </ul>
 *
 * @generated
...
public class ExtensionTypeImpl extends AnnotatedImpl implements ExtensionType {
  ...
  public NotificationChain basicSetGroup(GroupRef newGroup, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.EXTENSION_TYPE__GROUP, oldGroup, newGroup);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newGroup != group) {
      ...
      if (group != null)
        msgs = ((InternalEObject) group).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__GROUP, null, msgs);
      if (newGroup != null)
  ...
  public NotificationChain basicSetAll(All newAll, NotificationChain msgs) {
    ...
    all = newAll;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__ALL,
          oldAll, newAll);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setAll(All newAll) {
    if (newAll != all) {
      NotificationChain msgs = null;
      if (all != null)
        msgs = ((InternalEObject) all).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__ALL,
            null, msgs);
      if (newAll != null)
        msgs = ((InternalEObject) newAll).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__ALL,
            null, msgs);
  ...
  public NotificationChain basicSetChoice(ExplicitGroup newChoice, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.EXTENSION_TYPE__CHOICE, oldChoice, newChoice);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newChoice != choice) {
      ...
      if (choice != null)
        msgs = ((InternalEObject) choice).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__CHOICE, null, msgs);
      if (newChoice != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__CHOICE, newChoice, newChoice));
  }
  ...
  public NotificationChain basicSetSequence(ExplicitGroup newSequence, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.EXTENSION_TYPE__SEQUENCE, oldSequence, newSequence);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newSequence != sequence) {
      ...
      if (sequence != null)
        msgs = ((InternalEObject) sequence).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__SEQUENCE, null, msgs);
      if (newSequence != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__SEQUENCE, newSequence,
          newSequence));
  }
  ...
  public NotificationChain basicSetAnyAttribute1(Wildcard newAnyAttribute1, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.EXTENSION_TYPE__ANY_ATTRIBUTE1, oldAnyAttribute1, newAnyAttribute1);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newAnyAttribute1 != anyAttribute1) {
      ...
      if (anyAttribute1 != null)
        msgs = ((InternalEObject) anyAttribute1).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__ANY_ATTRIBUTE1, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__ANY_ATTRIBUTE1,
