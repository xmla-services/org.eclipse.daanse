...
public class ExtAdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
  protected ExtSwitch<Adapter> modelSwitch = new ExtSwitch<Adapter>() {
    @Override
   ...
   * <em>Authenticate Response Type</em>}'. <!-- begin-user-doc --> This default
   ...
   * <em>Authenticate Type</em>}'. <!-- begin-user-doc --> This default
   * implementation returns null so that we can easily ignore cases; it's useful
   * to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
