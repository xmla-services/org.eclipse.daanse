 ...
 * '<em><b>Retention Modes</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum RetentionModes implements Enumerator {
  ...
  /**
   * The '<em><b>No Event Loss</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>No Event Loss</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #NO_EVENT_LOSS
   ...
   * @generated
   */
  private static final RetentionModes[] VALUES_ARRAY = new RetentionModes[] { ALLOW_SINGLE_EVENT_LOSS,
      ALLOW_MULTIPLE_EVENT_LOSS, NO_EVENT_LOSS, };

  /**
   * A public read-only list of all the '<em><b>Retention Modes</b></em>'
  ...
  /**
   * Returns the '<em><b>Retention Modes</b></em>' literal with the specified
  ...
  public static RetentionModes get(int value) {
    switch (value) {
    case ALLOW_SINGLE_EVENT_LOSS_VALUE:
      return ALLOW_SINGLE_EVENT_LOSS;
    case ALLOW_MULTIPLE_EVENT_LOSS_VALUE:
      return ALLOW_MULTIPLE_EVENT_LOSS;
    case NO_EVENT_LOSS_VALUE:
      return NO_EVENT_LOSS;
    }
    return null;
  }
