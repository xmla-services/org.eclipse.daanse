 ...
 * '<em><b>Axis Format</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum AxisFormat implements Enumerator {
  /**
   * The '<em><b>Cluster Format</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Custom Format</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Tuple Format</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Cluster Format</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #CLUSTER_FORMAT
  ...
  /**
   * The '<em><b>Custom Format</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #CUSTOM_FORMAT
  ...
  /**
   * The '<em><b>Tuple Format</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #TUPLE_FORMAT
   ...
   * @generated
   */
  private static final AxisFormat[] VALUES_ARRAY = new AxisFormat[] { CLUSTER_FORMAT, CUSTOM_FORMAT, TUPLE_FORMAT, };
  ...
  /**
   * Returns the '<em><b>Axis Format</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>Axis Format</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public static AxisFormat get(int value) {
    switch (value) {
    case CLUSTER_FORMAT_VALUE:
      return CLUSTER_FORMAT;
    case CUSTOM_FORMAT_VALUE:
      return CUSTOM_FORMAT;
    case TUPLE_FORMAT_VALUE:
      return TUPLE_FORMAT;
    }
    return null;
  }
