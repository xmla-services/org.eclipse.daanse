 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getImagePath
 * <em>Image Path</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getImageUniqueID
 * <em>Image Unique ID</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getImageUrl
 * <em>Image Url</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getImageVersion
 * <em>Image Version</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getProcessingRecommendation
 * <em>Processing Recommendation</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getProcessingState
 * <em>Processing State</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getShareDimensionStorage
 * <em>Share Dimension Storage</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getStorageEngineUsed
 * <em>Storage Engine Used</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200_200.impl.DocumentRootImpl#getToken
 * <em>Token</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getImageUniqueID() <em>Image Unique
  ...
  /**
   * The default value of the '{@link #getImageUrl() <em>Image Url</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getImageUrl()
   * @generated
  ...
  /**
   * The default value of the '{@link #getImageVersion() <em>Image Version</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getImageVersion()
   * @generated
  ...
  /**
   * The default value of the '{@link #getProcessingRecommendation()
  ...
  /**
   * The default value of the '{@link #getShareDimensionStorage() <em>Share
   * Dimension Storage</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The default value of the '{@link #getStorageEngineUsed() <em>Storage Engine
   * Used</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine200_200Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine200_200Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine200_200Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION)
              .getEType(),
          EStringToStringMapEntryImpl.class, this, Engine200_200Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setImageUniqueID(String newImageUniqueID) {
    ((FeatureMap.Internal) getMixed()).set(Engine200_200Package.Literals.DOCUMENT_ROOT__IMAGE_UNIQUE_ID,
        newImageUniqueID);
  }
  ...
  public ProcessingRecommendationType getProcessingRecommendation() {
    return (ProcessingRecommendationType) getMixed()
        .get(Engine200_200Package.Literals.DOCUMENT_ROOT__PROCESSING_RECOMMENDATION, true);
  }
  ...
  public void setProcessingRecommendation(ProcessingRecommendationType newProcessingRecommendation) {
    ((FeatureMap.Internal) getMixed()).set(Engine200_200Package.Literals.DOCUMENT_ROOT__PROCESSING_RECOMMENDATION,
        newProcessingRecommendation);
  }
  ...
  public void setProcessingState(ProcessingStateType newProcessingState) {
    ((FeatureMap.Internal) getMixed()).set(Engine200_200Package.Literals.DOCUMENT_ROOT__PROCESSING_STATE,
        newProcessingState);
  }
  ...
  public ShareDimensionStorageType getShareDimensionStorage() {
    return (ShareDimensionStorageType) getMixed()
        .get(Engine200_200Package.Literals.DOCUMENT_ROOT__SHARE_DIMENSION_STORAGE, true);
  }
  ...
  public void setShareDimensionStorage(ShareDimensionStorageType newShareDimensionStorage) {
    ((FeatureMap.Internal) getMixed()).set(Engine200_200Package.Literals.DOCUMENT_ROOT__SHARE_DIMENSION_STORAGE,
        newShareDimensionStorage);
  }
  ...
  public StorageEngineUsedType getStorageEngineUsed() {
    return (StorageEngineUsedType) getMixed().get(Engine200_200Package.Literals.DOCUMENT_ROOT__STORAGE_ENGINE_USED,
        true);
  }
  ...
  public void setStorageEngineUsed(StorageEngineUsedType newStorageEngineUsed) {
    ((FeatureMap.Internal) getMixed()).set(Engine200_200Package.Literals.DOCUMENT_ROOT__STORAGE_ENGINE_USED,
        newStorageEngineUsed);
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case Engine200_200Package.DOCUMENT_ROOT__IMAGE_UNIQUE_ID:
      return IMAGE_UNIQUE_ID_EDEFAULT == null ? getImageUniqueID() != null
          : !IMAGE_UNIQUE_ID_EDEFAULT.equals(getImageUniqueID());
    case Engine200_200Package.DOCUMENT_ROOT__IMAGE_URL:
      return IMAGE_URL_EDEFAULT == null ? getImageUrl() != null : !IMAGE_URL_EDEFAULT.equals(getImageUrl());
    case Engine200_200Package.DOCUMENT_ROOT__IMAGE_VERSION:
      return IMAGE_VERSION_EDEFAULT == null ? getImageVersion() != null
          : !IMAGE_VERSION_EDEFAULT.equals(getImageVersion());
    case Engine200_200Package.DOCUMENT_ROOT__PROCESSING_RECOMMENDATION:
