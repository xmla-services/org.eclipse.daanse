 ...
 * Tuple Type</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.msxmla.NormTupleType#getMemberRef
 * <em>Member Ref</em>}</li>
 * </ul>
 *
...
public interface NormTupleType extends EObject {
  /**
   * Returns the value of the '<em><b>Member Ref</b></em>' containment reference
   * list. The list contents are of type
   * {@link org.eclipse.daanse.xmla.model.ecore.msxmla.MemberRefType}. <!--
   ...
   * @model containment="true" extendedMetaData="kind='element' name='MemberRef'"
   * @generated
   */
