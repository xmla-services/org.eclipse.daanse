...
public class Engine200FactoryImpl extends EFactoryImpl implements Engine200Factory {
  ...
  public static Engine200Factory init() {
    try {
      Engine200Factory theEngine200Factory = (Engine200Factory) EPackage.Registry.INSTANCE
          .getEFactory(Engine200Package.eNS_URI);
  ...
  public EObject create(EClass eClass) {
    ...
    case Engine200Package.WARNING_COLUMN_TYPE:
      return createWarningColumnType();
    case Engine200Package.WARNING_LOCATION_OBJECT:
      return createWarningLocationObject();
    case Engine200Package.WARNING_MEASURE_TYPE:
      return createWarningMeasureType();
    default:
