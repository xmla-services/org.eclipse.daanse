 ...
 * '<em><b>Sort Direction Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
...
public enum SortDirectionType implements Enumerator {
   ...
   * @generated
   */
  private static final SortDirectionType[] VALUES_ARRAY = new SortDirectionType[] { DEFAULT, ASCENDING, DESCENDING, };

  /**
   * A public read-only list of all the '<em><b>Sort Direction Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Sort Direction Type</b></em>' literal with the specified
