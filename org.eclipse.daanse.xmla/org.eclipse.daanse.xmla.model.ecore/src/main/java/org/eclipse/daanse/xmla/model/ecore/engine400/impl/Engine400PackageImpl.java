...
public class Engine400PackageImpl extends EPackageImpl implements Engine400Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine400Package#eINSTANCE} when
  ...
  public static Engine400Package init() {
    if (isInited)
      return (Engine400Package) EPackage.Registry.INSTANCE.getEPackage(Engine400Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine400Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine400PackageImpl theEngine400Package = registeredEngine400Package instanceof Engine400PackageImpl
        ? (Engine400PackageImpl) registeredEngine400Package
        : new Engine400PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_DefaultCompatibilityLevel(), theXMLTypePackage.getLong(),
        "defaultCompatibilityLevel", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(getDocumentRoot_DefaultCompatibilityLevel(), source,
        new String[] { "kind", "element", "name", "DefaultCompatibilityLevel", "namespace", "##targetNamespace" });
  }
