...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Olap
 * Info</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoImpl#getCubeInfo
 * <em>Cube Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoImpl#getAxesInfo
 * <em>Axes Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.OlapInfoImpl#getCellInfo
 * <em>Cell Info</em>}</li>
 * </ul>
 *
 * @generated
...
public class OlapInfoImpl extends MinimalEObjectImpl.Container implements OlapInfo {
  /**
   * The cached value of the '{@link #getCubeInfo() <em>Cube Info</em>}'
  ...
  /**
   * The cached value of the '{@link #getAxesInfo() <em>Axes Info</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getAxesInfo()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getCellInfo() <em>Cell Info</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCellInfo()
   * @generated
  ...
  public NotificationChain basicSetCubeInfo(CubeInfo newCubeInfo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.OLAP_INFO__CUBE_INFO, oldCubeInfo, newCubeInfo);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setCubeInfo(CubeInfo newCubeInfo) {
    if (newCubeInfo != cubeInfo) {
      ...
      if (cubeInfo != null)
        msgs = ((InternalEObject) cubeInfo).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__CUBE_INFO, null, msgs);
      if (newCubeInfo != null)
        msgs = ((InternalEObject) newCubeInfo).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__CUBE_INFO, null, msgs);
      msgs = basicSetCubeInfo(newCubeInfo, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO__CUBE_INFO, newCubeInfo,
          newCubeInfo));
  }
  ...
  public NotificationChain basicSetAxesInfo(AxesInfo newAxesInfo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.OLAP_INFO__AXES_INFO, oldAxesInfo, newAxesInfo);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setAxesInfo(AxesInfo newAxesInfo) {
    if (newAxesInfo != axesInfo) {
      NotificationChain msgs = null;
      if (axesInfo != null)
        msgs = ((InternalEObject) axesInfo).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__AXES_INFO, null, msgs);
      if (newAxesInfo != null)
        msgs = ((InternalEObject) newAxesInfo).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__AXES_INFO, null, msgs);
      msgs = basicSetAxesInfo(newAxesInfo, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO__AXES_INFO, newAxesInfo,
          newAxesInfo));
  }
  ...
  public NotificationChain basicSetCellInfo(CellInfo newCellInfo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.OLAP_INFO__CELL_INFO, oldCellInfo, newCellInfo);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setCellInfo(CellInfo newCellInfo) {
    if (newCellInfo != cellInfo) {
      NotificationChain msgs = null;
      if (cellInfo != null)
        msgs = ((InternalEObject) cellInfo).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__CELL_INFO, null, msgs);
      if (newCellInfo != null)
        msgs = ((InternalEObject) newCellInfo).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.OLAP_INFO__CELL_INFO, null, msgs);
      msgs = basicSetCellInfo(newCellInfo, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.OLAP_INFO__CELL_INFO, newCellInfo,
          newCellInfo));
  }
