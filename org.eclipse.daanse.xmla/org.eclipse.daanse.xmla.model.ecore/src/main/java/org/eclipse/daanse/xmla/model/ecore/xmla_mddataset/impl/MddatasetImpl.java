 ...
 * '<em><b>Mddataset</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.MddatasetImpl#getOlapInfo
 * <em>Olap Info</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.MddatasetImpl#getAxes
 * <em>Axes</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.MddatasetImpl#getCellData
 * <em>Cell Data</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.MddatasetImpl#getException
 * <em>Exception</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.MddatasetImpl#getMessages
 * <em>Messages</em>}</li>
 * </ul>
 *
 * @generated
...
public class MddatasetImpl extends MinimalEObjectImpl.Container implements Mddataset {
  /**
   * The cached value of the '{@link #getOlapInfo() <em>Olap Info</em>}'
  ...
  /**
   * The cached value of the '{@link #getCellData() <em>Cell Data</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCellData()
   * @generated
  ...
  public NotificationChain basicSetOlapInfo(OlapInfo newOlapInfo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.MDDATASET__OLAP_INFO, oldOlapInfo, newOlapInfo);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setOlapInfo(OlapInfo newOlapInfo) {
    if (newOlapInfo != olapInfo) {
      ...
      if (olapInfo != null)
        msgs = ((InternalEObject) olapInfo).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__OLAP_INFO, null, msgs);
      if (newOlapInfo != null)
        msgs = ((InternalEObject) newOlapInfo).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__OLAP_INFO, null, msgs);
      msgs = basicSetOlapInfo(newOlapInfo, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.MDDATASET__OLAP_INFO, newOlapInfo,
          newOlapInfo));
  }
  ...
  public NotificationChain basicSetAxes(Axes newAxes, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.MDDATASET__AXES, oldAxes, newAxes);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setAxes(Axes newAxes) {
    if (newAxes != axes) {
      NotificationChain msgs = null;
      if (axes != null)
        msgs = ((InternalEObject) axes).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__AXES, null, msgs);
      if (newAxes != null)
        msgs = ((InternalEObject) newAxes).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__AXES, null, msgs);
  ...
  public NotificationChain basicSetCellData(CellData newCellData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.MDDATASET__CELL_DATA, oldCellData, newCellData);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setCellData(CellData newCellData) {
    if (newCellData != cellData) {
      NotificationChain msgs = null;
      if (cellData != null)
        msgs = ((InternalEObject) cellData).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__CELL_DATA, null, msgs);
      if (newCellData != null)
        msgs = ((InternalEObject) newCellData).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__CELL_DATA, null, msgs);
      msgs = basicSetCellData(newCellData, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.MDDATASET__CELL_DATA, newCellData,
          newCellData));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetException(org.eclipse.daanse.xmla.model.ecore.xmla_exception.Exception newException,
      NotificationChain msgs) {
    org.eclipse.daanse.xmla.model.ecore.xmla_exception.Exception oldException = exception;
    exception = newException;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.MDDATASET__EXCEPTION, oldException, newException);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newException != exception) {
      ...
      if (exception != null)
        msgs = ((InternalEObject) exception).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__EXCEPTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.MDDATASET__EXCEPTION, newException,
          newException));
  }
  ...
  public NotificationChain basicSetMessages(Messages newMessages, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.MDDATASET__MESSAGES, oldMessages, newMessages);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setMessages(Messages newMessages) {
    if (newMessages != messages) {
      NotificationChain msgs = null;
      if (messages != null)
        msgs = ((InternalEObject) messages).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__MESSAGES, null, msgs);
      if (newMessages != null)
        msgs = ((InternalEObject) newMessages).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.MDDATASET__MESSAGES, null, msgs);
      msgs = basicSetMessages(newMessages, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.MDDATASET__MESSAGES, newMessages,
          newMessages));
  }
