 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine400.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine400.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine400.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine400.impl.DocumentRootImpl#getDefaultCompatibilityLevel
 * <em>Default Compatibility Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getDefaultCompatibilityLevel() <em>Default
   * Compatibility Level</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine400Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine400Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(Engine400Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, Engine400Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setDefaultCompatibilityLevel(long newDefaultCompatibilityLevel) {
    ((FeatureMap.Internal) getMixed()).set(Engine400Package.Literals.DOCUMENT_ROOT__DEFAULT_COMPATIBILITY_LEVEL,
        newDefaultCompatibilityLevel);
  }
