 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getCalculationError
 * <em>Calculation Error</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getCompatibilityLevel
 * <em>Compatibility Level</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getWarningColumn
 * <em>Warning Column</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine200.DocumentRoot#getWarningMeasure
 * <em>Warning Measure</em>}</li>
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Calculation Error</b></em>' attribute. The
   ...
   *        name='CalculationError' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Calculation Error</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   *        extendedMetaData="kind='element' name='CompatibilityLevel'
   ...
   * <em>Compatibility Level</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Warning Column</b></em>' containment
   ...
   *        derived="true" extendedMetaData="kind='element' name='WarningColumn'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Warning Column</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Warning Column</em>' containment
   *              reference.
  ...
  /**
   * Returns the value of the '<em><b>Warning Measure</b></em>' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true"
   *        derived="true" extendedMetaData="kind='element' name='WarningMeasure'
   *        namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <em>Warning Measure</em>}' containment reference. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Warning Measure</em>' containment
   *              reference.
