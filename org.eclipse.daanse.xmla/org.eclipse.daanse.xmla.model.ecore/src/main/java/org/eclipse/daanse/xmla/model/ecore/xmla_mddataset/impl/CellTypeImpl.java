 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.CellTypeImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.CellTypeImpl#getAny
 * <em>Any</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.CellTypeImpl#getCellOrdinal
 * <em>Cell Ordinal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellTypeImpl extends MinimalEObjectImpl.Container implements CellType {
  ...
  /**
   * The default value of the '{@link #getCellOrdinal() <em>Cell Ordinal</em>}'
  ...
  /**
   * The cached value of the '{@link #getCellOrdinal() <em>Cell Ordinal</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCellOrdinal()
   * @generated
  ...
  /**
   * This is true if the Cell Ordinal attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  public NotificationChain basicSetValue(ValueType newValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_mddatasetPackage.CELL_TYPE__VALUE, oldValue, newValue);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newValue != value) {
      ...
      if (value != null)
        msgs = ((InternalEObject) value).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_mddatasetPackage.CELL_TYPE__VALUE, null, msgs);
      if (newValue != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.CELL_TYPE__VALUE, newValue, newValue));
  }
  ...
  public void setCellOrdinal(long newCellOrdinal) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_mddatasetPackage.CELL_TYPE__CELL_ORDINAL,
          oldCellOrdinal, cellOrdinal, !oldCellOrdinalESet));
  }
  ...
  public void unsetCellOrdinal() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Xmla_mddatasetPackage.CELL_TYPE__CELL_ORDINAL,
          oldCellOrdinal, CELL_ORDINAL_EDEFAULT, oldCellOrdinalESet));
  }
