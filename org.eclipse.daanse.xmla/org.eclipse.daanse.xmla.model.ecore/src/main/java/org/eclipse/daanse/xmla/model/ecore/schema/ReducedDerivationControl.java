 ...
 * '<em><b>Reduced Derivation Control</b></em>', and utility methods for working
...
public enum ReducedDerivationControl implements Enumerator {
   ...
   * @generated
   */
  private static final ReducedDerivationControl[] VALUES_ARRAY = new ReducedDerivationControl[] { EXTENSION,
      RESTRICTION, };

  /**
   * A public read-only list of all the '<em><b>Reduced Derivation
   * Control</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Reduced Derivation Control</b></em>' literal with the
