 ...
 * '<em><b>Use Type</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
...
public enum UseType implements Enumerator {
  /**
   * The '<em><b>Prohibited</b></em>' literal object. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Prohibited</b></em>' literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #PROHIBITED
   ...
   * @generated
   */
  private static final UseType[] VALUES_ARRAY = new UseType[] { PROHIBITED, OPTIONAL, REQUIRED, };
  ...
  /**
   * Returns the '<em><b>Use Type</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>Use Type</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
