 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getSimpleContent
 * <em>Simple Content</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getComplexContent
 * <em>Complex Content</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getGroup
 * <em>Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getAll
 * <em>All</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getChoice
 * <em>Choice</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getSequence
 * <em>Sequence</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getGroup1
 * <em>Group1</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getAttribute
 * <em>Attribute</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getAttributeGroup
 * <em>Attribute Group</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getAnyAttribute1
 * <em>Any Attribute1</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#isAbstract
 * <em>Abstract</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getBlock
 * <em>Block</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getFinal
 * <em>Final</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#isMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.schema.impl.ComplexTypeImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class ComplexTypeImpl extends AnnotatedImpl implements ComplexType {
  /**
   * The cached value of the '{@link #getSimpleContent() <em>Simple Content</em>}'
  ...
  /**
   * The cached value of the '{@link #getComplexContent() <em>Complex
   * Content</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getAll() <em>All</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getAll()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getChoice() <em>Choice</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getChoice()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getAnyAttribute1() <em>Any Attribute1</em>}'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * This is true if the Mixed attribute has been set. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  public NotificationChain basicSetSimpleContent(SimpleContentType newSimpleContent, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_TYPE__SIMPLE_CONTENT, oldSimpleContent, newSimpleContent);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setSimpleContent(SimpleContentType newSimpleContent) {
    if (newSimpleContent != simpleContent) {
      ...
      if (simpleContent != null)
        msgs = ((InternalEObject) simpleContent).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__SIMPLE_CONTENT, null, msgs);
      if (newSimpleContent != null)
        msgs = ((InternalEObject) newSimpleContent).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__SIMPLE_CONTENT, null, msgs);
      msgs = basicSetSimpleContent(newSimpleContent, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__SIMPLE_CONTENT,
          newSimpleContent, newSimpleContent));
  }
  ...
  public NotificationChain basicSetComplexContent(ComplexContentType newComplexContent, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_TYPE__COMPLEX_CONTENT, oldComplexContent, newComplexContent);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setComplexContent(ComplexContentType newComplexContent) {
    if (newComplexContent != complexContent) {
      ...
      if (complexContent != null)
        msgs = ((InternalEObject) complexContent).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__COMPLEX_CONTENT, null, msgs);
      if (newComplexContent != null)
        msgs = ((InternalEObject) newComplexContent).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__COMPLEX_CONTENT, null, msgs);
      msgs = basicSetComplexContent(newComplexContent, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__COMPLEX_CONTENT,
          newComplexContent, newComplexContent));
  }
  ...
  public NotificationChain basicSetGroup(GroupRef newGroup, NotificationChain msgs) {
    ...
    group = newGroup;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__GROUP,
          oldGroup, newGroup);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newGroup != group) {
      ...
      if (group != null)
        msgs = ((InternalEObject) group).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__GROUP, null, msgs);
      if (newGroup != null)
  ...
  public NotificationChain basicSetAll(All newAll, NotificationChain msgs) {
    ...
    all = newAll;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__ALL,
          oldAll, newAll);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setAll(All newAll) {
    if (newAll != all) {
      NotificationChain msgs = null;
      if (all != null)
        msgs = ((InternalEObject) all).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__ALL,
            null, msgs);
      if (newAll != null)
        msgs = ((InternalEObject) newAll).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__ALL,
            null, msgs);
  ...
  public NotificationChain basicSetChoice(ExplicitGroup newChoice, NotificationChain msgs) {
    ...
    choice = newChoice;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__CHOICE,
          oldChoice, newChoice);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newChoice != choice) {
      ...
      if (choice != null)
        msgs = ((InternalEObject) choice).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__CHOICE, null, msgs);
      if (newChoice != null)
  ...
  public NotificationChain basicSetSequence(ExplicitGroup newSequence, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_TYPE__SEQUENCE, oldSequence, newSequence);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newSequence != sequence) {
      ...
      if (sequence != null)
        msgs = ((InternalEObject) sequence).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__SEQUENCE, null, msgs);
      if (newSequence != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__SEQUENCE, newSequence,
          newSequence));
  }
  ...
  public NotificationChain basicSetAnyAttribute1(Wildcard newAnyAttribute1, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SchemaPackage.COMPLEX_TYPE__ANY_ATTRIBUTE1, oldAnyAttribute1, newAnyAttribute1);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setAnyAttribute1(Wildcard newAnyAttribute1) {
    if (newAnyAttribute1 != anyAttribute1) {
      ...
      if (anyAttribute1 != null)
        msgs = ((InternalEObject) anyAttribute1).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__ANY_ATTRIBUTE1, null, msgs);
      if (newAnyAttribute1 != null)
        msgs = ((InternalEObject) newAnyAttribute1).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__ANY_ATTRIBUTE1, null, msgs);
      msgs = basicSetAnyAttribute1(newAnyAttribute1, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__ANY_ATTRIBUTE1,
          newAnyAttribute1, newAnyAttribute1));
  }
  ...
  public void setAbstract(boolean newAbstract) {
    ...
    abstractESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__ABSTRACT, oldAbstract,
          abstract_, !oldAbstractESet));
  }
  ...
  public void unsetAbstract() {
    ...
    abstractESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.COMPLEX_TYPE__ABSTRACT, oldAbstract,
  ...
  public void setMixed(boolean newMixed) {
    ...
    mixedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__MIXED, oldMixed, mixed,
          !oldMixedESet));
  }
  ...
  public void unsetMixed() {
    ...
    mixedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.COMPLEX_TYPE__MIXED, oldMixed,
          MIXED_EDEFAULT, oldMixedESet));
  }
