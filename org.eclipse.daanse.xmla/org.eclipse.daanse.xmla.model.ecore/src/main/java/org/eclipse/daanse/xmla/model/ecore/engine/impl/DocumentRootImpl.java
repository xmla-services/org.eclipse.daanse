 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl#getLastDataUpdate
 * <em>Last Data Update</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine.impl.DocumentRootImpl#getLastSchemaUpdate
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(EnginePackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(),
          EStringToStringMapEntryImpl.class, this, EnginePackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          (EClass) eStaticClass().getEStructuralFeature(EnginePackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(),
          EStringToStringMapEntryImpl.class, this, EnginePackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public void setLastSchemaUpdate(XMLGregorianCalendar newLastSchemaUpdate) {
    ((FeatureMap.Internal) getMixed()).set(EnginePackage.Literals.DOCUMENT_ROOT__LAST_SCHEMA_UPDATE,
        newLastSchemaUpdate);
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case EnginePackage.DOCUMENT_ROOT__LAST_DATA_UPDATE:
      return LAST_DATA_UPDATE_EDEFAULT == null ? getLastDataUpdate() != null
          : !LAST_DATA_UPDATE_EDEFAULT.equals(getLastDataUpdate());
    case EnginePackage.DOCUMENT_ROOT__LAST_SCHEMA_UPDATE:
      return LAST_SCHEMA_UPDATE_EDEFAULT == null ? getLastSchemaUpdate() != null
          : !LAST_SCHEMA_UPDATE_EDEFAULT.equals(getLastSchemaUpdate());
    }
