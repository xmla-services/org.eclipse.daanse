...
public class Engine100PackageImpl extends EPackageImpl implements Engine100Package {
   ...
   *
   * <p>
   * This method is used to initialize {@link Engine100Package#eINSTANCE} when
  ...
  public static Engine100Package init() {
    if (isInited)
      return (Engine100Package) EPackage.Registry.INSTANCE.getEPackage(Engine100Package.eNS_URI);

    // Obtain or create and register package
    Object registeredEngine100Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Engine100PackageImpl theEngine100Package = registeredEngine100Package instanceof Engine100PackageImpl
        ? (Engine100PackageImpl) registeredEngine100Package
        : new Engine100PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_DbStorageLocation(), theXMLTypePackage.getString(), "dbStorageLocation", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_HoldoutActualSize(), theXMLTypePackage.getInt(), "holdoutActualSize", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_HoldoutMaxCases(), theXMLTypePackage.getInt(), "holdoutMaxCases", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_HoldoutMaxPercent(), theXMLTypePackage.getInt(), "holdoutMaxPercent", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_HoldoutSeed(), theXMLTypePackage.getInt(), "holdoutSeed", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_ReadWriteMode(), this.getReadWriteModeType(), "readWriteMode", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(readWriteModeTypeObjectEDataType, ReadWriteModeType.class, "ReadWriteModeTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(getDocumentRoot_DbStorageLocation(), source,
        new String[] { "kind", "element", "name", "DbStorageLocation", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_HoldoutActualSize(), source,
        new String[] { "kind", "element", "name", "HoldoutActualSize", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_HoldoutMaxCases(), source,
        new String[] { "kind", "element", "name", "HoldoutMaxCases", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_HoldoutMaxPercent(), source,
        new String[] { "kind", "element", "name", "HoldoutMaxPercent", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_HoldoutSeed(), source,
        new String[] { "kind", "element", "name", "HoldoutSeed", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ReadWriteMode(), source,
        new String[] { "kind", "element", "name", "ReadWriteMode", "namespace", "##targetNamespace" });
    addAnnotation(readWriteModeTypeEEnum, source, new String[] { "name", "ReadWriteMode_._type" });
    addAnnotation(readWriteModeTypeObjectEDataType, source,
        new String[] { "name", "ReadWriteMode_._type:Object", "baseType", "ReadWriteMode_._type" });
  }
