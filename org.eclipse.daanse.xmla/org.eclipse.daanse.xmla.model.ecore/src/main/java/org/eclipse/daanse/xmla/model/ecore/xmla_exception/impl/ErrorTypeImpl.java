 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getLocation
 * <em>Location</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getCallstack
 * <em>Callstack</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getErrorCode
 * <em>Error Code</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getHelpFile
 * <em>Help File</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_exception.impl.ErrorTypeImpl#getSource
 * <em>Source</em>}</li>
 * </ul>
 *
 * @generated
...
public class ErrorTypeImpl extends MinimalEObjectImpl.Container implements ErrorType {
  ...
  /**
   * The default value of the '{@link #getCallstack() <em>Callstack</em>}'
  ...
  /**
   * The cached value of the '{@link #getCallstack() <em>Callstack</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getCallstack()
   * @generated
  ...
  /**
   * The default value of the '{@link #getErrorCode() <em>Error Code</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getErrorCode()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getErrorCode() <em>Error Code</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getErrorCode()
   * @generated
  ...
  /**
   * This is true if the Error Code attribute has been set. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #getHelpFile() <em>Help File</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getHelpFile()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getHelpFile() <em>Help File</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getHelpFile()
   * @generated
  ...
  public NotificationChain basicSetLocation(MessageLocation newLocation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Xmla_exceptionPackage.ERROR_TYPE__LOCATION, oldLocation, newLocation);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newLocation != location) {
      ...
      if (location != null)
        msgs = ((InternalEObject) location).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Xmla_exceptionPackage.ERROR_TYPE__LOCATION, null, msgs);
      if (newLocation != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__LOCATION, newLocation,
          newLocation));
  }
  ...
  public void setCallstack(String newCallstack) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__CALLSTACK, oldCallstack,
          callstack));
  }
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__DESCRIPTION,
  ...
  public void setErrorCode(long newErrorCode) {
    ...
    errorCodeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__ERROR_CODE, oldErrorCode,
          errorCode, !oldErrorCodeESet));
  }
  ...
  public void unsetErrorCode() {
    ...
    errorCodeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Xmla_exceptionPackage.ERROR_TYPE__ERROR_CODE,
          oldErrorCode, ERROR_CODE_EDEFAULT, oldErrorCodeESet));
  }
  ...
  public void setHelpFile(String newHelpFile) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__HELP_FILE, oldHelpFile,
          helpFile));
  }
  ...
  public void setSource(String newSource) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, Xmla_exceptionPackage.ERROR_TYPE__SOURCE, oldSource, source));
  }
