 ...
 * '<em><b>Direct Query Usage Type</b></em>', and utility methods for working
...
public enum DirectQueryUsageType implements Enumerator {
  ...
  /**
   * The '<em><b>Direct Query Only</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>In Memory Only</b></em>' literal object. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Direct Query Only</b></em>' literal value. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>In Memory Only</b></em>' literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #IN_MEMORY_ONLY
   ...
   * @generated
   */
  private static final DirectQueryUsageType[] VALUES_ARRAY = new DirectQueryUsageType[] { IN_MEMORY_WITH_DIRECT_QUERY,
      DIRECT_QUERY_ONLY, IN_MEMORY_ONLY, };

  /**
   * A public read-only list of all the '<em><b>Direct Query Usage Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Direct Query Usage Type</b></em>' literal with the
  ...
  public static DirectQueryUsageType get(int value) {
    ...
    case DIRECT_QUERY_ONLY_VALUE:
      return DIRECT_QUERY_ONLY;
    case IN_MEMORY_ONLY_VALUE:
