 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getRole
 * <em>Role</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getMultiplicity
 * <em>Multiplicity</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getDimensionID
 * <em>Dimension ID</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getAttributes
 * <em>Attributes</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getTranslations
 * <em>Translations</em>}</li>
 * <li>{@link org.eclipse.daanse.xmla.model.ecore.engine300_300.RelationshipEnd#getVisualizationProperties
...
public interface RelationshipEnd extends EObject {
   ...
   * <em>Role</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Dimension ID</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Attributes'"
   * @generated
   */
   ...
   * <em>Attributes</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Attributes</em>' containment
   *              reference.
   * @see #getAttributes()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Translations</b></em>' containment
   ...
   * <em>Translations</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value the new value of the '<em>Translations</em>' containment
   *              reference.
   * @see #getTranslations()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Visualization Properties</b></em>'
   * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the value of the '<em>Visualization Properties</em>' containment
   *         reference.
   ...
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Visualization Properties</em>'
