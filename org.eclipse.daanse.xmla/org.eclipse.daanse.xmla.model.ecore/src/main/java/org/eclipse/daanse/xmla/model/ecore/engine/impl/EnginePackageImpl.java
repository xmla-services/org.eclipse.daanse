...
public class EnginePackageImpl extends EPackageImpl implements EnginePackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link EnginePackage#eINSTANCE} when that
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDocumentRoot_LastDataUpdate(), theXMLTypePackage.getDateTime(), "lastDataUpdate", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_LastSchemaUpdate(), theXMLTypePackage.getDateTime(), "lastSchemaUpdate", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(impersonationInfoEClass, ImpersonationInfo.class, "ImpersonationInfo", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getImpersonationInfo_ImpersonationMode(), this.getImpersonationModeType(), "impersonationMode", null,
        1, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getImpersonationInfo_Account(), theXMLTypePackage.getString(), "account", null, 0, 1,
        ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getImpersonationInfo_Password(), theXMLTypePackage.getString(), "password", null, 0, 1,
        ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getImpersonationInfo_ImpersonationInfoSecurity(), this.getImpersonationInfoSecurityType(),
        "impersonationInfoSecurity", null, 0, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
    ...
    initEDataType(impersonationInfoSecurityTypeObjectEDataType, ImpersonationInfoSecurityType.class,
        "ImpersonationInfoSecurityTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(impersonationModeTypeObjectEDataType, ImpersonationModeType.class, "ImpersonationModeTypeObject",
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(getDocumentRoot_LastDataUpdate(), source,
        new String[] { "kind", "element", "name", "LastDataUpdate", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_LastSchemaUpdate(), source,
        new String[] { "kind", "element", "name", "LastSchemaUpdate", "namespace", "##targetNamespace" });
    addAnnotation(impersonationInfoEClass, source, new String[] { "name", "ImpersonationInfo", "kind", "elementOnly" });
    addAnnotation(getImpersonationInfo_ImpersonationMode(), source,
        new String[] { "kind", "element", "name", "ImpersonationMode" });
    addAnnotation(getImpersonationInfo_Account(), source, new String[] { "kind", "element", "name", "Account" });
    addAnnotation(getImpersonationInfo_Password(), source, new String[] { "kind", "element", "name", "Password" });
    addAnnotation(getImpersonationInfo_ImpersonationInfoSecurity(), source,
        new String[] { "kind", "element", "name", "ImpersonationInfoSecurity" });
    addAnnotation(impersonationInfoSecurityTypeEEnum, source,
        new String[] { "name", "ImpersonationInfoSecurity_._type" });
    addAnnotation(impersonationInfoSecurityTypeObjectEDataType, source, new String[] { "name",
        "ImpersonationInfoSecurity_._type:Object", "baseType", "ImpersonationInfoSecurity_._type" });
    addAnnotation(impersonationModeTypeEEnum, source, new String[] { "name", "ImpersonationMode_._type" });
    addAnnotation(impersonationModeTypeObjectEDataType, source,
        new String[] { "name", "ImpersonationMode_._type:Object", "baseType", "ImpersonationMode_._type" });
  }
