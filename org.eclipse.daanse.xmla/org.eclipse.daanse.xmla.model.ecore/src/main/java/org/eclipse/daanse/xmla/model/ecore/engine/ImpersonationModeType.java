 ...
 * '<em><b>Impersonation Mode Type</b></em>', and utility methods for working
...
public enum ImpersonationModeType implements Enumerator {
  ...
  /**
   * The '<em><b>Impersonate Account</b></em>' literal object. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>Impersonate Account</b></em>' literal value. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   ...
   * @generated
   */
  private static final ImpersonationModeType[] VALUES_ARRAY = new ImpersonationModeType[] { DEFAULT,
      IMPERSONATE_SERVICE_ACCOUNT, IMPERSONATE_ANONYMOUS, IMPERSONATE_CURRENT_USER, IMPERSONATE_ACCOUNT, };

  /**
   * A public read-only list of all the '<em><b>Impersonation Mode Type</b></em>'
  ...
  /**
   * Returns the '<em><b>Impersonation Mode Type</b></em>' literal with the
  ...
  public static ImpersonationModeType get(int value) {
    ...
    case DEFAULT_VALUE:
      return DEFAULT;
    case IMPERSONATE_SERVICE_ACCOUNT_VALUE:
      return IMPERSONATE_SERVICE_ACCOUNT;
    case IMPERSONATE_ANONYMOUS_VALUE:
      return IMPERSONATE_ANONYMOUS;
    case IMPERSONATE_CURRENT_USER_VALUE:
      return IMPERSONATE_CURRENT_USER;
    case IMPERSONATE_ACCOUNT_VALUE:
      return IMPERSONATE_ACCOUNT;
    }
    return null;
  }
