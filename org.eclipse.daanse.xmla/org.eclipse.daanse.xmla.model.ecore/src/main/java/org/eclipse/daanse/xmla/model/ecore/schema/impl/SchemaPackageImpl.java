...
public class SchemaPackageImpl extends EPackageImpl implements SchemaPackage {
  ...
  public static SchemaPackage init() {
    ...
    Engine2PackageImpl theEngine2Package = (Engine2PackageImpl) (registeredPackage instanceof Engine2PackageImpl
        ? registeredPackage
        : Engine2Package.eINSTANCE);
  ...
  public void initializePackageContents() {
    ...
    initEReference(getAnnotated_Annotation(), this.getAnnotationType(), null, "annotation", null, 0, 1, Annotated.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnnotated_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Annotated.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(annotationTypeEClass, AnnotationType.class, "AnnotationType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAnnotationType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        AnnotationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotationType_Appinfo(), this.getAppinfoType(), null, "appinfo", null, 0, -1,
        AnnotationType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotationType_Documentation(), this.getDocumentationType(), null, "documentation", null, 0, -1,
        AnnotationType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnnotationType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, AnnotationType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(anyTypeEClass, AnyType.class, "AnyType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAnyType_MaxOccurs(), this.getAllNNI(), "maxOccurs", "1", 0, 1, AnyType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnyType_MinOccurs(), theXMLTypePackage.getNonNegativeInteger(), "minOccurs", "1", 0, 1,
        AnyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(appinfoTypeEClass, AppinfoType.class, "AppinfoType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAppinfoType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, AppinfoType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAppinfoType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, AppinfoType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAppinfoType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, AppinfoType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAppinfoType_Source(), theXMLTypePackage.getAnyURI(), "source", null, 0, 1, AppinfoType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAppinfoType_AnyAttribute(), ecorePackage.getEFeatureMapEntry(), "anyAttribute", null, 0, -1,
        AppinfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(attributeEClass, Attribute.class, "Attribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAttribute_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, 1,
        Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Default(), theXMLTypePackage.getString(), "default", null, 0, 1, Attribute.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Fixed(), theXMLTypePackage.getString(), "fixed", null, 0, 1, Attribute.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Form(), this.getFormChoice(), "form", null, 0, 1, Attribute.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, Attribute.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Ref(), theXMLTypePackage.getQName(), "ref", null, 0, 1, Attribute.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Type(), theXMLTypePackage.getQName(), "type", null, 0, 1, Attribute.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttribute_Use(), this.getUseType(), "use", "optional", 0, 1, Attribute.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributeGroupEClass, AttributeGroup.class, "AttributeGroup", IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAttributeGroup_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        AttributeGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getAttributeGroup_Attribute(), this.getAttribute(), null, "attribute", null, 0, -1,
        AttributeGroup.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getAttributeGroup_AttributeGroup(), this.getAttributeGroupRef(), null, "attributeGroup", null, 0, -1,
        AttributeGroup.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getAttributeGroup_AnyAttribute1(), this.getWildcard(), null, "anyAttribute1", null, 0, 1,
        AttributeGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeGroup_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, AttributeGroup.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeGroup_Ref(), theXMLTypePackage.getQName(), "ref", null, 0, 1, AttributeGroup.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributeGroupRefEClass, AttributeGroupRef.class, "AttributeGroupRef", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(complexContentTypeEClass, ComplexContentType.class, "ComplexContentType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getComplexContentType_Restriction(), this.getComplexRestrictionType(), null, "restriction", null, 0,
        1, ComplexContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComplexContentType_Extension(), this.getExtensionType(), null, "extension", null, 0, 1,
        ComplexContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexContentType_Mixed(), theXMLTypePackage.getBoolean(), "mixed", null, 0, 1,
        ComplexContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(complexRestrictionTypeEClass, ComplexRestrictionType.class, "ComplexRestrictionType", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(complexTypeEClass, ComplexType.class, "ComplexType", IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getComplexType_SimpleContent(), this.getSimpleContentType(), null, "simpleContent", null, 0, 1,
        ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_ComplexContent(), this.getComplexContentType(), null, "complexContent", null, 0, 1,
        ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_Group(), this.getGroupRef(), null, "group", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_All(), this.getAll(), null, "all", null, 0, 1, ComplexType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getComplexType_Choice(), this.getExplicitGroup(), null, "choice", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_Sequence(), this.getExplicitGroup(), null, "sequence", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexType_Group1(), ecorePackage.getEFeatureMapEntry(), "group1", null, 0, -1,
        ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getComplexType_Attribute(), this.getAttribute(), null, "attribute", null, 0, -1, ComplexType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_AttributeGroup(), this.getAttributeGroupRef(), null, "attributeGroup", null, 0, -1,
        ComplexType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getComplexType_AnyAttribute1(), this.getWildcard(), null, "anyAttribute1", null, 0, 1,
        ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexType_Abstract(), theXMLTypePackage.getBoolean(), "abstract", "false", 0, 1,
        ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getComplexType_Block(), this.getDerivationSet(), "block", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexType_Final(), this.getDerivationSet(), "final", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexType_Mixed(), theXMLTypePackage.getBoolean(), "mixed", "false", 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getComplexType_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, ComplexType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(documentationTypeEClass, DocumentationType.class, "DocumentationType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDocumentationType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1,
        DocumentationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentationType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        DocumentationType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentationType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1,
        DocumentationType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentationType_Lang(), theXMLNamespacePackage.getLangType(), "lang", null, 0, 1,
        DocumentationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentationType_Source(), theXMLTypePackage.getAnyURI(), "source", null, 0, 1,
        DocumentationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentationType_AnyAttribute(), ecorePackage.getEFeatureMapEntry(), "anyAttribute", null, 0, -1,
        DocumentationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_All(), this.getAll(), null, "all", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Annotation(), this.getAnnotationType(), null, "annotation", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Any(), this.getAnyType(), null, "any", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_AnyAttribute(), this.getWildcard(), null, "anyAttribute", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Appinfo(), this.getAppinfoType(), null, "appinfo", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Attribute(), this.getTopLevelAttribute(), null, "attribute", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_AttributeGroup(), this.getNamedAttributeGroup(), null, "attributeGroup", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Choice(), this.getExplicitGroup(), null, "choice", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_ComplexContent(), this.getComplexContentType(), null, "complexContent", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_ComplexType(), this.getTopLevelComplexType(), null, "complexType", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Documentation(), this.getDocumentationType(), null, "documentation", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Element(), this.getTopLevelElement(), null, "element", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Enumeration(), this.getNoFixedFacet(), null, "enumeration", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Field(), this.getFieldType(), null, "field", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_FractionDigits(), this.getNumFacet(), null, "fractionDigits", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Group(), this.getNamedGroup(), null, "group", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Import(), this.getImportType(), null, "import", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Include(), this.getIncludeType(), null, "include", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Key(), this.getKeybase(), null, "key", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Keyref(), this.getKeyrefType(), null, "keyref", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Length(), this.getNumFacet(), null, "length", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_List(), this.getListType(), null, "list", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_MaxExclusive(), this.getFacet(), null, "maxExclusive", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_MaxInclusive(), this.getFacet(), null, "maxInclusive", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_MaxLength(), this.getNumFacet(), null, "maxLength", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_MinExclusive(), this.getFacet(), null, "minExclusive", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_MinInclusive(), this.getFacet(), null, "minInclusive", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_MinLength(), this.getNumFacet(), null, "minLength", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Notation(), this.getNotationType(), null, "notation", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Pattern(), this.getPatternType(), null, "pattern", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Redefine(), this.getRedefineType(), null, "redefine", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Restriction(), this.getRestrictionType1(), null, "restriction", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Schema(), this.getSchemaType(), null, "schema", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Selector(), this.getSelectorType(), null, "selector", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Sequence(), this.getExplicitGroup(), null, "sequence", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_SimpleContent(), this.getSimpleContentType(), null, "simpleContent", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_SimpleType(), this.getTopLevelSimpleType(), null, "simpleType", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_TotalDigits(), this.getTotalDigitsType(), null, "totalDigits", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Union(), this.getUnionType(), null, "union", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_Unique(), this.getKeybase(), null, "unique", null, 0, -2, null, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getDocumentRoot_WhiteSpace(), this.getWhiteSpaceType(), null, "whiteSpace", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);

    initEClass(elementEClass, Element.class, "Element", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getElement_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, 1, Element.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getElement_ComplexType(), this.getLocalComplexType(), null, "complexType", null, 0, 1, Element.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_IdentityConstraint(), ecorePackage.getEFeatureMapEntry(), "identityConstraint", null, 0,
        -1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getElement_Unique(), this.getKeybase(), null, "unique", null, 0, -1, Element.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getElement_Key(), this.getKeybase(), null, "key", null, 0, -1, Element.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getElement_Keyref(), this.getKeyrefType(), null, "keyref", null, 0, -1, Element.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getElement_Abstract(), theXMLTypePackage.getBoolean(), "abstract", "false", 0, 1, Element.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Block(), this.getBlockSet(), "block", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Default(), theXMLTypePackage.getString(), "default", null, 0, 1, Element.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Final(), this.getDerivationSet(), "final", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Fixed(), theXMLTypePackage.getString(), "fixed", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Form(), this.getFormChoice(), "form", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_MaxOccurs(), this.getAllNNI(), "maxOccurs", "1", 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_MinOccurs(), theXMLTypePackage.getNonNegativeInteger(), "minOccurs", "1", 0, 1,
        Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getElement_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Nillable(), theXMLTypePackage.getBoolean(), "nillable", "false", 0, 1, Element.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_Ref(), theXMLTypePackage.getQName(), "ref", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElement_SubstitutionGroup(), theXMLTypePackage.getQName(), "substitutionGroup", null, 0, 1,
        Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getElement_Type(), theXMLTypePackage.getQName(), "type", null, 0, 1, Element.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(explicitGroupEClass, ExplicitGroup.class, "ExplicitGroup", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(extensionTypeEClass, ExtensionType.class, "ExtensionType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getExtensionType_Group(), this.getGroupRef(), null, "group", null, 0, 1, ExtensionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getExtensionType_All(), this.getAll(), null, "all", null, 0, 1, ExtensionType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getExtensionType_Choice(), this.getExplicitGroup(), null, "choice", null, 0, 1, ExtensionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getExtensionType_Sequence(), this.getExplicitGroup(), null, "sequence", null, 0, 1,
        ExtensionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExtensionType_Group1(), ecorePackage.getEFeatureMapEntry(), "group1", null, 0, -1,
        ExtensionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getExtensionType_Attribute(), this.getAttribute(), null, "attribute", null, 0, -1,
        ExtensionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getExtensionType_AttributeGroup(), this.getAttributeGroupRef(), null, "attributeGroup", null, 0, -1,
        ExtensionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getExtensionType_AnyAttribute1(), this.getWildcard(), null, "anyAttribute1", null, 0, 1,
        ExtensionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExtensionType_Base(), theXMLTypePackage.getQName(), "base", null, 1, 1, ExtensionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(facetEClass, Facet.class, "Facet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFacet_Fixed(), theXMLTypePackage.getBoolean(), "fixed", "false", 0, 1, Facet.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFacet_Value(), theXMLTypePackage.getAnySimpleType(), "value", null, 1, 1, Facet.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(fieldTypeEClass, FieldType.class, "FieldType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFieldType_Xpath(), this.getXpathType(), "xpath", null, 1, 1, FieldType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(groupEClass, Group.class, "Group", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getGroup_Particle(), ecorePackage.getEFeatureMapEntry(), "particle", null, 0, -1, Group.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGroup_Element(), this.getLocalElement(), null, "element", null, 0, -1, Group.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getGroup_Group(), this.getGroupRef(), null, "group", null, 0, -1, Group.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getGroup_All(), this.getAll(), null, "all", null, 0, -1, Group.class, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getGroup_Choice(), this.getExplicitGroup(), null, "choice", null, 0, -1, Group.class, IS_TRANSIENT,
        IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
        IS_ORDERED);
    initEReference(getGroup_Sequence(), this.getExplicitGroup(), null, "sequence", null, 0, -1, Group.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getGroup_Any(), this.getAnyType(), null, "any", null, 0, -1, Group.class, IS_TRANSIENT, IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getGroup_MaxOccurs(), this.getAllNNI(), "maxOccurs", "1", 0, 1, Group.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGroup_MinOccurs(), theXMLTypePackage.getNonNegativeInteger(), "minOccurs", "1", 0, 1, Group.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGroup_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, Group.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGroup_Ref(), theXMLTypePackage.getQName(), "ref", null, 0, 1, Group.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(groupRefEClass, GroupRef.class, "GroupRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(importTypeEClass, ImportType.class, "ImportType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getImportType_Namespace(), theXMLTypePackage.getAnyURI(), "namespace", null, 0, 1, ImportType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getImportType_SchemaLocation(), theXMLTypePackage.getAnyURI(), "schemaLocation", null, 0, 1,
        ImportType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(includeTypeEClass, IncludeType.class, "IncludeType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getIncludeType_SchemaLocation(), theXMLTypePackage.getAnyURI(), "schemaLocation", null, 1, 1,
        IncludeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(keybaseEClass, Keybase.class, "Keybase", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getKeybase_Selector(), this.getSelectorType(), null, "selector", null, 1, 1, Keybase.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getKeybase_Field(), this.getFieldType(), null, "field", null, 1, -1, Keybase.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getKeybase_Name(), theXMLTypePackage.getNCName(), "name", null, 1, 1, Keybase.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(keyrefTypeEClass, KeyrefType.class, "KeyrefType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getKeyrefType_Refer(), theXMLTypePackage.getQName(), "refer", null, 1, 1, KeyrefType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(listTypeEClass, ListType.class, "ListType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getListType_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, 1, ListType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getListType_ItemType(), theXMLTypePackage.getQName(), "itemType", null, 0, 1, ListType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(localComplexTypeEClass, LocalComplexType.class, "LocalComplexType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(localElementEClass, LocalElement.class, "LocalElement", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(localSimpleTypeEClass, LocalSimpleType.class, "LocalSimpleType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(namedAttributeGroupEClass, NamedAttributeGroup.class, "NamedAttributeGroup", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(namedGroupEClass, NamedGroup.class, "NamedGroup", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(narrowMaxMinEClass, NarrowMaxMin.class, "NarrowMaxMin", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(noFixedFacetEClass, NoFixedFacet.class, "NoFixedFacet", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(notationTypeEClass, NotationType.class, "NotationType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNotationType_Name(), theXMLTypePackage.getNCName(), "name", null, 1, 1, NotationType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNotationType_Public(), this.getPublic(), "public", null, 0, 1, NotationType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNotationType_System(), theXMLTypePackage.getAnyURI(), "system", null, 0, 1, NotationType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getOpenAttrs_AnyAttribute(), ecorePackage.getEFeatureMapEntry(), "anyAttribute", null, 0, -1,
        OpenAttrs.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(patternTypeEClass, PatternType.class, "PatternType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(realGroupEClass, RealGroup.class, "RealGroup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRealGroup_All1(), this.getAll(), null, "all1", null, 0, 1, RealGroup.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getRealGroup_Choice1(), this.getExplicitGroup(), null, "choice1", null, 0, 1, RealGroup.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRealGroup_Sequence1(), this.getExplicitGroup(), null, "sequence1", null, 0, 1, RealGroup.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);

    initEClass(redefineTypeEClass, RedefineType.class, "RedefineType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRedefineType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        RedefineType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getRedefineType_Annotation(), this.getAnnotationType(), null, "annotation", null, 0, -1,
        RedefineType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRedefineType_SimpleType(), this.getTopLevelSimpleType(), null, "simpleType", null, 0, -1,
        RedefineType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRedefineType_ComplexType(), this.getTopLevelComplexType(), null, "complexType", null, 0, -1,
        RedefineType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRedefineType_Group1(), this.getNamedGroup(), null, "group1", null, 0, -1, RedefineType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getRedefineType_AttributeGroup(), this.getNamedAttributeGroup(), null, "attributeGroup", null, 0, -1,
        RedefineType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getRedefineType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, RedefineType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRedefineType_SchemaLocation(), theXMLTypePackage.getAnyURI(), "schemaLocation", null, 1, 1,
        RedefineType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(restrictionTypeEClass, RestrictionType.class, "RestrictionType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRestrictionType_Group(), this.getGroupRef(), null, "group", null, 0, 1, RestrictionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_All(), this.getAll(), null, "all", null, 0, 1, RestrictionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Choice(), this.getExplicitGroup(), null, "choice", null, 0, 1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Sequence(), this.getExplicitGroup(), null, "sequence", null, 0, 1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, 1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRestrictionType_Facets(), ecorePackage.getEFeatureMapEntry(), "facets", null, 0, -1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MinExclusive(), this.getFacet(), null, "minExclusive", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MinInclusive(), this.getFacet(), null, "minInclusive", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MaxExclusive(), this.getFacet(), null, "maxExclusive", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MaxInclusive(), this.getFacet(), null, "maxInclusive", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_TotalDigits(), this.getTotalDigitsType(), null, "totalDigits", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_FractionDigits(), this.getNumFacet(), null, "fractionDigits", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Length(), this.getNumFacet(), null, "length", null, 0, -1, RestrictionType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MinLength(), this.getNumFacet(), null, "minLength", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_MaxLength(), this.getNumFacet(), null, "maxLength", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Enumeration(), this.getNoFixedFacet(), null, "enumeration", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_WhiteSpace(), this.getWhiteSpaceType(), null, "whiteSpace", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Pattern(), this.getPatternType(), null, "pattern", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getRestrictionType_Group1(), ecorePackage.getEFeatureMapEntry(), "group1", null, 0, -1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_Attribute(), this.getAttribute(), null, "attribute", null, 0, -1,
        RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_AttributeGroup(), this.getAttributeGroupRef(), null, "attributeGroup", null, 0,
        -1, RestrictionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType_AnyAttribute1(), this.getWildcard(), null, "anyAttribute1", null, 0, 1,
        RestrictionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRestrictionType_Base(), theXMLTypePackage.getQName(), "base", null, 1, 1, RestrictionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(restrictionType1EClass, RestrictionType1.class, "RestrictionType1", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRestrictionType1_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, 1,
        RestrictionType1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRestrictionType1_Facets(), ecorePackage.getEFeatureMapEntry(), "facets", null, 0, -1,
        RestrictionType1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MinExclusive(), this.getFacet(), null, "minExclusive", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MinInclusive(), this.getFacet(), null, "minInclusive", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MaxExclusive(), this.getFacet(), null, "maxExclusive", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MaxInclusive(), this.getFacet(), null, "maxInclusive", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_TotalDigits(), this.getTotalDigitsType(), null, "totalDigits", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_FractionDigits(), this.getNumFacet(), null, "fractionDigits", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_Length(), this.getNumFacet(), null, "length", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MinLength(), this.getNumFacet(), null, "minLength", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_MaxLength(), this.getNumFacet(), null, "maxLength", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_Enumeration(), this.getNoFixedFacet(), null, "enumeration", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_WhiteSpace(), this.getWhiteSpaceType(), null, "whiteSpace", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getRestrictionType1_Pattern(), this.getPatternType(), null, "pattern", null, 0, -1,
        RestrictionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getRestrictionType1_Base(), theXMLTypePackage.getQName(), "base", null, 0, 1, RestrictionType1.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(schemaTypeEClass, SchemaType.class, "SchemaType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSchemaType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, SchemaType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Include(), this.getIncludeType(), null, "include", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Import(), this.getImportType(), null, "import", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Redefine(), this.getRedefineType(), null, "redefine", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Annotation(), this.getAnnotationType(), null, "annotation", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getSchemaType_Group1(), ecorePackage.getEFeatureMapEntry(), "group1", null, 0, -1, SchemaType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_SimpleType(), this.getTopLevelSimpleType(), null, "simpleType", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_ComplexType(), this.getTopLevelComplexType(), null, "complexType", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Group2(), this.getNamedGroup(), null, "group2", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_AttributeGroup(), this.getNamedAttributeGroup(), null, "attributeGroup", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Element(), this.getTopLevelElement(), null, "element", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Attribute(), this.getTopLevelAttribute(), null, "attribute", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Notation(), this.getNotationType(), null, "notation", null, 0, -1, SchemaType.class,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getSchemaType_Annotation1(), this.getAnnotationType(), null, "annotation1", null, 0, -1,
        SchemaType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getSchemaType_AttributeFormDefault(), this.getFormChoice(), "attributeFormDefault", "unqualified", 0,
        1, SchemaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSchemaType_BlockDefault(), this.getBlockSet(), "blockDefault", "", 0, 1, SchemaType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSchemaType_ElementFormDefault(), this.getFormChoice(), "elementFormDefault", "unqualified", 0, 1,
        SchemaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSchemaType_FinalDefault(), this.getFullDerivationSet(), "finalDefault", "", 0, 1,
        SchemaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSchemaType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, SchemaType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSchemaType_Lang(), theXMLNamespacePackage.getLangType(), "lang", null, 0, 1, SchemaType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSchemaType_TargetNamespace(), theXMLTypePackage.getAnyURI(), "targetNamespace", null, 0, 1,
        SchemaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSchemaType_Version(), theXMLTypePackage.getToken(), "version", null, 0, 1, SchemaType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(selectorTypeEClass, SelectorType.class, "SelectorType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSelectorType_Xpath(), this.getXpathType1(), "xpath", null, 1, 1, SelectorType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(simpleContentTypeEClass, SimpleContentType.class, "SimpleContentType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSimpleContentType_Restriction(), this.getSimpleRestrictionType(), null, "restriction", null, 0, 1,
        SimpleContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSimpleContentType_Extension(), this.getSimpleExtensionType(), null, "extension", null, 0, 1,
        SimpleContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(simpleExplicitGroupEClass, SimpleExplicitGroup.class, "SimpleExplicitGroup", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(simpleExtensionTypeEClass, SimpleExtensionType.class, "SimpleExtensionType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(simpleRestrictionTypeEClass, SimpleRestrictionType.class, "SimpleRestrictionType", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(simpleTypeEClass, SimpleType.class, "SimpleType", IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSimpleType_Restriction(), this.getRestrictionType1(), null, "restriction", null, 0, 1,
        SimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSimpleType_List(), this.getListType(), null, "list", null, 0, 1, SimpleType.class, !IS_TRANSIENT,
        !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getSimpleType_Union(), this.getUnionType(), null, "union", null, 0, 1, SimpleType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSimpleType_Final(), this.getSimpleDerivationSet(), "final", null, 0, 1, SimpleType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSimpleType_Name(), theXMLTypePackage.getNCName(), "name", null, 0, 1, SimpleType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(topLevelAttributeEClass, TopLevelAttribute.class, "TopLevelAttribute", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(topLevelComplexTypeEClass, TopLevelComplexType.class, "TopLevelComplexType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(topLevelElementEClass, TopLevelElement.class, "TopLevelElement", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(topLevelSimpleTypeEClass, TopLevelSimpleType.class, "TopLevelSimpleType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(totalDigitsTypeEClass, TotalDigitsType.class, "TotalDigitsType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(unionTypeEClass, UnionType.class, "UnionType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getUnionType_SimpleType(), this.getLocalSimpleType(), null, "simpleType", null, 0, -1,
        UnionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getUnionType_MemberTypes(), this.getMemberTypesType(), "memberTypes", null, 0, 1, UnionType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(whiteSpaceTypeEClass, WhiteSpaceType.class, "WhiteSpaceType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(wildcardEClass, Wildcard.class, "Wildcard", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getWildcard_Namespace(), this.getNamespaceList(), "namespace", "##any", 0, 1, Wildcard.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWildcard_ProcessContents(), this.getProcessContentsType(), "processContents", "strict", 0, 1,
        Wildcard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    ...
    initEEnum(namespaceListMember1ItemMember1EEnum, NamespaceListMember1ItemMember1.class,
    ...
    initEEnum(simpleDerivationSetMember1ItemEEnum, SimpleDerivationSetMember1Item.class,
    ...
    initEDataType(allNNIMember1ObjectEDataType, AllNNIMember1.class, "AllNNIMember1Object", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(blockSetEDataType, Object.class, "BlockSet", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(blockSetMember0ObjectEDataType, BlockSetMember0.class, "BlockSetMember0Object", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(blockSetMember1EDataType, List.class, "BlockSetMember1", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(blockSetMember1ItemObjectEDataType, BlockSetMember1Item.class, "BlockSetMember1ItemObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(derivationControlObjectEDataType, DerivationControl.class, "DerivationControlObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(derivationSetEDataType, Object.class, "DerivationSet", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(derivationSetMember0ObjectEDataType, DerivationSetMember0.class, "DerivationSetMember0Object",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(derivationSetMember1EDataType, List.class, "DerivationSetMember1", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(formChoiceObjectEDataType, FormChoice.class, "FormChoiceObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(fullDerivationSetEDataType, Object.class, "FullDerivationSet", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(fullDerivationSetMember0ObjectEDataType, FullDerivationSetMember0.class,
        "FullDerivationSetMember0Object", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(fullDerivationSetMember1EDataType, List.class, "FullDerivationSetMember1", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(memberTypesTypeEDataType, List.class, "MemberTypesType", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(namespaceListEDataType, Object.class, "NamespaceList", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(namespaceListMember0ObjectEDataType, NamespaceListMember0.class, "NamespaceListMember0Object",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(namespaceListMember1EDataType, List.class, "NamespaceListMember1", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(namespaceListMember1ItemEDataType, Object.class, "NamespaceListMember1Item", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(namespaceListMember1ItemMember1ObjectEDataType, NamespaceListMember1ItemMember1.class,
        "NamespaceListMember1ItemMember1Object", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(processContentsTypeObjectEDataType, ProcessContentsType.class, "ProcessContentsTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(publicEDataType, String.class, "Public", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(reducedDerivationControlObjectEDataType, ReducedDerivationControl.class,
        "ReducedDerivationControlObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(simpleDerivationSetEDataType, Object.class, "SimpleDerivationSet", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(simpleDerivationSetMember0ObjectEDataType, SimpleDerivationSetMember0.class,
        "SimpleDerivationSetMember0Object", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(simpleDerivationSetMember1EDataType, List.class, "SimpleDerivationSetMember1", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(simpleDerivationSetMember1ItemObjectEDataType, SimpleDerivationSetMember1Item.class,
        "SimpleDerivationSetMember1ItemObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(typeDerivationControlObjectEDataType, TypeDerivationControl.class, "TypeDerivationControlObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(allEClass, source, new String[] { "name", "all", "kind", "elementOnly" });
    addAnnotation(allNNIEDataType, source, new String[] { "name", "allNNI", "memberTypes",
        "http://www.eclipse.org/emf/2003/XMLType#nonNegativeInteger allNNI_._member_._1" });
    addAnnotation(allNNIMember1EEnum, source, new String[] { "name", "allNNI_._member_._1" });
    addAnnotation(allNNIMember1ObjectEDataType, source,
        new String[] { "name", "allNNI_._member_._1:Object", "baseType", "allNNI_._member_._1" });
    addAnnotation(annotatedEClass, source, new String[] { "name", "annotated", "kind", "elementOnly" });
    addAnnotation(getAnnotated_Annotation(), source,
        new String[] { "kind", "element", "name", "annotation", "namespace", "##targetNamespace" });
    addAnnotation(getAnnotated_Id(), source, new String[] { "kind", "attribute", "name", "id" });
    addAnnotation(annotationTypeEClass, source, new String[] { "name", "annotation_._type", "kind", "elementOnly" });
    addAnnotation(getAnnotationType_Group(), source, new String[] { "kind", "group", "name", "group:1" });
    addAnnotation(getAnnotationType_Appinfo(), source,
        new String[] { "kind", "element", "name", "appinfo", "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getAnnotationType_Documentation(), source, new String[] { "kind", "element", "name", "documentation",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getAnnotationType_Id(), source, new String[] { "kind", "attribute", "name", "id" });
    addAnnotation(anyTypeEClass, source, new String[] { "name", "any_._type", "kind", "elementOnly" });
    addAnnotation(getAnyType_MaxOccurs(), source, new String[] { "kind", "attribute", "name", "maxOccurs" });
    addAnnotation(getAnyType_MinOccurs(), source, new String[] { "kind", "attribute", "name", "minOccurs" });
    addAnnotation(appinfoTypeEClass, source, new String[] { "name", "appinfo_._type", "kind", "mixed" });
    addAnnotation(getAppinfoType_Mixed(), source, new String[] { "kind", "elementWildcard", "name", ":mixed" });
    addAnnotation(getAppinfoType_Group(), source, new String[] { "kind", "group", "name", "group:1" });
    addAnnotation(getAppinfoType_Any(), source, new String[] { "kind", "elementWildcard", "wildcards", "##any", "name",
        ":2", "processing", "lax", "group", "#group:1" });
    addAnnotation(getAppinfoType_Source(), source, new String[] { "kind", "attribute", "name", "source" });
    addAnnotation(getAppinfoType_AnyAttribute(), source,
        new String[] { "kind", "attributeWildcard", "wildcards", "##other", "name", ":4", "processing", "lax" });
    addAnnotation(attributeEClass, source, new String[] { "name", "attribute", "kind", "elementOnly" });
    addAnnotation(getAttribute_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getAttribute_Default(), source, new String[] { "kind", "attribute", "name", "default" });
    addAnnotation(getAttribute_Fixed(), source, new String[] { "kind", "attribute", "name", "fixed" });
    addAnnotation(getAttribute_Form(), source, new String[] { "kind", "attribute", "name", "form" });
    addAnnotation(getAttribute_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getAttribute_Ref(), source, new String[] { "kind", "attribute", "name", "ref" });
    addAnnotation(getAttribute_Type(), source, new String[] { "kind", "attribute", "name", "type" });
    addAnnotation(getAttribute_Use(), source, new String[] { "kind", "attribute", "name", "use" });
    addAnnotation(attributeGroupEClass, source, new String[] { "name", "attributeGroup", "kind", "elementOnly" });
    addAnnotation(getAttributeGroup_Group(), source, new String[] { "kind", "group", "name", "group:3" });
    addAnnotation(getAttributeGroup_Attribute(), source,
        new String[] { "kind", "element", "name", "attribute", "namespace", "##targetNamespace", "group", "#group:3" });
    addAnnotation(getAttributeGroup_AttributeGroup(), source, new String[] { "kind", "element", "name",
        "attributeGroup", "namespace", "##targetNamespace", "group", "#group:3" });
    addAnnotation(getAttributeGroup_AnyAttribute1(), source,
        new String[] { "kind", "element", "name", "anyAttribute", "namespace", "##targetNamespace" });
    addAnnotation(getAttributeGroup_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getAttributeGroup_Ref(), source, new String[] { "kind", "attribute", "name", "ref" });
    addAnnotation(attributeGroupRefEClass, source, new String[] { "name", "attributeGroupRef", "kind", "elementOnly" });
    addAnnotation(blockSetEDataType, source,
        new String[] { "name", "blockSet", "memberTypes", "blockSet_._member_._0 blockSet_._member_._1" });
    addAnnotation(blockSetMember0EEnum, source, new String[] { "name", "blockSet_._member_._0" });
    addAnnotation(blockSetMember0ObjectEDataType, source,
        new String[] { "name", "blockSet_._member_._0:Object", "baseType", "blockSet_._member_._0" });
    addAnnotation(blockSetMember1EDataType, source,
        new String[] { "name", "blockSet_._member_._1", "itemType", "blockSet_._member_._1_._item" });
    addAnnotation(blockSetMember1ItemEEnum, source, new String[] { "name", "blockSet_._member_._1_._item" });
    addAnnotation(blockSetMember1ItemObjectEDataType, source,
        new String[] { "name", "blockSet_._member_._1_._item:Object", "baseType", "blockSet_._member_._1_._item" });
    addAnnotation(complexContentTypeEClass, source,
        new String[] { "name", "complexContent_._type", "kind", "elementOnly" });
    addAnnotation(getComplexContentType_Restriction(), source,
        new String[] { "kind", "element", "name", "restriction", "namespace", "##targetNamespace" });
    addAnnotation(getComplexContentType_Extension(), source,
        new String[] { "kind", "element", "name", "extension", "namespace", "##targetNamespace" });
    addAnnotation(getComplexContentType_Mixed(), source, new String[] { "kind", "attribute", "name", "mixed" });
    addAnnotation(complexRestrictionTypeEClass, source,
        new String[] { "name", "complexRestrictionType", "kind", "elementOnly" });
    addAnnotation(complexTypeEClass, source, new String[] { "name", "complexType", "kind", "elementOnly" });
    addAnnotation(getComplexType_SimpleContent(), source,
        new String[] { "kind", "element", "name", "simpleContent", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_ComplexContent(), source,
        new String[] { "kind", "element", "name", "complexContent", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_Group(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_All(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_Choice(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_Sequence(), source,
        new String[] { "kind", "element", "name", "sequence", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_Group1(), source, new String[] { "kind", "group", "name", "group:9" });
    addAnnotation(getComplexType_Attribute(), source,
        new String[] { "kind", "element", "name", "attribute", "namespace", "##targetNamespace", "group", "#group:9" });
    addAnnotation(getComplexType_AttributeGroup(), source, new String[] { "kind", "element", "name", "attributeGroup",
        "namespace", "##targetNamespace", "group", "#group:9" });
    addAnnotation(getComplexType_AnyAttribute1(), source,
        new String[] { "kind", "element", "name", "anyAttribute", "namespace", "##targetNamespace" });
    addAnnotation(getComplexType_Abstract(), source, new String[] { "kind", "attribute", "name", "abstract" });
    addAnnotation(getComplexType_Block(), source, new String[] { "kind", "attribute", "name", "block" });
    addAnnotation(getComplexType_Final(), source, new String[] { "kind", "attribute", "name", "final" });
    addAnnotation(getComplexType_Mixed(), source, new String[] { "kind", "attribute", "name", "mixed" });
    addAnnotation(getComplexType_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(derivationControlEEnum, source, new String[] { "name", "derivationControl" });
    addAnnotation(derivationControlObjectEDataType, source,
        new String[] { "name", "derivationControl:Object", "baseType", "derivationControl" });
    addAnnotation(derivationSetEDataType, source, new String[] { "name", "derivationSet", "memberTypes",
        "derivationSet_._member_._0 derivationSet_._member_._1" });
    addAnnotation(derivationSetMember0EEnum, source, new String[] { "name", "derivationSet_._member_._0" });
    addAnnotation(derivationSetMember0ObjectEDataType, source,
        new String[] { "name", "derivationSet_._member_._0:Object", "baseType", "derivationSet_._member_._0" });
    addAnnotation(derivationSetMember1EDataType, source,
        new String[] { "name", "derivationSet_._member_._1", "itemType", "reducedDerivationControl" });
    addAnnotation(documentationTypeEClass, source, new String[] { "name", "documentation_._type", "kind", "mixed" });
    addAnnotation(getDocumentationType_Mixed(), source, new String[] { "kind", "elementWildcard", "name", ":mixed" });
    addAnnotation(getDocumentationType_Group(), source, new String[] { "kind", "group", "name", "group:1" });
    addAnnotation(getDocumentationType_Any(), source, new String[] { "kind", "elementWildcard", "wildcards", "##any",
        "name", ":2", "processing", "lax", "group", "#group:1" });
    addAnnotation(getDocumentationType_Lang(), source,
        new String[] { "kind", "attribute", "name", "lang", "namespace", "http://www.w3.org/XML/1998/namespace" });
    addAnnotation(getDocumentationType_Source(), source, new String[] { "kind", "attribute", "name", "source" });
    addAnnotation(getDocumentationType_AnyAttribute(), source,
        new String[] { "kind", "attributeWildcard", "wildcards", "##other", "name", ":5", "processing", "lax" });
    ...
    addAnnotation(getDocumentRoot_All(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Annotation(), source,
        new String[] { "kind", "element", "name", "annotation", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Any(), source,
        new String[] { "kind", "element", "name", "any", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_AnyAttribute(), source,
        new String[] { "kind", "element", "name", "anyAttribute", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Appinfo(), source,
        new String[] { "kind", "element", "name", "appinfo", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Attribute(), source,
        new String[] { "kind", "element", "name", "attribute", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_AttributeGroup(), source,
        new String[] { "kind", "element", "name", "attributeGroup", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Choice(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ComplexContent(), source,
        new String[] { "kind", "element", "name", "complexContent", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_ComplexType(), source,
        new String[] { "kind", "element", "name", "complexType", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Documentation(), source,
        new String[] { "kind", "element", "name", "documentation", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Element(), source,
        new String[] { "kind", "element", "name", "element", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Enumeration(), source,
        new String[] { "kind", "element", "name", "enumeration", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Field(), source,
        new String[] { "kind", "element", "name", "field", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_FractionDigits(), source,
        new String[] { "kind", "element", "name", "fractionDigits", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Group(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Import(), source,
        new String[] { "kind", "element", "name", "import", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Include(), source,
        new String[] { "kind", "element", "name", "include", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Key(), source,
        new String[] { "kind", "element", "name", "key", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Keyref(), source,
        new String[] { "kind", "element", "name", "keyref", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Length(), source,
        new String[] { "kind", "element", "name", "length", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_List(), source,
        new String[] { "kind", "element", "name", "list", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MaxExclusive(), source,
        new String[] { "kind", "element", "name", "maxExclusive", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MaxInclusive(), source,
        new String[] { "kind", "element", "name", "maxInclusive", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MaxLength(), source,
        new String[] { "kind", "element", "name", "maxLength", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MinExclusive(), source,
        new String[] { "kind", "element", "name", "minExclusive", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MinInclusive(), source,
        new String[] { "kind", "element", "name", "minInclusive", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_MinLength(), source,
        new String[] { "kind", "element", "name", "minLength", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Notation(), source,
        new String[] { "kind", "element", "name", "notation", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Pattern(), source,
        new String[] { "kind", "element", "name", "pattern", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Redefine(), source,
        new String[] { "kind", "element", "name", "redefine", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Restriction(), source,
        new String[] { "kind", "element", "name", "restriction", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Schema(), source,
        new String[] { "kind", "element", "name", "schema", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Selector(), source,
        new String[] { "kind", "element", "name", "selector", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Sequence(), source,
        new String[] { "kind", "element", "name", "sequence", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_SimpleContent(), source,
        new String[] { "kind", "element", "name", "simpleContent", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_TotalDigits(), source,
        new String[] { "kind", "element", "name", "totalDigits", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Union(), source,
        new String[] { "kind", "element", "name", "union", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_Unique(), source,
        new String[] { "kind", "element", "name", "unique", "namespace", "##targetNamespace" });
    addAnnotation(getDocumentRoot_WhiteSpace(), source,
        new String[] { "kind", "element", "name", "whiteSpace", "namespace", "##targetNamespace" });
    addAnnotation(elementEClass, source, new String[] { "name", "element", "kind", "elementOnly" });
    addAnnotation(getElement_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getElement_ComplexType(), source,
        new String[] { "kind", "element", "name", "complexType", "namespace", "##targetNamespace" });
    addAnnotation(getElement_IdentityConstraint(), source,
        new String[] { "kind", "group", "name", "IdentityConstraint:5" });
    addAnnotation(getElement_Unique(), source, new String[] { "kind", "element", "name", "unique", "namespace",
        "##targetNamespace", "group", "#IdentityConstraint:5" });
    addAnnotation(getElement_Key(), source, new String[] { "kind", "element", "name", "key", "namespace",
        "##targetNamespace", "group", "#IdentityConstraint:5" });
    addAnnotation(getElement_Keyref(), source, new String[] { "kind", "element", "name", "keyref", "namespace",
        "##targetNamespace", "group", "#IdentityConstraint:5" });
    addAnnotation(getElement_Abstract(), source, new String[] { "kind", "attribute", "name", "abstract" });
    addAnnotation(getElement_Block(), source, new String[] { "kind", "attribute", "name", "block" });
    addAnnotation(getElement_Default(), source, new String[] { "kind", "attribute", "name", "default" });
    addAnnotation(getElement_Final(), source, new String[] { "kind", "attribute", "name", "final" });
    addAnnotation(getElement_Fixed(), source, new String[] { "kind", "attribute", "name", "fixed" });
    addAnnotation(getElement_Form(), source, new String[] { "kind", "attribute", "name", "form" });
    addAnnotation(getElement_MaxOccurs(), source, new String[] { "kind", "attribute", "name", "maxOccurs" });
    addAnnotation(getElement_MinOccurs(), source, new String[] { "kind", "attribute", "name", "minOccurs" });
    addAnnotation(getElement_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getElement_Nillable(), source, new String[] { "kind", "attribute", "name", "nillable" });
    addAnnotation(getElement_Ref(), source, new String[] { "kind", "attribute", "name", "ref" });
    addAnnotation(getElement_SubstitutionGroup(), source,
        new String[] { "kind", "attribute", "name", "substitutionGroup" });
    addAnnotation(getElement_Type(), source, new String[] { "kind", "attribute", "name", "type" });
    addAnnotation(explicitGroupEClass, source, new String[] { "name", "explicitGroup", "kind", "elementOnly" });
    addAnnotation(extensionTypeEClass, source, new String[] { "name", "extensionType", "kind", "elementOnly" });
    addAnnotation(getExtensionType_Group(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace" });
    addAnnotation(getExtensionType_All(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace" });
    addAnnotation(getExtensionType_Choice(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace" });
    addAnnotation(getExtensionType_Sequence(), source,
        new String[] { "kind", "element", "name", "sequence", "namespace", "##targetNamespace" });
    addAnnotation(getExtensionType_Group1(), source, new String[] { "kind", "group", "name", "group:7" });
    addAnnotation(getExtensionType_Attribute(), source,
        new String[] { "kind", "element", "name", "attribute", "namespace", "##targetNamespace", "group", "#group:7" });
    addAnnotation(getExtensionType_AttributeGroup(), source, new String[] { "kind", "element", "name", "attributeGroup",
        "namespace", "##targetNamespace", "group", "#group:7" });
    addAnnotation(getExtensionType_AnyAttribute1(), source,
        new String[] { "kind", "element", "name", "anyAttribute", "namespace", "##targetNamespace" });
    addAnnotation(getExtensionType_Base(), source, new String[] { "kind", "attribute", "name", "base" });
    addAnnotation(facetEClass, source, new String[] { "name", "facet", "kind", "elementOnly" });
    addAnnotation(getFacet_Fixed(), source, new String[] { "kind", "attribute", "name", "fixed" });
    addAnnotation(getFacet_Value(), source, new String[] { "kind", "attribute", "name", "value" });
    addAnnotation(fieldTypeEClass, source, new String[] { "name", "field_._type", "kind", "elementOnly" });
    addAnnotation(getFieldType_Xpath(), source, new String[] { "kind", "attribute", "name", "xpath" });
    addAnnotation(formChoiceEEnum, source, new String[] { "name", "formChoice" });
    addAnnotation(formChoiceObjectEDataType, source,
        new String[] { "name", "formChoice:Object", "baseType", "formChoice" });
    addAnnotation(fullDerivationSetEDataType, source, new String[] { "name", "fullDerivationSet", "memberTypes",
        "fullDerivationSet_._member_._0 fullDerivationSet_._member_._1" });
    addAnnotation(fullDerivationSetMember0EEnum, source, new String[] { "name", "fullDerivationSet_._member_._0" });
    addAnnotation(fullDerivationSetMember0ObjectEDataType, source,
        new String[] { "name", "fullDerivationSet_._member_._0:Object", "baseType", "fullDerivationSet_._member_._0" });
    addAnnotation(fullDerivationSetMember1EDataType, source,
        new String[] { "name", "fullDerivationSet_._member_._1", "itemType", "typeDerivationControl" });
    addAnnotation(groupEClass, source, new String[] { "name", "group", "kind", "elementOnly" });
    addAnnotation(getGroup_Particle(), source, new String[] { "kind", "group", "name", "Particle:3" });
    addAnnotation(getGroup_Element(), source, new String[] { "kind", "element", "name", "element", "namespace",
        "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_Group(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_All(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_Choice(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_Sequence(), source, new String[] { "kind", "element", "name", "sequence", "namespace",
        "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_Any(), source,
        new String[] { "kind", "element", "name", "any", "namespace", "##targetNamespace", "group", "#Particle:3" });
    addAnnotation(getGroup_MaxOccurs(), source, new String[] { "kind", "attribute", "name", "maxOccurs" });
    addAnnotation(getGroup_MinOccurs(), source, new String[] { "kind", "attribute", "name", "minOccurs" });
    addAnnotation(getGroup_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getGroup_Ref(), source, new String[] { "kind", "attribute", "name", "ref" });
    addAnnotation(groupRefEClass, source, new String[] { "name", "groupRef", "kind", "elementOnly" });
    addAnnotation(importTypeEClass, source, new String[] { "name", "import_._type", "kind", "elementOnly" });
    addAnnotation(getImportType_Namespace(), source, new String[] { "kind", "attribute", "name", "namespace" });
    addAnnotation(getImportType_SchemaLocation(), source,
        new String[] { "kind", "attribute", "name", "schemaLocation" });
    addAnnotation(includeTypeEClass, source, new String[] { "name", "include_._type", "kind", "elementOnly" });
    addAnnotation(getIncludeType_SchemaLocation(), source,
        new String[] { "kind", "attribute", "name", "schemaLocation" });
    addAnnotation(keybaseEClass, source, new String[] { "name", "keybase", "kind", "elementOnly" });
    addAnnotation(getKeybase_Selector(), source,
        new String[] { "kind", "element", "name", "selector", "namespace", "##targetNamespace" });
    addAnnotation(getKeybase_Field(), source,
        new String[] { "kind", "element", "name", "field", "namespace", "##targetNamespace" });
    addAnnotation(getKeybase_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(keyrefTypeEClass, source, new String[] { "name", "keyref_._type", "kind", "elementOnly" });
    addAnnotation(getKeyrefType_Refer(), source, new String[] { "kind", "attribute", "name", "refer" });
    addAnnotation(listTypeEClass, source, new String[] { "name", "list_._type", "kind", "elementOnly" });
    addAnnotation(getListType_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getListType_ItemType(), source, new String[] { "kind", "attribute", "name", "itemType" });
    addAnnotation(localComplexTypeEClass, source, new String[] { "name", "localComplexType", "kind", "elementOnly" });
    addAnnotation(localElementEClass, source, new String[] { "name", "localElement", "kind", "elementOnly" });
    addAnnotation(localSimpleTypeEClass, source, new String[] { "name", "localSimpleType", "kind", "elementOnly" });
    addAnnotation(memberTypesTypeEDataType, source,
        new String[] { "name", "memberTypes_._type", "itemType", "http://www.eclipse.org/emf/2003/XMLType#QName" });
    addAnnotation(namedAttributeGroupEClass, source,
        new String[] { "name", "namedAttributeGroup", "kind", "elementOnly" });
    addAnnotation(namedGroupEClass, source, new String[] { "name", "namedGroup", "kind", "elementOnly" });
    addAnnotation(namespaceListEDataType, source, new String[] { "name", "namespaceList", "memberTypes",
        "namespaceList_._member_._0 namespaceList_._member_._1" });
    addAnnotation(namespaceListMember0EEnum, source, new String[] { "name", "namespaceList_._member_._0" });
    addAnnotation(namespaceListMember0ObjectEDataType, source,
        new String[] { "name", "namespaceList_._member_._0:Object", "baseType", "namespaceList_._member_._0" });
    addAnnotation(namespaceListMember1EDataType, source,
        new String[] { "name", "namespaceList_._member_._1", "itemType", "namespaceList_._member_._1_._item" });
    addAnnotation(namespaceListMember1ItemEDataType, source,
        new String[] { "name", "namespaceList_._member_._1_._item", "memberTypes",
            "http://www.eclipse.org/emf/2003/XMLType#anyURI namespaceList_._member_._1_._item_._member_._1" });
    addAnnotation(namespaceListMember1ItemMember1EEnum, source,
        new String[] { "name", "namespaceList_._member_._1_._item_._member_._1" });
    addAnnotation(namespaceListMember1ItemMember1ObjectEDataType, source,
        new String[] { "name", "namespaceList_._member_._1_._item_._member_._1:Object", "baseType",
            "namespaceList_._member_._1_._item_._member_._1" });
    addAnnotation(narrowMaxMinEClass, source, new String[] { "name", "narrowMaxMin", "kind", "elementOnly" });
    addAnnotation(noFixedFacetEClass, source, new String[] { "name", "noFixedFacet", "kind", "elementOnly" });
    addAnnotation(notationTypeEClass, source, new String[] { "name", "notation_._type", "kind", "elementOnly" });
    addAnnotation(getNotationType_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(getNotationType_Public(), source, new String[] { "kind", "attribute", "name", "public" });
    addAnnotation(getNotationType_System(), source, new String[] { "kind", "attribute", "name", "system" });
    addAnnotation(numFacetEClass, source, new String[] { "name", "numFacet", "kind", "elementOnly" });
    addAnnotation(openAttrsEClass, source, new String[] { "name", "openAttrs", "kind", "empty" });
    addAnnotation(getOpenAttrs_AnyAttribute(), source,
        new String[] { "kind", "attributeWildcard", "wildcards", "##other", "name", ":0", "processing", "lax" });
    addAnnotation(patternTypeEClass, source, new String[] { "name", "pattern_._type", "kind", "elementOnly" });
    addAnnotation(processContentsTypeEEnum, source, new String[] { "name", "processContents_._type" });
    addAnnotation(processContentsTypeObjectEDataType, source,
        new String[] { "name", "processContents_._type:Object", "baseType", "processContents_._type" });
    addAnnotation(publicEDataType, source,
        new String[] { "name", "public", "baseType", "http://www.eclipse.org/emf/2003/XMLType#token" });
    addAnnotation(realGroupEClass, source, new String[] { "name", "realGroup", "kind", "elementOnly" });
    addAnnotation(getRealGroup_All1(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace" });
    addAnnotation(getRealGroup_Choice1(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace" });
    addAnnotation(getRealGroup_Sequence1(), source,
        new String[] { "kind", "element", "name", "sequence", "namespace", "##targetNamespace" });
    addAnnotation(redefineTypeEClass, source, new String[] { "name", "redefine_._type", "kind", "elementOnly" });
    addAnnotation(getRedefineType_Group(), source, new String[] { "kind", "group", "name", "group:1" });
    addAnnotation(getRedefineType_Annotation(), source, new String[] { "kind", "element", "name", "annotation",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getRedefineType_SimpleType(), source, new String[] { "kind", "element", "name", "simpleType",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getRedefineType_ComplexType(), source, new String[] { "kind", "element", "name", "complexType",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getRedefineType_Group1(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getRedefineType_AttributeGroup(), source, new String[] { "kind", "element", "name", "attributeGroup",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getRedefineType_Id(), source, new String[] { "kind", "attribute", "name", "id" });
    addAnnotation(getRedefineType_SchemaLocation(), source,
        new String[] { "kind", "attribute", "name", "schemaLocation" });
    addAnnotation(reducedDerivationControlEEnum, source, new String[] { "name", "reducedDerivationControl" });
    addAnnotation(reducedDerivationControlObjectEDataType, source,
        new String[] { "name", "reducedDerivationControl:Object", "baseType", "reducedDerivationControl" });
    addAnnotation(restrictionTypeEClass, source, new String[] { "name", "restrictionType", "kind", "elementOnly" });
    addAnnotation(getRestrictionType_Group(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_All(), source,
        new String[] { "kind", "element", "name", "all", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_Choice(), source,
        new String[] { "kind", "element", "name", "choice", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_Sequence(), source,
        new String[] { "kind", "element", "name", "sequence", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_Facets(), source, new String[] { "kind", "group", "name", "Facets:8" });
    addAnnotation(getRestrictionType_MinExclusive(), source, new String[] { "kind", "element", "name", "minExclusive",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_MinInclusive(), source, new String[] { "kind", "element", "name", "minInclusive",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_MaxExclusive(), source, new String[] { "kind", "element", "name", "maxExclusive",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_MaxInclusive(), source, new String[] { "kind", "element", "name", "maxInclusive",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_TotalDigits(), source, new String[] { "kind", "element", "name", "totalDigits",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_FractionDigits(), source, new String[] { "kind", "element", "name",
        "fractionDigits", "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_Length(), source,
        new String[] { "kind", "element", "name", "length", "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_MinLength(), source, new String[] { "kind", "element", "name", "minLength",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_MaxLength(), source, new String[] { "kind", "element", "name", "maxLength",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_Enumeration(), source, new String[] { "kind", "element", "name", "enumeration",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_WhiteSpace(), source, new String[] { "kind", "element", "name", "whiteSpace",
        "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_Pattern(), source,
        new String[] { "kind", "element", "name", "pattern", "namespace", "##targetNamespace", "group", "#Facets:8" });
    addAnnotation(getRestrictionType_Group1(), source, new String[] { "kind", "group", "name", "group:21" });
    addAnnotation(getRestrictionType_Attribute(), source, new String[] { "kind", "element", "name", "attribute",
        "namespace", "##targetNamespace", "group", "#group:21" });
    addAnnotation(getRestrictionType_AttributeGroup(), source, new String[] { "kind", "element", "name",
        "attributeGroup", "namespace", "##targetNamespace", "group", "#group:21" });
    addAnnotation(getRestrictionType_AnyAttribute1(), source,
        new String[] { "kind", "element", "name", "anyAttribute", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType_Base(), source, new String[] { "kind", "attribute", "name", "base" });
    addAnnotation(restrictionType1EClass, source, new String[] { "name", "restriction_._type", "kind", "elementOnly" });
    addAnnotation(getRestrictionType1_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getRestrictionType1_Facets(), source, new String[] { "kind", "group", "name", "Facets:4" });
    addAnnotation(getRestrictionType1_MinExclusive(), source, new String[] { "kind", "element", "name", "minExclusive",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_MinInclusive(), source, new String[] { "kind", "element", "name", "minInclusive",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_MaxExclusive(), source, new String[] { "kind", "element", "name", "maxExclusive",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_MaxInclusive(), source, new String[] { "kind", "element", "name", "maxInclusive",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_TotalDigits(), source, new String[] { "kind", "element", "name", "totalDigits",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_FractionDigits(), source, new String[] { "kind", "element", "name",
        "fractionDigits", "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_Length(), source,
        new String[] { "kind", "element", "name", "length", "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_MinLength(), source, new String[] { "kind", "element", "name", "minLength",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_MaxLength(), source, new String[] { "kind", "element", "name", "maxLength",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_Enumeration(), source, new String[] { "kind", "element", "name", "enumeration",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_WhiteSpace(), source, new String[] { "kind", "element", "name", "whiteSpace",
        "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_Pattern(), source,
        new String[] { "kind", "element", "name", "pattern", "namespace", "##targetNamespace", "group", "#Facets:4" });
    addAnnotation(getRestrictionType1_Base(), source, new String[] { "kind", "attribute", "name", "base" });
    addAnnotation(schemaTypeEClass, source, new String[] { "name", "schema_._type", "kind", "elementOnly" });
    addAnnotation(getSchemaType_Group(), source, new String[] { "kind", "group", "name", "group:1" });
    addAnnotation(getSchemaType_Include(), source,
        new String[] { "kind", "element", "name", "include", "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getSchemaType_Import(), source,
        new String[] { "kind", "element", "name", "import", "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getSchemaType_Redefine(), source,
        new String[] { "kind", "element", "name", "redefine", "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getSchemaType_Annotation(), source, new String[] { "kind", "element", "name", "annotation",
        "namespace", "##targetNamespace", "group", "#group:1" });
    addAnnotation(getSchemaType_Group1(), source, new String[] { "kind", "group", "name", "group:6" });
    addAnnotation(getSchemaType_SimpleType(), source, new String[] { "kind", "element", "name", "simpleType",
        "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_ComplexType(), source, new String[] { "kind", "element", "name", "complexType",
        "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_Group2(), source,
        new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_AttributeGroup(), source, new String[] { "kind", "element", "name", "attributeGroup",
        "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_Element(), source,
        new String[] { "kind", "element", "name", "element", "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_Attribute(), source,
        new String[] { "kind", "element", "name", "attribute", "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_Notation(), source,
        new String[] { "kind", "element", "name", "notation", "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_Annotation1(), source, new String[] { "kind", "element", "name", "annotation",
        "namespace", "##targetNamespace", "group", "#group:6" });
    addAnnotation(getSchemaType_AttributeFormDefault(), source,
        new String[] { "kind", "attribute", "name", "attributeFormDefault" });
    addAnnotation(getSchemaType_BlockDefault(), source, new String[] { "kind", "attribute", "name", "blockDefault" });
    addAnnotation(getSchemaType_ElementFormDefault(), source,
        new String[] { "kind", "attribute", "name", "elementFormDefault" });
    addAnnotation(getSchemaType_FinalDefault(), source, new String[] { "kind", "attribute", "name", "finalDefault" });
    addAnnotation(getSchemaType_Id(), source, new String[] { "kind", "attribute", "name", "id" });
    addAnnotation(getSchemaType_Lang(), source,
        new String[] { "kind", "attribute", "name", "lang", "namespace", "http://www.w3.org/XML/1998/namespace" });
    addAnnotation(getSchemaType_TargetNamespace(), source,
        new String[] { "kind", "attribute", "name", "targetNamespace" });
    addAnnotation(getSchemaType_Version(), source, new String[] { "kind", "attribute", "name", "version" });
    addAnnotation(selectorTypeEClass, source, new String[] { "name", "selector_._type", "kind", "elementOnly" });
    addAnnotation(getSelectorType_Xpath(), source, new String[] { "kind", "attribute", "name", "xpath" });
    addAnnotation(simpleContentTypeEClass, source,
        new String[] { "name", "simpleContent_._type", "kind", "elementOnly" });
    addAnnotation(getSimpleContentType_Restriction(), source,
        new String[] { "kind", "element", "name", "restriction", "namespace", "##targetNamespace" });
    addAnnotation(getSimpleContentType_Extension(), source,
        new String[] { "kind", "element", "name", "extension", "namespace", "##targetNamespace" });
    addAnnotation(simpleDerivationSetEDataType, source, new String[] { "name", "simpleDerivationSet", "memberTypes",
        "simpleDerivationSet_._member_._0 simpleDerivationSet_._member_._1" });
    addAnnotation(simpleDerivationSetMember0EEnum, source, new String[] { "name", "simpleDerivationSet_._member_._0" });
    addAnnotation(simpleDerivationSetMember0ObjectEDataType, source, new String[] { "name",
        "simpleDerivationSet_._member_._0:Object", "baseType", "simpleDerivationSet_._member_._0" });
    addAnnotation(simpleDerivationSetMember1EDataType, source, new String[] { "name",
        "simpleDerivationSet_._member_._1", "itemType", "simpleDerivationSet_._member_._1_._item" });
    addAnnotation(simpleDerivationSetMember1ItemEEnum, source,
        new String[] { "name", "simpleDerivationSet_._member_._1_._item" });
    addAnnotation(simpleDerivationSetMember1ItemObjectEDataType, source, new String[] { "name",
        "simpleDerivationSet_._member_._1_._item:Object", "baseType", "simpleDerivationSet_._member_._1_._item" });
    addAnnotation(simpleExplicitGroupEClass, source,
        new String[] { "name", "simpleExplicitGroup", "kind", "elementOnly" });
    addAnnotation(simpleExtensionTypeEClass, source,
        new String[] { "name", "simpleExtensionType", "kind", "elementOnly" });
    addAnnotation(simpleRestrictionTypeEClass, source,
        new String[] { "name", "simpleRestrictionType", "kind", "elementOnly" });
    addAnnotation(simpleTypeEClass, source, new String[] { "name", "simpleType", "kind", "elementOnly" });
    addAnnotation(getSimpleType_Restriction(), source,
        new String[] { "kind", "element", "name", "restriction", "namespace", "##targetNamespace" });
    addAnnotation(getSimpleType_List(), source,
        new String[] { "kind", "element", "name", "list", "namespace", "##targetNamespace" });
    addAnnotation(getSimpleType_Union(), source,
        new String[] { "kind", "element", "name", "union", "namespace", "##targetNamespace" });
    addAnnotation(getSimpleType_Final(), source, new String[] { "kind", "attribute", "name", "final" });
    addAnnotation(getSimpleType_Name(), source, new String[] { "kind", "attribute", "name", "name" });
    addAnnotation(topLevelAttributeEClass, source, new String[] { "name", "topLevelAttribute", "kind", "elementOnly" });
    addAnnotation(topLevelComplexTypeEClass, source,
        new String[] { "name", "topLevelComplexType", "kind", "elementOnly" });
    addAnnotation(topLevelElementEClass, source, new String[] { "name", "topLevelElement", "kind", "elementOnly" });
    addAnnotation(topLevelSimpleTypeEClass, source,
        new String[] { "name", "topLevelSimpleType", "kind", "elementOnly" });
    addAnnotation(totalDigitsTypeEClass, source, new String[] { "name", "totalDigits_._type", "kind", "elementOnly" });
    addAnnotation(typeDerivationControlEEnum, source, new String[] { "name", "typeDerivationControl" });
    addAnnotation(typeDerivationControlObjectEDataType, source,
        new String[] { "name", "typeDerivationControl:Object", "baseType", "typeDerivationControl" });
    addAnnotation(unionTypeEClass, source, new String[] { "name", "union_._type", "kind", "elementOnly" });
    addAnnotation(getUnionType_SimpleType(), source,
        new String[] { "kind", "element", "name", "simpleType", "namespace", "##targetNamespace" });
    addAnnotation(getUnionType_MemberTypes(), source, new String[] { "kind", "attribute", "name", "memberTypes" });
    addAnnotation(useTypeEEnum, source, new String[] { "name", "use_._type" });
    addAnnotation(useTypeObjectEDataType, source,
        new String[] { "name", "use_._type:Object", "baseType", "use_._type" });
    addAnnotation(whiteSpaceTypeEClass, source, new String[] { "name", "whiteSpace_._type", "kind", "elementOnly" });
    addAnnotation(wildcardEClass, source, new String[] { "name", "wildcard", "kind", "elementOnly" });
    addAnnotation(getWildcard_Namespace(), source, new String[] { "kind", "attribute", "name", "namespace" });
    addAnnotation(getWildcard_ProcessContents(), source,
        new String[] { "kind", "attribute", "name", "processContents" });
    addAnnotation(xpathTypeEDataType, source, new String[] { "name", "xpath_._type", "baseType",
        "http://www.eclipse.org/emf/2003/XMLType#token", "pattern",
        "(\\.//)?((((child::)?((\\i\\c*:)?(\\i\\c*|\\*)))|\\.)/)*((((child::)?((\\i\\c*:)?(\\i\\c*|\\*)))|\\.)|((attribute::|@)((\\i\\c*:)?(\\i\\c*|\\*))))(\\|(\\.//)?((((child::)?((\\i\\c*:)?(\\i\\c*|\\*)))|\\.)/)*((((child::)?((\\i\\c*:)?(\\i\\c*|\\*)))|\\.)|((attribute::|@)((\\i\\c*:)?(\\i\\c*|\\*)))))*" });
    addAnnotation(xpathType1EDataType, source, new String[] { "name", "xpath_._1_._type", "baseType",
        "http://www.eclipse.org/emf/2003/XMLType#token", "pattern",
