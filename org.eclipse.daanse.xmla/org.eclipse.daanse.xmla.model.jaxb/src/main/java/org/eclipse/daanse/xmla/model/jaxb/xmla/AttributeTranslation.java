...
/**
 * <p>
 * Java class for AttributeTranslation complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="AttributeTranslation"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="CaptionColumn" type="{urn:schemas-microsoft-com:xml-analysis}DataItem" minOccurs="0"/&gt;
...
public class AttributeTranslation {
   ...
   * 
   * @return possible object is {@link AttributeTranslation.Annotations }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link AttributeTranslation.Annotations }
   * 
   */
  ...
  public boolean isSetCaptionColumn() {
    return (this.captionColumn != null);
  }
