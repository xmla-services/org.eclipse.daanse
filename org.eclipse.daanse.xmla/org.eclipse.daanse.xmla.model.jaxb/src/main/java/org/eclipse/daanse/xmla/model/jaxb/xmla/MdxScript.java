...
/**
 * <p>
 * Java class for MdxScript complex type.
 * 
 * <p>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Command" type="{urn:schemas-microsoft-com:xml-analysis}Command" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="DefaultScript" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="CalculationProperties" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="CalculationProperty" type="{urn:schemas-microsoft-com:xml-analysis}CalculationProperty" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class MdxScript {
   ...
   * 
   * @return possible object is {@link MdxScript.Annotations }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link MdxScript.Annotations }
   * 
   */
   ...
   * 
   * @return possible object is {@link MdxScript.Commands }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link MdxScript.Commands }
   * 
   */
  ...
  public boolean isSetDefaultScript() {
    return (this.defaultScript != null);
  }

  /**
   * Gets the value of the calculationProperties property.
   * 
   * @return possible object is {@link MdxScript.CalculationProperties }
   * 
   */
  ...
  /**
   * Sets the value of the calculationProperties property.
   * 
   * @param value allowed object is {@link MdxScript.CalculationProperties }
   * 
   */
  ...
  public boolean isSetCalculationProperties() {
    return (this.calculationProperties != null);
  }
  ...
  public static class CalculationProperties {
    ...
    /**
     * Gets the value of the calculationProperty property.
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the Jakarta XML Binding object. This is why there is not a
     * <CODE>set</CODE> method for the calculationProperty property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     * getCalculationProperty().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CalculationProperty }
     * 
     * 
     */
    public List<CalculationProperty> getCalculationProperty() {
      if (calculationProperty == null) {
        calculationProperty = new ArrayList<CalculationProperty>();
      }
      return this.calculationProperty;
    }

    public boolean isSetCalculationProperty() {
      return ((this.calculationProperty != null) && (!this.calculationProperty.isEmpty()));
    }

    public void unsetCalculationProperty() {
      this.calculationProperty = null;
    }
