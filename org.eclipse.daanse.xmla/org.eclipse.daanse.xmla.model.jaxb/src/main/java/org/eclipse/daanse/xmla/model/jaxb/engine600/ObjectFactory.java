 ...
 * element interface generated in the org.eclipse.daanse.xmla.ws.eng600 package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _SupportedCompatibilityLevels_QNAME = new QName(
      "http://schemas.microsoft.com/analysisservices/2013/engine/600", "SupportedCompatibilityLevels");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema
   * derived classes for package: org.eclipse.daanse.xmla.ws.eng600
   * 
   */
