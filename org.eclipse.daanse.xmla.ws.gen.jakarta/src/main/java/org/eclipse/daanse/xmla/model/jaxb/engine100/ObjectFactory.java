...
package org.eclipse.daanse.xmla.model.jaxb.engine100;
 ...
 * generated in the org.eclipse.daanse.xmla.model.jaxb.engine100 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ReadWriteMode_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "ReadWriteMode");
    private final static QName _HoldoutMaxPercent_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "HoldoutMaxPercent");
    private final static QName _HoldoutMaxCases_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "HoldoutMaxCases");
    private final static QName _HoldoutSeed_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "HoldoutSeed");
    private final static QName _HoldoutActualSize_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "HoldoutActualSize");
    private final static QName _DbStorageLocation_QNAME = new QName("http://schemas.microsoft.com/analysisservices/2008/engine/100", "DbStorageLocation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.eclipse.daanse.xmla.model.jaxb.engine100
     * 
     */
